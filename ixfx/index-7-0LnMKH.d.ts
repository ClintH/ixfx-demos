 ...
 * @param values
 */
declare function piecewise<T>(values: Array<T>): Generator<T[], void, unknown>;
/**
...
declare const index_piecewise: typeof piecewise;
