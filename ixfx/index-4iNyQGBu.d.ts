 ...
 * @returns
 */
declare function query(queryOrElement: string | HTMLElement | Array<string | HTMLElement> | AsyncGenerator<string | HTMLElement>): AsyncGenerator<WrappedElement>;

type ChainDom_WrappedElement = WrappedElement;
declare const ChainDom_query: typeof query;
declare namespace ChainDom {
  export { type ChainDom_WrappedElement as WrappedElement, ChainDom_query as query };
}
...
/**
 * Tracks unique values. Alternatively: {@link trackUniqueInstances}
 *
 * ```js
 * const t = trackUnique();
 * t(`hello`); // true
...
/**
 * Tracks unique object instances. Alternatively: {@link trackUnique} to track by value.
 */
...
export { trackUnique as A, Bipolar as B, Chain as C, trackUniqueInstances as D, Table as E, type FrequencyEventMap as F, interpolate as G, interpolateAngle as H, IntervalTracker as I, wrapInteger as J, wrap as K, wrapRange as L, type MovingAverage as M, Normalise as N, type NumberFunction as O, Pool$1 as P, TrackedPointMap as T, index$1 as a, Correlate as b, FrequencyMutable as c, movingAverageTimed as d, movingAverage as e, frequencyMutable as f, intervalTracker as g, type PointTrack as h, index as i, type PointTrackerResults as j, PointTracker as k, pointsTracker as l, movingAverageLight as m, noiseFilter as n, pointTracker as o, piPi as p, clamp$1 as q, clampIndex as r, scale$1 as s, scaler as t, scaleClamped$1 as u, scalePercentages as v, scalePercent as w, scalerPercent as x, flip as y, type TrackUnique as z };
