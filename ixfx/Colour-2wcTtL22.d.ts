...
declare namespace Colour {
  export { type Colour_Colourish as Colourish, type Colour_Hsl as Hsl, type Colour_Hsla as Hsla, type Colour_InterpolationOpts as InterpolationOpts, type Colour_Rgb as Rgb, type Colour_Rgba as Rgba, type Colour_Spaces as Spaces, Colour_cssLinearGradient as cssLinearGradient, Colour_fromHsla as fromHsla, Colour_getCssVariable as getCssVariable, Colour_goldenAngleColour as goldenAngleColour, Colour_interpolator as interpolator, Colour_opacity as opacity, Colour_randomHue as randomHue, Colour_resolve as resolve, Colour_resolveToString as resolveToString, Colour_scale as scale, Colour_toHex as toHex, Colour_toHsl as toHsl, Colour_toRgb as toRgb, Colour_toString as toString };
}

export { Colour as C, type Rgb as R, randomHue as r };
