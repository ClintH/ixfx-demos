...
import { T as ToString, I as IterableAsync } from './Util-lqHq7HUO.js';
import { I as IsEqual } from './IsEqual-f56NWa68.js';
import { I as Interval } from './IntervalType-CQa4mlKV.js';
import { D as DelayOpts, d as delayLoop, i as interval } from './Delay-PO9jy0yJ.js';
import { a as integerUniqueGen } from './index-rTszY0HY.js';
...
type index$1_DelayOptions = DelayOptions;
declare const index$1_Dom: typeof Dom;
type index$1_Gen<V> = Gen<V>;
type index$1_GenFactoryNoInput<Out> = GenFactoryNoInput<Out>;
type index$1_GenOrData<V> = GenOrData<V>;
type index$1_LazyChain<In, Out> = LazyChain<In, Out>;
type index$1_Link<In, Out> = Link<In, Out>;
declare const index$1_Links: typeof Links;
type index$1_LinksWithSource<In, Out> = LinksWithSource<In, Out>;
type index$1_RankArrayOptions = RankArrayOptions;
type index$1_RankFunction<T> = RankFunction<T>;
type index$1_RankOptions = RankOptions;
type index$1_TickOptions = TickOptions;
...
declare namespace index$1 {
  export { type index$1_DelayOptions as DelayOptions, index$1_Dom as Dom, type index$1_Gen as Gen, type index$1_GenFactoryNoInput as GenFactoryNoInput, type index$1_GenOrData as GenOrData, type index$1_LazyChain as LazyChain, type index$1_Link as Link, index$1_Links as Links, type index$1_LinksWithSource as LinksWithSource, type index$1_RankArrayOptions as RankArrayOptions, type index$1_RankFunction as RankFunction, type index$1_RankOptions as RankOptions, type index$1_TickOptions as TickOptions, index$1_addToArray as addToArray, index$1_asArray as asArray, index$1_asCallback as asCallback, index$1_asPromise as asPromise, index$1_asValue as asValue, index$1_fromEvent as fromEvent, index$1_fromFunction as fromFunction, index$1_lazy as lazy, index$1_mergeAsArray as mergeAsArray, index$1_mergeFlat as mergeFlat, index$1_run as run, index$1_runN as runN, index$1_single as single, index$1_synchronise as synchronise, index$1_tick as tick };
}
 ...
 * @param delimiter
 */
declare function stringSegmentsEndToEnd(source: string, delimiter?: string): Generator<string, void, unknown>;
/**
 * Returns chunks of `source`, broken up by `delimiter` (default '.').
 *
 * If `delimiter` is not found, no results are yielded.
 ...
 * @param delimiter
 */
declare function stringSegmentsEndToStart(source: string, delimiter?: string): Generator<string, void, unknown>;
/**
 * Returns chunks of `source`, broken up by `delimiter` (default '.').
 *
 * If `delimiter` is not found, no results are yielded.
 ...
 * @param delimiter
 */
declare function stringSegmentsStartToEnd(source: string, delimiter?: string): Generator<string, void, unknown>;
/**
 * ```js
 ...
 * @param delimiter
 */
declare function stringSegmentsStartToStart(source: string, delimiter?: string): Generator<string, void, unknown>;
/**
...
declare const index_stringSegmentsEndToEnd: typeof stringSegmentsEndToEnd;
declare const index_stringSegmentsEndToStart: typeof stringSegmentsEndToStart;
declare const index_stringSegmentsStartToEnd: typeof stringSegmentsStartToEnd;
declare const index_stringSegmentsStartToStart: typeof stringSegmentsStartToStart;
declare namespace index {
  export { IterableAsync as Async, index$1 as Chain, index_DelayOpts as DelayOpts, IterableSync as Sync, index_count as count, index_delayLoop as delayLoop, index_interval as interval, index_numericPercent as numericPercent, index_numericRange as numericRange, index_numericRangeRaw as numericRangeRaw, index_pingPong as pingPong, index_pingPongPercent as pingPongPercent, integerUniqueGen as randomUniqueInteger, index_stringSegmentsEndToEnd as stringSegmentsEndToEnd, index_stringSegmentsEndToStart as stringSegmentsEndToStart, index_stringSegmentsStartToEnd as stringSegmentsStartToEnd, index_stringSegmentsStartToStart as stringSegmentsStartToStart };
}

export { IterableSync as I, stringSegmentsEndToStart as a, stringSegmentsStartToEnd as b, stringSegmentsStartToStart as c, numericRange as d, count as e, numericPercent as f, index$1 as g, index as i, numericRangeRaw as n, stringSegmentsEndToEnd as s };
