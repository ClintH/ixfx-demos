import { C as CirclePositioned, L as Line, P as Point, e as Rect } from './Types-da56032e.js';
 ...
 * @returns
 */
declare const textPath: (pathReference: string, text: string, parent: SVGElement, opts?: TextPathDrawingOpts, queryOrExisting?: string | SVGTextPathElement) => SVGTextPathElement;
/**
...
type SvgHelper = {
     ...
     * @param queryOrExisting DOM query to look up existing element, or the element instance
     */
    textPath(pathReference: string, text: string, opts?: TextDrawingOpts, queryOrExisting?: string | SVGTextPathElement): SVGTextPathElement;
    /**
     * Creates a line
     * @param line Line
     * @param opts Drawing options
...
export { CircleDrawingOpts as C, DrawingOpts as D, LineDrawingOpts as L, MarkerOpts as M, PathDrawingOpts as P, Svg as S, TextDrawingOpts as T, StrokeOpts as a, MarkerDrawingOpts as b, TextPathDrawingOpts as c, createOrResolve as d, clear as e, createEl as f, applyPathOpts as g, applyOpts as h, applyStrokeOpts as i, SvgHelper as j, getBounds as k, SvgElements as l, makeHelper as m, remove as r, setBounds as s };
