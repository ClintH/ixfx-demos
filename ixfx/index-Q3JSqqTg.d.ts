...
type LinksWithSource0<TFinal> = [
    GenOrData<TFinal> | GenFactoryNoInput<TFinal>
];
type LinksWithSource1<TFinal, T1> = [
    GenOrData<T1> | GenFactoryNoInput<T1>,
    Link<T1, TFinal>
];
type LinksWithSource2<TFinal, T1, T2> = [
    GenOrData<T1> | GenFactoryNoInput<T1>,
    Link<T1, T2>,
    Link<T2, TFinal>
];
type LinksWithSource3<TFinal, T1, T2, T3> = [
    GenOrData<T1> | GenFactoryNoInput<T1>,
    Link<T1, T2>,
    Link<T2, T3>,
    Link<T3, TFinal>
];
type LinksWithSource4<TFinal, T1, T2, T3, T4> = [
    GenOrData<T1> | GenFactoryNoInput<T1>,
    Link<T1, T2>,
    Link<T2, T3>,
    Link<T3, T4>,
 ...
 */
type LinksWithSource<TFinal, T1, T2, T3, T4> = LinksWithSource0<TFinal> | LinksWithSource1<TFinal, T1> | LinksWithSource2<TFinal, T1, T2> | LinksWithSource3<TFinal, T1, T2, T3> | LinksWithSource4<TFinal, T1, T2, T3, T4>;
/**
 * Delay options
 */
type DelayOptions = {
 ...
 * @returns
 */
declare function run<TFinal, T1, T2, T3, T4>(...functions: LinksWithSource<TFinal, T1, T2, T3, T4>): AsyncGenerator<TFinal>;
