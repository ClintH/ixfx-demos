 ...
 */
declare const pingPongPercent: (interval?: number, lower?: number | undefined, upper?: number | undefined, start?: number | undefined, rounding?: number | undefined) => Generator<number, never, unknown>;
/**
 ...
 */
declare const pingPong: (interval: number, lower: number, upper: number, start?: number | undefined, rounding?: number | undefined) => Generator<number, never, unknown>;
