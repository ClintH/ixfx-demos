 ...
 * @returns
 */
declare function iterableFromPoll<V>(sampleRateMs: number, poll: () => V | undefined): AsyncGenerator<Awaited<V & null> | Awaited<V & {}>, void, unknown>;
...
export { AsyncPromiseOrGenerator as A, ContinuouslySyncCallback as B, Continuously as C, DelayOpts as D, ContinuouslyAsyncCallback as E, ContinuouslyOpts as F, continuously as G, HasCompletion as H, Interval as I, debounce as J, DebouncedFunction as K, throttle as L, ModTimer as M, sleep as N, OnStartCalled as O, waitFor as P, delay as Q, RepeatPredicate as R, SleepOpts as S, Timer as T, UpdateFailPolicy as U, everyNth as V, runOnce as W, RetryWithBackOffResult as X, RetryWithBackOffOpts as Y, retryWithBackOff as Z, iterableFromPoll as _, delayLoop as a, interval as b, forEachAsync as c, delayIterable as d, repeatReduce as e, forEach as f, TaskQueue as g, TimerSource as h, index as i, hasElapsedMs as j, completionMs as k, frequencyTimerSource as l, relativeTimer as m, relativeTimerMs as n, relativeTimerTicks as o, frequencyTimer as p, msElapsedTimer as q, repeat as r, intervalToMs as s, ticksElapsedTimer as t, IntervalOpts as u, TimeoutSyncCallback as v, TimeoutAsyncCallback as w, Timeout as x, timeout as y, updateOutdated as z };
