import { T as Triangle, C as Cell, G as Grid, a as CellAccessor, V as VisitGenerator, A as Arc, B as Bezier, E as Ellipse, b as Grid$1, c as Triangle$1 } from './Triangle-8a9bbfd2.js';
import { d as Path, a as Point, R as RectPositioned, C as CirclePositioned, e as Rect, f as Circle, L as Line, g as Point3d, h as Circle$1, i as Line$1, j as Path$1, k as Point$1, l as Rect$1 } from './Point-e1746397.js';
import { a as RandomSource, b as Rgb } from './Arrays-d92e2b0d.js';
import { C as Coord, P as Polar } from './Polar-6ad40287.js';
import { a as TreeNode } from './Trees-187a9348.js';
import { a as Scaler } from './Scaler-58d3f927.js';
 ...
 * @returns
 */
declare const clampMagnitude: (v: Vector, max?: number, min?: number) => Coord | Point;
/**
 * Returns `a + b`.
 *
 ...
 * @returns
 */
declare const sum: (a: Vector, b: Vector) => Coord | Point;
/**
 * Returns `a - b`.
 *
 * Vector is returned in the same type as `a`
 ...
 * @param b
 */
declare const subtract: (a: Vector, b: Vector) => Coord | Point;
/**
 * Returns `a * b`.
 *
 ...
 * @param b
 */
declare const multiply$1: (a: Vector, b: Vector) => Coord | Point;
/**
 * Returns `a / b`.
 *
 * Vector is returned in the same type `a`.
 ...
 * @param b
 */
declare const divide: (a: Vector, b: Vector) => Coord | Point;
...
export { CompoundPath$1 as C, Layout as L, QuadTree as Q, Sphere$1 as S, Vector$1 as V, Waypoint as W, Shape as a, radiansFromAxisX as b, Convolve2d as c, degreeToRadian as d, SurfacePoints as e, index as i, radianToDegree as r };
