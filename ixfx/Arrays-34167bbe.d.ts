import { I as IsEqual } from './Util-e3ea7983.js';
import { E as EasingName, w as weight, d as dotProduct, a as average, b as averageWeighted, m as min, c as maxIndex, e as minIndex, f as max, t as total, g as maxFast, h as minFast, M as MinMaxAvgTotal, i as minMaxAvg } from './NumericArrays-b9b9222a.js';
 ...
 */
declare const filterBetween: <V>(array: readonly V[], predicate: (value: V, index: number, array: readonly V[]) => boolean, startIndex?: number | undefined, endIndex?: number | undefined) => readonly V[];
/**
...
export { Arrays as A, sample as B, Colour$1 as C, Random as R, RandomSource as a, randomElement as b, weightedSkewed as c, defaultRandom as d, weightedInteger as e, gaussianSkewed as f, gaussian as g, float as h, integer as i, shortGuid as j, randomHue as k, guardArray as l, guardIndex as m, areValuesIdentical as n, interleave as o, ensureLength as p, filterBetween as q, randomIndex as r, string as s, randomPluck as t, shuffle as u, without as v, weighted as w, remove as x, groupBy as y, zip as z };
