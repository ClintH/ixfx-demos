...
import { T as ToString, I as IsEqual } from './Util-45757d25.js';
...
declare type ValueSetEventMap<V> = {
    readonly add: {
        readonly value: V;
...
declare type DiscardPolicy = `older` | `newer` | `additions`;
/**
 ...
 * @template V Type of data stored
 */
interface SetMutable<V> extends SimpleEventEmitter<ValueSetEventMap<V>> {
    /**
     * Add `values` to set.
 ...
 */
interface MapOfMutable<V, M> extends SimpleEventEmitter<MapArrayEvents<V>> {
    /**
 ...
 * @template V
 */
interface CircularArray<V> extends Array<V> {
    /**
 ...
 */
interface SimpleMapArrayMutable<V> {
    /**
...
export { ArrayKeys as A, CircularArray as C, DiscardPolicy as D, EitherKey as E, MapOfMutable as M, ObjKeys as O, QueueMutable as Q, Stack as S, ValueSetEventMap as V, MapArrayEvents as a, MultiValue as b, MapMultiOpts as c, MapArrayOpts as d, MapSetOpts as e, MapCircularOpts as f, SimpleMapArrayMutable as g, StackMutable as h, Queue as i, MapImmutable as j, MapMutable as k, SetImmutable as l, SetMutable as m, StackBase as n };
