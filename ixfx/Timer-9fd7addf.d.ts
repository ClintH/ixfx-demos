 ...
 * ```
 */
declare const throttle: (callback: (...args: readonly unknown[]) => void, intervalMinMs: number) => (...args: unknown[]) => void;
/**
...
declare const Timer$1_throttle: typeof throttle;
...
export { Continuously as C, HasCompletion as H, ModTimer as M, Timer$1 as T, Timer as a, TimerSource as b, Timeout as c, debounce as d, timeout as e, continuously as f, delay as g, frequencyTimerSource as h, interval as i, frequencyTimer as j, ticksElapsedTimer as k, msElapsedTimer as m, relativeTimer as r, sleep as s, throttle as t };
