import { D as Drawing } from './Drawing-aba41271';
import { b as CirclePositioned } from './Circle-f30fc0a6';
import { a as Point, f as Line } from './Rect-320e55dc';
import { M as MapOfMutable, C as CircularArray } from './Interfaces-9ecd995f';
...
declare const wrappedRange: (a: number, b: number, min: number, max: number, fn: (rangeMax: number) => number) => number;
declare const lerp$1: (amount: number, a: Hsl, b: Hsl) => Hsl;
declare const lerp_: (amount: number, a: Hsl, b: Hsl) => Hsl;
...
declare const Hsl$1_wrappedRange: typeof wrappedRange;
declare const Hsl$1_lerp_: typeof lerp_;
...
declare namespace Hsl$1 {
  export {
    ...
    Hsl$1_wrappedRange as wrappedRange,
    lerp$1 as lerp,
    Hsl$1_lerp_ as lerp_,
    toCss$2 as toCss,
