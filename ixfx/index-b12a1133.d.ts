...
declare type Lab$2 = readonly [number, number, number];
...
/**
 * Returns hsl from array. Assumes hue is in 0-360 range, while
 * S, L and optional A are in 0-1 range
 * @param a
 * @returns
 */
declare const fromArray$1: (a: readonly number[]) => Hsl | Hsla;
declare const toRgb$1: (hsl: Hsl | Hsla) => Rgb | Rgba;
declare const fromRgba: (rgba: Rgba) => Hsla;
declare const fromRgb$1: (rgb: Rgb | Rgba) => Hsl | Hsla;
declare const lerp$2: (amount: number, a: Hsl, b: Hsl) => Hsl;
declare const toCss$4: (hsl: Hsl | Hsla) => string;
declare const isHsla: (p: Colour) => p is Hsla;
declare const isHsl: (p: Colour) => p is Hsl;
...
declare const toXyz: (lab: Lab) => Xyz;
declare const fromXyz: (xyz: Xyz) => Lab;
declare const isLab: (p: Colour) => p is Lab;
declare const toLab: (c: Colour) => Lab | Laba;
declare const lerp$1: (amount: number, from: Lab | Laba, to: Lab | Laba) => Lab;
declare const toCss$3: (v: Lab) => string;

declare const Lab$1_toXyz: typeof toXyz;
declare const Lab$1_fromXyz: typeof fromXyz;
declare const Lab$1_isLab: typeof isLab;
declare const Lab$1_toLab: typeof toLab;
declare namespace Lab$1 {
  export {
    Lab$1_toXyz as toXyz,
    Lab$1_fromXyz as fromXyz,
    Lab$1_isLab as isLab,
    Lab$1_toLab as toLab,
    lerp$1 as lerp,
    toCss$3 as toCss,
  };
}
...
declare const guard: (rgb: Rgb | Rgba | Readonly<Rgb> | Readonly<Rgba>) => void;
declare const lerp: (amount: number, from: Rgb, to: Rgb) => Rgb;
declare const toCss$2: (v: Rgb | Rgba) => string;
declare const isRgb: (p: Colour) => p is Rgb;
 ...
 */
declare const toRgb: (_xyz: Xyz, white?: Whitepoint) => Rgb;
/**
 * RGB to XYZ
 *
 ...
 */
declare const fromRgb: (rgb: Rgb, white?: Whitepoint) => Xyz;
declare const toCss$1: (v: Xyz) => string;

declare const Xyz$1_max: typeof max;
declare const Xyz$1_toRgb: typeof toRgb;
declare const Xyz$1_fromRgb: typeof fromRgb;
declare namespace Xyz$1 {
  export {
    Xyz$1_max as max,
    Xyz$1_toRgb as toRgb,
    Xyz$1_fromRgb as fromRgb,
    toCss$1 as toCss,
  };
}

declare type Spaces = `hsl` | `rgb` | `lab`;
declare type WithAlpha = (Rgb | Hsl) & {
    alpha: number;
};
declare type Hsl = {
    h: number;
...
declare type Hsla = Hsl & WithAlpha;
declare type Rgb = {
    r: number;
    g: number;
    b: number;
};
declare type Rgba = Rgb & WithAlpha;
declare type Lab = {
    l: number;
    a: number;
    b: number;
};
declare type Laba = Lab & {
    alpa: number;
};
declare type Xyz = {
    x: number;
...
declare type Colour = Hsl | Hsla | Rgb | Rgba | Lab | Laba;
declare type Colourish = string | Colour;
declare const hasAlpha: (p: Colour) => p is WithAlpha;
...
declare const toCss: (c: Colour) => string;
...
type Colour$1_WithAlpha = WithAlpha;
type Colour$1_Hsl = Hsl;
type Colour$1_Hsla = Hsla;
type Colour$1_Rgb = Rgb;
type Colour$1_Rgba = Rgba;
type Colour$1_Lab = Lab;
type Colour$1_Laba = Laba;
type Colour$1_Xyz = Xyz;
type Colour$1_Whitepoint = Whitepoint;
type Colour$1_Colour = Colour;
type Colour$1_Colourish = Colourish;
declare const Colour$1_hasAlpha: typeof hasAlpha;
...
declare const Colour$1_toCss: typeof toCss;
