import { a as Point, f as Line, P as Path, R as RectPositioned, e as Rect } from './Rect-8331264b';
...
declare type ToSvg$1 = {
     ...
     * @param endRadian End
     */
    (origin: Point, radius: number, startRadian: number, endRadian: number): readonly string[];
    /**
     * SVG path for non-positioned arc
     */
    (arc: Arc, origin: Point): readonly string[];
    /**
...
declare type ToSvg = {
    (radius: number, origin: Point): readonly string[];
    (circle: Circle, origin: Point): readonly string[];
    (circle: CirclePositioned): readonly string[];
};
