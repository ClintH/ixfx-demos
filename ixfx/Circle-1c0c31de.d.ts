import { a as Point, f as Line, P as Path, R as RectPositioned, e as Rect } from './Rect-04af8f31';
 ...
 * @returns
 */
declare const compute$1: (arc: ArcPositioned | Arc, t: number, origin?: Point | undefined) => Point;
/**
