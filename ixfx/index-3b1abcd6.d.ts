import { a as RandomSource } from './Arrays-1528d53e.js';
import { j as Easing } from './NumericArrays-20f70b74.js';
import { S as SimpleEventEmitter } from './Events-5892cf2f.js';
import { a as Timer } from './Timer-504c3588.js';
...
/**
 * Creates and runs an envelope, sampling its value at `sampleRateMs`.
 * @param opts Envelope options
 * @param sampleRateMs Sample rate
 * @returns
 */
declare const adsrSample: (opts: EnvelopeOpts, sampleRateMs: number) => Promise<readonly number[]>;
...
export { AdsrOpts as A, CompleteEvent as C, EnvelopeOpts as E, JitterOpts as J, Oscillator as O, StateChangeEvent as S, AdsrTimingOpts as a, Adsr as b, adsr as c, defaultAdsrOpts as d, adsrSample as e, index as i, jitter as j };
