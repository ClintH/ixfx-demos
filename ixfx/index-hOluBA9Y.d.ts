import { I as ICircularArray, c as circularArray } from './CircularArray-a3P3DoYa.js';
import { i as index$6 } from './index-9Zs-bMhA.js';
import { E as EitherKey, A as ArrayKeys, O as ObjectKeys } from './Types-S6h-aw9z.js';
import { a as IStack, I as IStackImmutable } from './IStackImmutable-nAQ6b3zv.js';
import { S as SetStringImmutable, a as SetStringMutable, i as index$5 } from './index-vYxGWJ9K.js';
import { Q as QueueImmutable, i as index$4 } from './index--jZ29AbY.js';
import { c as QueueMutable } from './QueueMutable-EfdcXIOG.js';
import { S as SimpleEventEmitter } from './Events-IwuYx9yI.js';
import { I as Interval } from './IntervalType-CQa4mlKV.js';
import { I as IMapOfMutableExtended, a as IMapOfMutable, M as MapArrayEvents, b as IMapOf } from './IMapOfMutableExtended-de8zpYRs.js';
import { I as IsEqual } from './IsEqual-EdZcaNvH.js';
import { T as ToString } from './ToString-Wn1YmnlL.js';
import { I as IDictionary, a as IWithEntries } from './IMappish-dyh98iBG.js';
...
type index$3_ExpiringMap<K, V> = ExpiringMap<K, V>;
declare const index$3_ExpiringMap: typeof ExpiringMap;
...
type index$3_MapOfSimpleMutable<V> = MapOfSimpleMutable<V>;
declare const index$3_MapOfSimpleMutable: typeof MapOfSimpleMutable;
...
declare namespace index$3 {
  export { index$3_ExpiringMap as ExpiringMap, type index$3_ExpiringMapEvent as ExpiringMapEvent, type index$3_ExpiringMapEvents as ExpiringMapEvents, type Opts as ExpiringMapOpts, type index$3_IMapImmutable as IMapImmutable, type index$3_IMapMutable as IMapMutable, index$3_IMapOf as IMapOf, index$3_IMapOfMutable as IMapOfMutable, index$3_IMapOfMutableExtended as IMapOfMutableExtended, IDictionary as IMappish, index$3_IWithEntries as IWithEntries, index$3_MapArrayEvents as MapArrayEvents, type index$3_MapArrayOpts as MapArrayOpts, type index$3_MapCircularOpts as MapCircularOpts, type index$3_MapMultiOpts as MapMultiOpts, index$3_MapOfMutableImpl as MapOfMutableImpl, index$3_MapOfSimpleMutable as MapOfSimpleMutable, type index$3_MapSetOpts as MapSetOpts, type index$3_MultiValue as MultiValue, index$3_NumberMap as NumberMap, create as expiringMap, immutable$1 as immutable, ofSimpleMutable as mapOfSimpleMutable, mutable$1 as mutable, index$3_ofArrayMutable as ofArrayMutable, index$3_ofCircularMutable as ofCircularMutable, index$3_ofSetMutable as ofSetMutable };
}
