import { M as MapArrayEvents, a as MultiValue, b as MapMultiOpts, c as MapOfMutable, d as MapArrayOpts, e as MapSetOpts, f as MapCircularOpts, C as CircularArray, S as SimpleMapArrayMutable, D as DiscardPolicy, g as Stack$1, h as StackMutable, Q as Queue$1, i as QueueMutable, E as EitherKey, j as MapImmutable, k as MapMutable, A as ArrayKeys, O as ObjKeys, l as SetImmutable, m as SetMutable, n as StackBase, V as ValueSetEventMap } from './Interfaces-1ff610c2.js';
import { S as SimpleEventEmitter } from './Events-f58b1bc8.js';
import { T as ToString } from './Util-cfdf41d9.js';
import { S as Set, s as setMutable } from './Set-cba97f8e.js';
import { T as Trees } from './Trees-7baa359e.js';
import { A as Arrays } from './Arrays-b8f76ef3.js';
