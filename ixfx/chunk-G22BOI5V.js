...
} from "./chunk-H3SB7SKO.js";
import {
  DirectedGraph_exports,
  Reactive_exports,
  Table
} from "./chunk-F423R2YP.js";
import {
  resolveEl
    ...
    for await (const value of input) {
      ...
      for (const subValue of valueArray) {
        if (includeType && typeof subValue !== includeType)
          break;
        const toBest = fn(subValue, best);
        const toWorst = fn(subValue, worst);
        yield max;
      }
    }
  }
