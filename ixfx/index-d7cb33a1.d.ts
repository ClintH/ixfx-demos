...
import { a as Stack, M as MapOfMutable, C as CircularArray } from './Interfaces-6f10c00b';
...
declare const drawSeriesAxis: (series: Series, height: number, drawing: DrawingOpts) => void;
declare const drawSeries: (series: Series, values: CircularArray<number>, plotSize: Rect, drawing: DrawingOpts) => void;
/**
