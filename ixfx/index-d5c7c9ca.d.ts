...
declare const circleEl: (circle: CirclePositioned, parent: SVGElement, opts?: DrawingOpts$1 | undefined, id?: string | undefined) => SVGCircleElement;
declare const lineEl: (line: Line, parent: SVGElement, opts?: DrawingOpts$1 | undefined, id?: string | undefined) => SVGLineElement;
declare const textEl: (pos: Point, text: string, parent: SVGElement, opts?: TextDrawingOpts | undefined, id?: string | undefined) => SVGTextElement;
/**
...
declare const svg: (parent: SVGElement, opts?: DrawingOpts$1 | undefined) => {
    ...
    circle: (circle: CirclePositioned, opts?: DrawingOpts$1 | undefined, id?: string | undefined) => SVGCircleElement;
