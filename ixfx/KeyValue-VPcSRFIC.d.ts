...
declare namespace KeyValue$1 {
  export { type KeyValue$1_BasicType as BasicType, type KeyValue$1_KeyValue as KeyValue, type KeyValue$1_Primitive as Primitive, type KeyValue$1_Sorter as Sorter, type KeyValue$1_StringOrNumber as StringOrNumber, KeyValue$1_byValueString as byValueString, KeyValue$1_getSorter as getSorter, KeyValue$1_isPrimitive as isPrimitive, KeyValue$1_minMaxAvg as minMaxAvg, KeyValue$1_sortByKey as sortByKey, KeyValue$1_sortByValueNumber as sortByValueNumber, KeyValue$1_sortByValueString as sortByValueString };
}

export { type BasicType as B, KeyValue$1 as K, type Primitive as P, type StringOrNumber as S, type KeyValue as a, byValueString as b, sortByValueString as c, sortByValueNumber as d, type Sorter as e, getSorter as g, isPrimitive as i, minMaxAvg as m, sortByKey as s };
