...
__export(generators_exports, {
  ...
  stringSegmentsEndToEnd: () => stringSegmentsEndToEnd,
  stringSegmentsEndToStart: () => stringSegmentsEndToStart,
  stringSegmentsStartToEnd: () => stringSegmentsStartToEnd,
  stringSegmentsStartToStart: () => stringSegmentsStartToStart
});
...
function* stringSegmentsEndToEnd(source, delimiter = `.`) {
...
function* stringSegmentsEndToStart(source, delimiter = `.`) {
  let accumulator = ``;
  const orig = source;
  while (source.length > 0) {
...
function* stringSegmentsStartToEnd(source, delimiter = `.`) {
  let accumulator = ``;
  const orig = source;
  while (source.length > 0) {
...
function* stringSegmentsStartToStart(source, delimiter = `.`) {
  const orig = source;
  while (source.length > 0) {
    yield source;
...
//# sourceMappingURL=chunk-PJQ7J6OJ.js.map