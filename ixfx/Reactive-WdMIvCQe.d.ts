 ...
 * @param transformer
 */
declare const bindTextContent: <V>(elOrQuery: string | HTMLElement, source: Reactive<V>, bindOpts?: Partial<DomBindOptions<V>>) => PipeDomBinding;
/**
 ...
 * @returns
 */
declare const bindHtmlContent: <V>(elOrQuery: string | HTMLElement, source: Reactive<V>, bindOpts?: Partial<DomBindOptions<V>>) => PipeDomBinding;
/**
 ...
 * @returns
 */
declare const bindAttribute: <V>(elOrQuery: string | HTMLElement, source: Reactive<V>, attribute: string, bindOpts?: Partial<DomBindOptions<V>>) => PipeDomBinding;
/**
 ...
 * @returns
 */
declare const bindCssVariable: <V>(elOrQuery: string | HTMLElement, source: Reactive<V>, cssVariable: string, bindOpts?: Partial<DomBindOptions<V>>) => PipeDomBinding;
/**
 ...
 * @returns
 */
declare const create: <V>(source: Reactive<V>, options?: Partial<DomCreateOptions> & Partial<DomBindOptions<V>>) => PipeDomBinding;
/**
 ...
 * @param bindOpts
 */
declare const bind: <V>(elOrQuery: string | HTMLElement, source: Reactive<V>, bindOpts?: Partial<DomBindOptions<V>>) => PipeDomBinding;
/**
 ...
 * @returns
 */
declare const bindUpdate: <V>(elOrQuery: string | HTMLElement, source: Reactive<V>, updater: (v: V, el: HTMLElement) => void) => PipeDomBinding;
 ...
 * @returns
 */
declare const bindDiffUpdate: <V>(elOrQuery: string | HTMLElement, source: ReactiveDiff<V>, updater: (diffs: Array<Change<any>>, el: HTMLElement) => void, opts?: Partial<BindUpdateOpts<V>>) => PipeDomBinding & {
    refresh: () => void;
};
/**
 ...
 * @returns
 */
declare const createUpdate: <V>(source: Reactive<V>, updater: (v: V, el: HTMLElement) => void, options?: Partial<DomCreateOptions>) => PipeDomBinding;
...
declare const ReactiveDom_bindAttribute: typeof bindAttribute;
declare const ReactiveDom_bindCssVariable: typeof bindCssVariable;
...
declare const ReactiveDom_create: typeof create;
declare const ReactiveDom_createUpdate: typeof createUpdate;
declare const ReactiveDom_win: typeof win;
declare namespace ReactiveDom {
  export { type ReactiveDom_BindUpdateOpts as BindUpdateOpts, type ReactiveDom_DomBindOptions as DomBindOptions, type ReactiveDom_DomCreateOptions as DomCreateOptions, type ReactiveDom_PipeDomBinding as PipeDomBinding, ReactiveDom_bind as bind, ReactiveDom_bindAttribute as bindAttribute, ReactiveDom_bindCssVariable as bindCssVariable, ReactiveDom_bindDiffUpdate as bindDiffUpdate, ReactiveDom_bindHtmlContent as bindHtmlContent, ReactiveDom_bindTextContent as bindTextContent, ReactiveDom_bindUpdate as bindUpdate, ReactiveDom_create as create, ReactiveDom_createUpdate as createUpdate, ReactiveDom_win as win };
}
