...
var sum = function(aOrX, bOrAy, bX, bY) {
  let a;
  let b;
  if (isPoint(aOrX)) {
    a = aOrX;
    if (isPoint(bOrAy)) {
      ...
      if (bX === void 0)
        throw new Error(`bX required`);
      if (bY === void 0)
        throw new Error(`bY required`);
      b = { x: bX, y: bY };
    }
  } else if (!isPoint(bOrAy)) {
    a = { x: aOrX, y: bOrAy };
    if (bX === void 0)
      throw new Error(`bX required`);
    if (bY === void 0)
  ...
  if (a === void 0)
    throw new Error(`a param missing`);
  if (b === void 0)
    throw new Error(`b param missing`);
  guard(a, `a`);
  guard(b, `b`);
  return {
    x: a.x + b.x,
...
//# sourceMappingURL=chunk-OUCQ22H4.js.map