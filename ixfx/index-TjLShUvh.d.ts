import { T as ToString, I as IterableAsync } from './Util-lMkeEZwv.js';
...
declare function flatten$2<V>(it: Iterable<V>): Generator<any, void, unknown>;
/**
...
declare function fromIterable$2<T>(iterable: Iterable<T>): Generator<T, void, unknown>;
/**
 ...
 */
declare function fromArray$2<V>(array: Array<V>): Generator<V>;
...
declare namespace IterableSync {
  export { chunks$1 as chunks, IterableSync_chunksOverlapping as chunksOverlapping, concat$1 as concat, dropWhile$1 as dropWhile, equals$1 as equals, every$1 as every, fill$1 as fill, filter$2 as filter, find$1 as find, IterableSync_first as first, flatten$2 as flatten, forEach$1 as forEach, fromArray$2 as fromArray, fromIterable$2 as fromIterable, IterableSync_last as last, map$1 as map, max$2 as max, min$2 as min, reduce$1 as reduce, IterableSync_repeat as repeat, slice$1 as slice, some$1 as some, toArray$1 as toArray, unique$1 as unique, uniqueByValue$1 as uniqueByValue, until$1 as until, IterableSync_yieldNumber as yieldNumber, zip$1 as zip };
}
 ...
 * @returns
 */
declare function flatten$1<In, Out>(flattener: (v: Array<In>) => Out): Link<Array<In>, Out>;
/**
...
declare namespace Links {
  export { Links_average as average, Links_chunk as chunk, Links_debounce as debounce, Links_delay as delay, Links_drop as drop, Links_duration as duration, filter$1 as filter, flatten$1 as flatten, max$1 as max, min$1 as min, Links_rank as rank, Links_rankArray as rankArray, Links_take as take, Links_tally as tally, Links_total as total, Links_transform as transform };
}
...
declare function fromArray$1<Out>(it: Array<Out>, delay?: Interval): GenFactoryNoInput<Out>;

declare function fromEvent$1<Out>(target: EventTarget, name: string): GenFactoryNoInput<Out>;
...
declare function fromIterable$1<Out>(it: Iterable<Out> | AsyncIterable<Out>): GenFactoryNoInput<Out>;
...
declare const oncePromise: (target: EventTarget, name: string) => Promise<any>;
/**
...
type Chains_RankArrayOptions = RankArrayOptions;
type Chains_RankFunction<T> = RankFunction<T>;
type Chains_RankOptions = RankOptions;
...
declare const Chains_fromFunction: typeof fromFunction;
...
declare const Chains_oncePromise: typeof oncePromise;
...
declare const Chains_tick: typeof tick;
declare namespace Chains {
  export { type Chains_CombineLatestOptions as CombineLatestOptions, type Chains_DelayOptions as DelayOptions, Chains_Dom as Dom, type Chains_Gen as Gen, type Chains_GenFactoryNoInput as GenFactoryNoInput, type Chains_GenOrData as GenOrData, type Chains_GenValueTypeObject as GenValueTypeObject, type Chains_LazyChain as LazyChain, type Chains_Link as Link, Chains_Links as Links, type Chains_LinksWithSource as LinksWithSource, type Chains_RankArrayOptions as RankArrayOptions, type Chains_RankFunction as RankFunction, type Chains_RankOptions as RankOptions, type Chains_SyncOptions as SyncOptions, type Chains_TickOptions as TickOptions, Chains_addToArray as addToArray, Chains_asArray as asArray, Chains_asCallback as asCallback, Chains_asPromise as asPromise, Chains_asValue as asValue, combineLatestToArray$1 as combineLatestToArray, Chains_combineLatestToObject as combineLatestToObject, fromArray$1 as fromArray, fromEvent$1 as fromEvent, Chains_fromFunction as fromFunction, fromIterable$1 as fromIterable, Chains_isGenFactoryNoInput as isGenFactoryNoInput, Chains_lazy as lazy, Chains_mergeFlat as mergeFlat, Chains_oncePromise as oncePromise, Chains_resolveToAsyncGen as resolveToAsyncGen, Chains_resolveToGen as resolveToGen, Chains_run as run, Chains_runN as runN, Chains_single as single, Chains_syncToArray as syncToArray, Chains_tick as tick };
}
