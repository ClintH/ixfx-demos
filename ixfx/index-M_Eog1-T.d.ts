...
/**
 * Creates a HTML element per value. By default uses
 * object reference to check if values are equal.
 *
 * ```js
...
declare const index$2_runN: typeof runN;
