import { J as JitterOpts, a as Jitterer, j as jitter, b as jitterAbsolute, p as pingPong, c as pingPongPercent } from './Jitter-DO1UcZ-N.js';
import { S as SimpleEventEmitter } from './Events-QY1ngixJ.js';
import { E as Easing } from './Easing-Wc_ASUAL.js';
...
declare const index_perMinute: typeof perMinute;
...
declare namespace index {
  export { type index_Adsr as Adsr, type index_AdsrIterableOpts as AdsrIterableOpts, type index_AdsrOpts as AdsrOpts, type index_AdsrTimingOpts as AdsrTimingOpts, type index_CompleteEvent as CompleteEvent, Easing as Easings, type index_EnvelopeOpts as EnvelopeOpts, Envelope as Envelopes, type index_Events as Events, index_Forces as Forces, index_JitterOpts as JitterOpts, index_Jitterer as Jitterer, Oscillator as Oscillators, type index_StateChangeEvent as StateChangeEvent, index_adsr as adsr, index_adsrIterable as adsrIterable, index_defaultAdsrOpts as defaultAdsrOpts, index_jitter as jitter, index_jitterAbsolute as jitterAbsolute, index_perMinute as perMinute, index_perSecond as perSecond, index_pingPong as pingPong, index_pingPongPercent as pingPongPercent };
}

export { type AdsrOpts as A, type CompleteEvent as C, Envelope as E, Forces as F, Oscillator as O, type StateChangeEvent as S, perMinute as a, type EnvelopeOpts as b, type AdsrTimingOpts as c, defaultAdsrOpts as d, type Events as e, type Adsr as f, adsr as g, adsrIterable as h, index as i, type AdsrIterableOpts as j, perSecond as p };
