 ...
 * @returns
 */
declare const percentRange: (interval?: number, repeating?: boolean, start?: number, end?: number) => Generator<number, void, unknown>;
/**
...
declare const Generators_percentRange: typeof percentRange;
...
declare namespace Generators {
  export {
    ...
    Generators_percentRange as percentRange,
    Generators_pingPongPercent as pingPongPercent,
    Generators_pingPong as pingPong,
  };
}

export { Generators as G, numericRange as a, pingPongPercent as b, pingPong as c, interval as i, numericRangeRaw as n, percentRange as p };
