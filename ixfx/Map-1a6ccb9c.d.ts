import { I as IsEqual, T as ToString } from './Util-3af86bef.js';
 ...
 * @returns
 */
declare const getClosestIntegerKey: <V>(data: Map<number, any>, target: number) => number;
/**
...
declare const Map$1_getClosestIntegerKey: typeof getClosestIntegerKey;
...
declare namespace Map$1 {
  export {
    ...
    Map$1_getClosestIntegerKey as getClosestIntegerKey,
    Map$1_getOrGenerate as getOrGenerate,
...
export { ExpiringMap as E, GetOrGenerate as G, Map$1 as M, Opts as O, Mappish as a, getOrGenerate as b, getOrGenerateSync as c, deleteByValue as d, addKeepingExisting as e, sortByValueProperty as f, getClosestIntegerKey as g, hasKeyValue as h, hasAnyValue as i, filter as j, fromIterable as k, fromObject as l, addObject as m, find as n, mapToObjTransform as o, transformMap as p, toObject as q, mapToArray as r, sortByValue as s, toArray as t, MergeReconcile as u, mergeByKey as v, create as w, ExpiringMapEvent as x, ExpiringMapEvents as y, zipKeyValue as z };
