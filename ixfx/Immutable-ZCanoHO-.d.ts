 ...
 * @param changes
 */
declare const applyChanges: <V extends Record<string, any>>(source: V, changes: Array<Change<any>>) => V;
/**
...
type Immutable_ReadonlyRemapObjectPropertyType<OriginalType, PropertyType> = ReadonlyRemapObjectPropertyType<OriginalType, PropertyType>;
...
declare const Immutable_isEmptyEntries: typeof isEmptyEntries;
declare const Immutable_isEqualContextString: typeof isEqualContextString;
declare const Immutable_keysToNumbers: typeof keysToNumbers;
declare const Immutable_map: typeof map;
declare const Immutable_updateByPath: typeof updateByPath;
declare namespace Immutable {
  export { type Immutable_Change as Change, type Immutable_CompareDataOptions as CompareDataOptions, type Immutable_IsEqualContext as IsEqualContext, type Immutable_ReadonlyRemapObjectPropertyType as ReadonlyRemapObjectPropertyType, type Immutable_RemapObjectPropertyType as RemapObjectPropertyType, Immutable_applyChanges as applyChanges, Immutable_compareData as compareData, Immutable_compareKeys as compareKeys, Immutable_getField as getField, Immutable_getPaths as getPaths, Immutable_getPathsAndData as getPathsAndData, Immutable_isEmptyEntries as isEmptyEntries, Immutable_isEqualContextString as isEqualContextString, Immutable_keysToNumbers as keysToNumbers, Immutable_map as map, Immutable_updateByPath as updateByPath };
}

export { type Change as C, Immutable as I, type ReadonlyRemapObjectPropertyType as R, type IsEqualContext as a, type CompareDataOptions as b, compareKeys as c, compareData as d, applyChanges as e, isEmptyEntries as f, getField as g, type RemapObjectPropertyType as h, isEqualContextString as i, getPaths as j, keysToNumbers as k, getPathsAndData as l, map as m, updateByPath as u };
