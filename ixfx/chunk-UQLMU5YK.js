...
function fromNumbers2(xOrWidth, yOrHeight, width, height4) {
  if (width === void 0 || height4 === void 0) {
    return { width: xOrWidth, height: yOrHeight };
  }
  return { x: xOrWidth, y: yOrHeight, width, height: height4 };
}
var isEqual = (a, b) => {
...
var normaliseByRect2 = (rect2, normaliseBy) => {
  if (isPositioned(rect2)) {
    return Object.freeze({
      x: rect2.x / normaliseBy.width,
      y: rect2.y / normaliseBy.height,
      width: rect2.width / normaliseBy.width,
      height: rect2.height / normaliseBy.height
    });
  } else {
    return Object.freeze({
      width: rect2.width / normaliseBy.width,
...
//# sourceMappingURL=chunk-UQLMU5YK.js.map