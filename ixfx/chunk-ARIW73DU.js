import {
  getCssVariable
} from "./chunk-Q3Q65ZLU.js";
import {
  fromNumbers
} from "./chunk-UGVTOQVJ.js";
import {
  __export
...
var line = (line2, parent, opts, queryOrExisting) => {
  ...
  lineEl2.setAttributeNS(null, `x1`, line2.a.x.toString());
  lineEl2.setAttributeNS(null, `y1`, line2.a.y.toString());
  lineEl2.setAttributeNS(null, `x2`, line2.b.x.toString());
  lineEl2.setAttributeNS(null, `y2`, line2.b.y.toString());
  if (opts)
...
var textPath = (pathRef, text2, parent, opts, queryOrExisting) => {
  ...
  textUpdate(textEl2, void 0, void 0, opts);
...
var svg = (parent, parentOpts) => {
  ...
  const o = {
    text: (text2, pos, opts, queryOrExisting) => (void 0)(text2, parent, pos, opts, queryOrExisting),
    textPath: (pathRef, text2, opts, queryOrExisting) => (void 0)(pathRef, text2, parent, opts, queryOrExisting),
    line: (line2, opts, queryOrExisting) => (void 0)(line2, parent, opts, queryOrExisting),
    circle: (circle2, opts, queryOrExisting) => (void 0)(circle2, parent, opts, queryOrExisting),
