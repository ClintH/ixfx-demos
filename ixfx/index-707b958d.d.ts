...
import { a as Point, C as CardinalDirection } from './Point-69dee631.js';
import { S as ScaleFn } from './Scaler-7ffaf22e.js';
 ...
 * ```
 */
declare const dataTableList: (parentOrQuery: Readonly<HTMLElement | string>, data: ReadonlyMap<string, object>) => (data: ReadonlyMap<string, object>) => void;
/**
 ...
 * ```
 */
declare const dataTable: (parentOrQuery: Readonly<HTMLElement | string>, data?: object, opts?: DataTableOpts) => (data: object) => void;
/**
...
type CreateUpdateElement<V> = (item: V, el: Readonly<HTMLElement | null>) => HTMLElement;
declare const reconcileChildren: <V>(parentEl: Readonly<HTMLElement>, list: ReadonlyMap<string, V>, createUpdate: CreateUpdateElement<V>) => void;
...
export { DataFormatter as A, DataTableOpts as B, CanvasResizeArgs as C, DragDrop as D, ElementResizeArgs as E, dataTable as F, clear as G, themeChangeObservable as H, resizeObservable as I, copyToClipboard as J, CreateUpdateElement as K, LogOpts as L, reconcileChildren as M, pointerVisualise as N, Opts as O, PluckOpts as P, defaultErrorHandler as Q, Rx as R, TransformOpts as T, Log as a, DomRxOpts as b, PointSpaces as c, ElPositionOpts as d, positionFn as e, cardinalPosition as f, positionRelative as g, positionFromMiddle as h, index as i, fullSizeElement as j, CanvasOpts as k, log as l, canvasHelper as m, fullSizeCanvas as n, cycleCssClass as o, pointScaler as p, parentSize as q, rx as r, getTranslation as s, parentSizeCanvas as t, resolveEl as u, viewportToSpace as v, windowResize as w, createAfter as x, createIn as y, dataTableList as z };
