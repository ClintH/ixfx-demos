 ...
 * @returns
 */
declare const relation: (a: Point | number, b?: number | undefined) => (aa: Point | number, bb?: number | undefined) => {
    angle: number;
    distance: number;
    centroid: Point;
};
...
export { Circle$1 as C, Line$1 as L, Point as P, RectPositioned as R, PolyLine as a, Path as b, Rect$1 as c, Point$1 as d, Path$1 as e, Rect as f, Line as g, CirclePositioned as h };
