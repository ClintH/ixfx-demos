import { T as TraversableTree$1, a as TreeNode, S as SimplifiedNode, L as LabelledSingleValue, b as LabelledNode, c as LabelledValue, d as LabelledValues } from './Types-d483f031.js';
 ...
 */
declare const compare: <T>(a: TreeNode<T>, b: TreeNode<T>, eq?: IsEqual<T> | undefined) => DiffNode<T>;
/**
...
declare const findChildByValue$1: <T>(value: T, parent: TreeNode<T>, eq?: IsEqual<T>) => false | TreeNode<T>;
/**
...
declare namespace TreeMutable {
  export {
    TreeMutable_WrappedNode as WrappedNode,
    TreeMutable_add as add,
    TreeMutable_addValue as addValue,
    asDynamicTraversable$1 as asDynamicTraversable,
    breadthFirst$1 as breadthFirst,
    children$1 as children,
    childrenLength$1 as childrenLength,
    TreeMutable_compare as compare,
    TreeMutable_computeMaxDepth as computeMaxDepth,
    TreeMutable_createNode as createNode,
    depthFirst$2 as depthFirst,
    findAnyChildByValue$1 as findAnyChildByValue,
    findChildByValue$1 as findChildByValue,
    followValue$1 as followValue,
    TreeMutable_fromPlainObject as fromPlainObject,
    TreeMutable_getRoot as getRoot,
    hasAnyChild$1 as hasAnyChild,
    hasAnyParent$1 as hasAnyParent,
    hasChild$1 as hasChild,
    hasParent$1 as hasParent,
    parents$1 as parents,
    TreeMutable_remove as remove,
    TreeMutable_root as root,
    TreeMutable_rootWrapped as rootWrapped,
    TreeMutable_setChildren as setChildren,
    TreeMutable_stripParentage as stripParentage,
    TreeMutable_throwTreeTest as throwTreeTest,
    toStringDeep$2 as toStringDeep,
    TreeMutable_treeTest as treeTest,
    TreeMutable_value as value,
    TreeMutable_wrap as wrap,
  };
}
...
declare namespace Pathed {
  export {
    PathOpts$1 as PathOpts,
    Pathed_addValueByPath as addValueByPath,
    Pathed_childrenLengthByPath as childrenLengthByPath,
    Pathed_clearValuesByPath as clearValuesByPath,
    create$1 as create,
    Pathed_removeByPath as removeByPath,
    Pathed_valueByPath as valueByPath,
    Pathed_valuesByPath as valuesByPath,
  };
}
 ...
 * @returns
 */
declare function getByPath<T extends object>(path: string, node: T, opts?: PathOpts): Entry;
/**
 ...
 * @returns
 */
declare function traceByPath<T extends object>(path: string, node: T, opts?: PathOpts): Iterable<EntryWithAncestors>;
/**
...
declare namespace TraverseObject {
  export {
    TraverseObject_ChildrenOptions as ChildrenOptions,
    TraverseObject_CreateOptions as CreateOptions,
    TraverseObject_Entry as Entry,
    TraverseObject_EntryStatic as EntryStatic,
    TraverseObject_EntryWithAncestors as EntryWithAncestors,
    TraverseObject_PathOpts as PathOpts,
    TraverseObject_asDynamicTraversable as asDynamicTraversable,
    TraverseObject_children as children,
    TraverseObject_create as create,
    TraverseObject_createSimplified as createSimplified,
    TraverseObject_createWrapped as createWrapped,
    depthFirst$1 as depthFirst,
    TraverseObject_getByPath as getByPath,
    TraverseObject_prettyPrint as prettyPrint,
    TraverseObject_prettyPrintEntries as prettyPrintEntries,
    toStringDeep$1 as toStringDeep,
    TraverseObject_traceByPath as traceByPath,
  };
}
 ...
 * @returns
 */
declare const hasAnyParent: <T>(child: TraversableTree$1<T>, possibleParent: TraversableTree$1<T>, eq?: IsEqual<TraversableTree$1<T>> | undefined) => boolean;
declare const hasAnyParentValue: <T>(child: TraversableTree$1<T>, possibleParentValue: T, eq?: IsEqual<T> | undefined) => boolean;
declare const findAnyParentByValue: <TValue>(child: TraversableTree$1<TValue>, possibleParentValue: TValue, eq?: IsEqual<TValue> | undefined) => TraversableTree$1<TValue> | undefined;
/**
 ...
 * @returns
 */
declare function depthFirst<T>(root: TraversableTree$1<T>): IterableIterator<TraversableTree$1<T>>;
/**
...
declare namespace TraversableTree {
  export {
    TraversableTree_breadthFirst as breadthFirst,
    TraversableTree_childrenLength as childrenLength,
    TraversableTree_couldAddChild as couldAddChild,
    TraversableTree_depthFirst as depthFirst,
    TraversableTree_find as find,
    TraversableTree_findAnyChildByValue as findAnyChildByValue,
    TraversableTree_findAnyParentByValue as findAnyParentByValue,
    TraversableTree_findByValue as findByValue,
    TraversableTree_findChildByValue as findChildByValue,
    TraversableTree_findParentByValue as findParentByValue,
    TraversableTree_followValue as followValue,
    TraversableTree_hasAnyChild as hasAnyChild,
    TraversableTree_hasAnyChildValue as hasAnyChildValue,
    TraversableTree_hasAnyParent as hasAnyParent,
    TraversableTree_hasAnyParentValue as hasAnyParentValue,
    TraversableTree_hasChild as hasChild,
    TraversableTree_hasChildValue as hasChildValue,
    TraversableTree_hasParent as hasParent,
    TraversableTree_hasParentValue as hasParentValue,
    TraversableTree_parents as parents,
    TraversableTree_siblings as siblings,
    TraversableTree_toString as toString,
    TraversableTree_toStringDeep as toStringDeep,
  };
}

declare const toTraversable: <T>(node: object | TreeNode<T> | TraversableTree$1<T>) => TraversableTree$1<any>;
...
declare namespace index {
  export {
    index_DiffAnnotation as DiffAnnotation,
    index_DiffNode as DiffNode,
    TraverseObject as FromObject,
    index_LabelledNode as LabelledNode,
    index_LabelledSingleValue as LabelledSingleValue,
    index_LabelledValue as LabelledValue,
    index_LabelledValues as LabelledValues,
    TreeMutable as Mutable,
    index_Pathed as Pathed,
    index_SimplifiedNode as SimplifiedNode,
    TraversableTree$1 as TraversableTree,
    TraversableTree as Traverse,
    index_TreeNode as TreeNode,
    compare$1 as compare,
    index_isTraversable as isTraversable,
    index_isTreeNode as isTreeNode,
    index_toTraversable as toTraversable,
  };
}

export { DiffAnnotation as D, Pathed as P, TreeMutable as T, isTreeNode as a, isTraversable as b, TraverseObject as c, TraversableTree as d, DiffNode as e, compare$1 as f, index as i, toTraversable as t };
