 ...
 */
declare const filterBetween: <V>(array: ReadonlyArray<V> | Array<V>, predicate: (value: V, index: number, array: ReadonlyArray<V> | Array<V>) => boolean, startIndex?: number, endIndex?: number) => Array<V>;
 ...
 * @returns
 */
declare const valuesEqual: <V>(array: ReadonlyArray<V> | Array<V>, equality?: IsEqual<V>) => boolean;
 ...
 * @returns
 */
declare const until: <V, A>(data: ReadonlyArray<V> | Array<V>, predicate: (v: V, accumulator: A) => readonly [stop: boolean, acc: A], initial: A) => Array<V>;
/**
 ...
 */
declare const mergeByKey: <V>(keyFunction: ToString<V>, reconcile: MergeReconcile<V>, ...arrays: ReadonlyArray<ReadonlyArray<V>>) => Array<V>;
/**
 ...
 * @returns
 */
declare const reducePairwise: <V, X>(array: ReadonlyArray<V>, reducer: (accumulator: X, a: V, b: V) => X, initial: X) => X;
/**
 ...
 * @param isEqual
 */
declare const isEqual: <V>(arrayA: Array<V>, arrayB: Array<V>, isEqual?: (a: V, b: V) => boolean) => boolean;
/**
