...
var interpolate3 = (arc, amount, origin) => {
  guard3(arc);
...
var toPath2 = (arc) => {
  ...
  return Object.freeze({
    ...arc,
    interpolate: (amount) => interpolate3(arc, amount),
    bbox: () => bbox3(arc),
    length: () => length2(arc),
...
var bbox3 = (arc) => {
  if (isPositioned(arc)) {
    const middle = interpolate3(arc, 0.5);
...
var guard5 = (cell, paramName = `Param`, grid) => {
  if (cell === void 0)
