...
import { a as LogOption } from './Debug-1701deb8.js';
...
type Runner<V extends Transitions> = {
    readonly run: () => Promise<MachineState<V> | boolean>;
 ...
 * @returns
 */
declare function init$1<V extends Transitions>(machine: Machine<V> | Transitions, handlersOrOpts: readonly StatesHandler<V>[] | DriverOpts<V>): Promise<Runner<V>>;
 ...
 */
type StateNames<V extends Transitions> = keyof V;
 ...
 * @returns
 */
declare const init: <V extends Transitions>(stateMachine: Transitions | Machine<V> | TransitionsStrict, initialState?: keyof V | undefined) => MachineState<V>;
 ...
 * @returns
 */
declare const possible: <V extends Transitions>(sm: MachineState<V>) => (keyof V | null)[];
 ...
 * @returns
 */
declare const to: <V extends Transitions>(sm: MachineState<V>, toState: keyof V) => MachineState<V>;
 ...
 * @returns
 */
declare const isValidTransition: <V extends Transitions>(sm: MachineState<V>, toState: keyof V) => boolean;
declare const validateTransition: <V extends Transitions>(sm: MachineState<V>, toState: keyof V) => void;
/**
