...
declare function query(): Link<string, HTMLElement>;

type Dom_WrappedElement = WrappedElement;
declare const Dom_query: typeof query;
declare namespace Dom {
  export { type Dom_WrappedElement as WrappedElement, Dom_query as query };
}
