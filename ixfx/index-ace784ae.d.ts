import { C as Circle, A as Arc, B as Bezier } from './Circle-bb5efda9';
import { P as Path, a as Point, R as RectPositioned, L as Line, b as Rect, c as Point$1, d as Path$1 } from './Rect-99bb2c4c';
import { S as SetMutable } from './Interfaces-9d8a5fa1';
...
declare const polarToCartesian: (origin: Point, distance: number, angleRadians: number) => {
    x: number;
    y: number;
};
...
declare const index_polarToCartesian: typeof polarToCartesian;
declare namespace index {
  export {
    ...
    index_polarToCartesian as polarToCartesian,
  };
}

export { CompoundPath$1 as C, Grid$1 as G, radiansFromAxisX as a, degreeToRadian as d, index as i, polarToCartesian as p, radianToDegree as r };
