...
declare const toRgb: (hsl: Hsl | Hsla) => Rgb | Rgba;
...
declare const toCss$3: (hsl: Hsl | Hsla) => string;
declare const isHsla: (p: Colour) => p is Hsla;
declare const isHsl: (p: Colour) => p is Hsl;

declare const Hsl$1_toRgb: typeof toRgb;
...
declare const toCss$2: (v: Lab) => string;
...
declare const toCss$1: (v: Rgb | Rgba) => string;
