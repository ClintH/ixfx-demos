...
import { a as KeyValue, S as SortSyles } from './KeyValue-6zP_QgTW.js';
import { N as NumberTracker, T as TrackedValueOpts, a as TrackerBase, b as TimestampedObject, c as TrackedValueMap, d as NumberTrackerResults, P as PrimitiveTracker, e as Timestamped, f as TimestampedPrimitive, n as numberTracker } from './NumberTracker-UFa0HdgL.js';
import { af as PointRelationResult, P as Point, ag as PointRelation, p as PolyLine, L as Line } from './index-hzykKOZZ.js';
import { C as Coord } from './Polar-d4ZsOE9z.js';
import { a as Reactive } from './Reactive-6uWcxhv2.js';
import { I as Interval } from './IntervalType-zqeNLRm6.js';
import { I as IMapImmutable } from './MakeGlobal-fOzzfx--.js';
...
/**
 * Some kind of (async) generator or an array of data
 */
...
type LinksWithSource0<In> = [
    Link<In, In> | GenOrData<In> | GenFactoryNoInput<In>
];
type LinksWithSource1<In, OutFinal> = [
    Link<In, In> | GenOrData<In> | GenFactoryNoInput<In>,
    Link<In, OutFinal>
];
type LinksWithSource2<In1, Out1, Out2> = [
    Link<In1, In1> | GenOrData<In1> | GenFactoryNoInput<In1>,
    Link<In1, Out1>,
    Link<Out1, Out2>
];
type LinksWithSource3<In1, Out1, Out2, Out3> = [
    Link<In1, In1> | GenOrData<In1> | GenFactoryNoInput<In1>,
    Link<In1, Out1>,
    Link<Out1, Out2>,
    Link<Out2, Out3>
];
type LinksWithSource4<In1, Out1, Out2, Out3, Out4> = [
    Link<In1, In1> | GenOrData<In1> | GenFactoryNoInput<In1>,
    Link<In1, Out1>,
    Link<Out1, Out2>,
    Link<Out2, Out3>,
 ...
 */
type LinksWithSourceN<In, Out> = [
    Link<In, any> | GenOrData<In> | GenFactoryNoInput<In>,
    ...Array<Link<any, any>>,
    Link<any, Out>
];
type LinksWithSource<In1, Out1 = void, Out2 = void, Out3 = void, Out4 = void> = LinksWithSource0<In1> | LinksWithSource1<In1, Out1> | LinksWithSource2<In1, Out1, Out2> | LinksWithSource3<In1, Out1, Out2, Out3> | LinksWithSource4<In1, Out1, Out2, Out3, Out4> | LinksWithSourceN<In1, Out1>;
/**
 ...
 * @returns
 */
declare function run<In1, Out1>(...functions: LinksWithSource<In1, Out1>): AsyncGenerator<Out1>;
/**
 ...
 * @returns
 */
declare function prepare<In, Out>(...functions: Links$1<In, Out>): (source: GenOrData<In> | GenFactoryNoInput<Out>) => AsyncGenerator<Out, any, unknown>;

declare const index$2_Dom: typeof Dom;
declare const index$2_Links: typeof Links;
declare const index$2_addToArray: typeof addToArray;
declare const index$2_asArray: typeof asArray;
declare const index$2_asCallback: typeof asCallback;
declare const index$2_asPromise: typeof asPromise;
declare const index$2_asValue: typeof asValue;
declare const index$2_fromEvent: typeof fromEvent;
declare const index$2_fromFunction: typeof fromFunction;
declare const index$2_lazy: typeof lazy;
declare const index$2_mergeAsArray: typeof mergeAsArray;
declare const index$2_mergeFlat: typeof mergeFlat;
declare const index$2_prepare: typeof prepare;
declare const index$2_run: typeof run;
declare const index$2_single: typeof single;
declare const index$2_synchronise: typeof synchronise;
declare const index$2_tick: typeof tick;
declare namespace index$2 {
  export { index$2_Dom as Dom, index$2_Links as Links, index$2_addToArray as addToArray, index$2_asArray as asArray, index$2_asCallback as asCallback, index$2_asPromise as asPromise, index$2_asValue as asValue, index$2_fromEvent as fromEvent, index$2_fromFunction as fromFunction, index$2_lazy as lazy, index$2_mergeAsArray as mergeAsArray, index$2_mergeFlat as mergeFlat, index$2_prepare as prepare, index$2_run as run, index$2_single as single, index$2_synchronise as synchronise, index$2_tick as tick };
}
