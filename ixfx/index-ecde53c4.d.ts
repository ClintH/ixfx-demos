...
import { a as Point } from './Point-73de3e62.js';
...
declare type DataFormatter = (data: object, path: string) => string;
/**
 ...
 * ```
 */
declare const dataTable: (parentOrQuery: HTMLElement | string, data?: object, formatter?: DataFormatter) => (data: object) => void;
/**
...
export { CanvasResizeArgs as C, DomRxOpts as D, ElementResizeArgs as E, LogOpts as L, Opts as O, PluckOpts as P, Rx as R, TransformOpts as T, Log as a, fullSizeCanvas as b, parentSizeCanvas as c, resolveEl as d, createAfter as e, fullSizeElement as f, getTranslation as g, createIn as h, index as i, dataTableList as j, DataFormatter as k, log as l, dataTable as m, clear as n, resizeObservable as o, parentSize as p, copyToClipboard as q, rx as r, CreateUpdateElement as s, themeChangeObservable as t, reconcileChildren as u, pointerVisualise as v, windowResize as w, defaultErrorHandler as x };
