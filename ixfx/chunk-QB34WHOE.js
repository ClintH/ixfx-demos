...
var interpolate = (a, b, amt) => ({ x: (1 - amt) * a.x + amt * b.x, y: (1 - amt) * a.y + amt * b.y });
var from = (xOrArray, y) => {
...
var interpolate2 = (circle, t2) => point2(circle, t2 * piPi2);
...
var toPath3 = (circle) => {
  ...
  return Object.freeze({
    ...circle,
    interpolate: (t2) => interpolate2(circle, t2),
    bbox: () => bbox3(circle),
...
var interpolate3 = (paths, t2, useWidth, dimensions) => {
...
var fromPaths = (...paths) => {
  ...
  return Object.freeze({
    ...
    interpolate: (t2, useWidth = false) => interpolate3(paths, t2, useWidth, dims),
    bbox: () => bbox4(paths),
...
var guard4 = (cell, paramName = `Param`, grid) => {
  if (cell === void 0)
...
var toPath4 = (line) => {
  ...
  return Object.freeze({
    ...line,
    length: () => length3(a, b),
    interpolate: (t2) => compute2(a, b, t2),
    bbox: () => bbox5(line),
