import { c as RemapObjectPropertyType, d as ReactiveNonInitial, C as ChangeKind, e as ChangeRecord, f as CompareChangeSet, I as IsEqualContext, P as Pathed, g as Process, h as changedDataFields, i as compareArrays, j as compareData, k as compareKeys, l as isEmptyEntries, m as isEqualContextString } from './Types-pa0ja9zv.js';
import { S as SimpleEventEmitter } from './Events-IwuYx9yI.js';
import { b as LogSet } from './Types-Yc1lP6QG.js';
import { V as ValueType, N as NumberFunction, R as RankArrayOptions, a as RankFunction, b as RankOptions } from './Types-7SgeNhBP.js';
import { i as index$2 } from './index-oYB2zUfM.js';
import { G as GetOrGenerate, g as getOrGenerate, a as getOrGenerateSync } from './GetOrGenerate-QzZloU-t.js';
import { a as IWithEntries, I as IDictionary } from './IMappish-dyh98iBG.js';
 ...
 */
declare const firstEntryByValue: <K, V>(map: IWithEntries<K, V>, predicate: (value: V, key: K) => boolean) => readonly [key: K, value: V] | undefined;
/**
