import { M as MinMaxAvgTotal } from './NumericArrays-b9b9222a.js';
...
import { N as NumberTracker, T as TrackedValueOpts, O as ObjectTracker, a as Timestamped, b as TrackedValueMap, n as numberTracker, c as TrackerBase, P as PrimitiveTracker } from './NumberTracker-5428ad2b.js';
import { P as Point, a as PointRelation, b as PolyLine } from './Point-d303e36b.js';
...
declare class PointTracker extends ObjectTracker<Point> {
     ...
     */
    relation: PointRelation | undefined;
    /**
     ...
     * @param p Point
     */
    seen(...p: Point[] | Timestamped<Point>[]): PointSeenInfo;
    /**
 ...
 * ```
 */
declare const pointTracker: (id?: string | undefined, opts?: TrackedValueOpts) => PointTracker;
...
declare const index_intervalTracker: typeof intervalTracker;
type index_PointSeenInfo = PointSeenInfo;
...
declare namespace index {
  export {
    ...
    index_intervalTracker as intervalTracker,
    index_PointSeenInfo as PointSeenInfo,
...
export { FrequencyEventMap as F, IntervalTracker as I, MovingAverage as M, NumberFunction as N, PointSeenInfo as P, TrackedPointMap as T, Normalise as a, FrequencyMutable as b, movingAverage as c, intervalTracker as d, PointTracker as e, frequencyMutable as f, pointsTracker as g, pointTracker as h, index as i, clamp as j, clampIndex as k, scalePercentages as l, movingAverageLight as m, scalePercent as n, flip as o, piPi as p, interpolate as q, interpolateAngle as r, scale as s, wrap as t, wrapRange as u, wrapInteger as w };
