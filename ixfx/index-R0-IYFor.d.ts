...
import { N as NumberFunction } from './Types-7SgeNhBP.js';
import { I as Interval } from './IntervalType-CQa4mlKV.js';
import { m as minMaxAvg } from './MinMaxAvg-laf7O9kA.js';
import { M as MinMaxAvgOpts, a as MinMaxAvgTotal } from './Types-AemTbNiz.js';
...
declare namespace index {
  export { index_Bipolar as Bipolar, type index_InterpolateOptions as InterpolateOptions, index_MinMaxAvgOpts as MinMaxAvgOpts, index_MinMaxAvgTotal as MinMaxAvgTotal, type index_MovingAverageTimedOptions as MovingAverageTimedOptions, index_Normalise as Normalise, index_applyToValues as applyToValues, index_average as average, index_averageWeighted as averageWeighted, index_clamp as clamp, index_clampIndex as clampIndex, index_count as count, index_dotProduct as dotProduct, index_filter as filter, index_flip as flip, index_interpolate as interpolate, index_interpolateAngle as interpolateAngle, index_interpolatorInterval as interpolatorInterval, index_interpolatorStepped as interpolatorStepped, index_isApproximately as isApproximately, index_isValid as isValid, index_linearSpace as linearSpace, index_max as max, index_maxFast as maxFast, index_maxIndex as maxIndex, index_min as min, index_minFast as minFast, index_minIndex as minIndex, index_minMaxAvg as minMaxAvg, index_movingAverage as movingAverage, index_movingAverageLight as movingAverageLight, index_movingAverageTimed as movingAverageTimed, index_noiseFilter as noiseFilter, index_numericPercent as numericPercent, index_numericRange as numericRange, index_numericRangeRaw as numericRangeRaw, index_piPi as piPi, index_proportion as proportion, index_quantiseEvery as quantiseEvery, index_relativeDifference as relativeDifference, index_round as round, index_roundUpToMultiple as roundUpToMultiple, index_scale as scale, index_scaleClamped as scaleClamped, index_scalePercent as scalePercent, index_scalePercentages as scalePercentages, index_scaler as scaler, index_scalerPercent as scalerPercent, index_softmax as softmax, index_total as total, index_totalFast as totalFast, index_validNumbers as validNumbers, index_weight as weight, index_wrap as wrap, index_wrapInteger as wrapInteger, index_wrapRange as wrapRange };
}

export { wrapRange as $, average as A, Bipolar as B, min as C, maxIndex as D, minIndex as E, max as F, total as G, maxFast as H, type InterpolateOptions as I, totalFast as J, minFast as K, proportion as L, type MovingAverageTimedOptions as M, Normalise as N, quantiseEvery as O, relativeDifference as P, round as Q, roundUpToMultiple as R, scale as S, scaler as T, scaleClamped as U, scalePercentages as V, scalePercent as W, scalerPercent as X, softmax as Y, wrapInteger as Z, wrap as _, applyToValues as a, averageWeighted as b, clamp as c, clampIndex as d, count as e, filter as f, flip as g, numericRange as h, index as i, numericPercent as j, isValid as k, interpolate as l, interpolatorStepped as m, numericRangeRaw as n, interpolatorInterval as o, piPi as p, interpolateAngle as q, isApproximately as r, linearSpace as s, movingAverageLight as t, movingAverageTimed as u, movingAverage as v, noiseFilter as w, weight as x, validNumbers as y, dotProduct as z };
