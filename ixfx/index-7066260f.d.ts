import { E as Easing } from './Easing-7b385212';
 ...
 * ```
 *
 * A custom source for random numbers can be provided, or `Math.random` is used by default.
...
type index_RandomSource = RandomSource;
...
export { AdsrOpts as A, CompleteEvent as C, DefaultRandom as D, EnvelopeOpts as E, JitterOpts as J, Oscillator as O, RandomSource as R, StateChangeEvent as S, AdsrTimingOpts as a, Adsr as b, adsr as c, defaultAdsrOpts as d, index as i, jitter as j };
