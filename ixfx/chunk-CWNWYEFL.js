...
var isEqual4 = (a, b) => isEqual(a.a, b.a) && isEqual(a.b, b.b) && isEqual(a.c, b.c);
var corners2 = (t4) => {
  guard6(t4);
...
var Box = class {
  ...
  measureApply(m, force) {
    ...
    if (isEqual3(m.size, this.visual))
      different = false;
...
//# sourceMappingURL=chunk-CWNWYEFL.js.map