...
declare const waitFor: (timeoutMs: number, abortHandler: (reason: string) => void, complete: () => void) => (error?: string | undefined) => void;

export { Continuously as C, DebouncedFunction as D, HasCompletion as H, IntervalAsync as I, ModTimer as M, TimerSource as T, UpdateFailPolicy as U, Timer as a, Timeout as b, TimeoutSyncCallback as c, debounce as d, TimeoutAsyncCallback as e, timeout as f, ContinuouslySyncCallback as g, ContinuouslyAsyncCallback as h, interval as i, continuously as j, delay as k, frequencyTimerSource as l, frequencyTimer as m, msElapsedTimer as n, ticksElapsedTimer as o, relativeTimer as r, sleep as s, throttle as t, updateOutdated as u, waitFor as w };
