...
import { H as HasCompletion } from './Types-WqS2k5P9.js';
 ...
 * @returns
 */
declare const continuously: (callback: ContinuouslyAsyncCallback | ContinuouslySyncCallback, interval?: Interval, opts?: Partial<ContinuouslyOpts>) => Continuously;
