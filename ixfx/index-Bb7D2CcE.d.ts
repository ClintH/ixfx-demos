import { M as ModSettableOptions, a as ModSettableFeedback, b as ModSettable, c as ModSource, S as SpringOptions, i as index$3 } from './index-ByySHuUe.js';
import { I as Interval } from './IntervalType-B6zEAEa4.js';
import { T as Timer } from './Timer-BAVYXjPU.js';
...
type index$2_TicksModSettableOptions = TicksModSettableOptions;
declare const index$2_bpm: typeof bpm;
declare const index$2_elapsed: typeof elapsed;
declare const index$2_hertz: typeof hertz;
declare const index$2_perMinute: typeof perMinute;
declare const index$2_perSecond: typeof perSecond;
declare const index$2_ticks: typeof ticks;
declare namespace index$2 {
  export { type index$2_TicksModSettableOptions as TicksModSettableOptions, index$2_bpm as bpm, index$2_elapsed as elapsed, index$2_hertz as hertz, index$2_perMinute as perMinute, index$2_perSecond as perSecond, index$2_ticks as ticks };
}
...
type index$1_Adsr = Adsr;
declare const index$1_Adsr: typeof Adsr;
type index$1_AdsrBase = AdsrBase;
declare const index$1_AdsrBase: typeof AdsrBase;
type index$1_AdsrEvents = AdsrEvents;
type index$1_AdsrIterableOpts = AdsrIterableOpts;
type index$1_AdsrIterator = AdsrIterator;
declare const index$1_AdsrIterator: typeof AdsrIterator;
type index$1_AdsrOpts = AdsrOpts;
type index$1_AdsrStateTransitions = AdsrStateTransitions;
type index$1_AdsrTimingOpts = AdsrTimingOpts;
type index$1_CompleteEvent = CompleteEvent;
type index$1_EnvelopeOpts = EnvelopeOpts;
type index$1_StateChangeEvent = StateChangeEvent;
declare const index$1_adsr: typeof adsr;
declare const index$1_adsrStateTransitions: typeof adsrStateTransitions;
declare const index$1_defaultAdsrOpts: typeof defaultAdsrOpts;
declare const index$1_defaultAdsrTimingOpts: typeof defaultAdsrTimingOpts;
declare namespace index$1 {
  export { index$1_Adsr as Adsr, index$1_AdsrBase as AdsrBase, type index$1_AdsrEvents as AdsrEvents, type index$1_AdsrIterableOpts as AdsrIterableOpts, index$1_AdsrIterator as AdsrIterator, type index$1_AdsrOpts as AdsrOpts, type index$1_AdsrStateTransitions as AdsrStateTransitions, type index$1_AdsrTimingOpts as AdsrTimingOpts, type index$1_CompleteEvent as CompleteEvent, type index$1_EnvelopeOpts as EnvelopeOpts, type index$1_StateChangeEvent as StateChangeEvent, index$1_adsr as adsr, index$1_adsrStateTransitions as adsrStateTransitions, index$1_defaultAdsrOpts as defaultAdsrOpts, index$1_defaultAdsrTimingOpts as defaultAdsrTimingOpts };
}
...
declare namespace index {
  export { index$3 as Easings, index$1 as Envelopes, index_Forces as Forces, type index_JitterOpts as JitterOpts, type index_Jitterer as Jitterer, index_ModSettable as ModSettable, index_ModSettableFeedback as ModSettableFeedback, index_ModSettableOptions as ModSettableOptions, index_ModSource as ModSource, Oscillator as Oscillators, index$2 as Sources, index_SpringOptions as SpringOptions, type index_WaveOptions as WaveOptions, type index_WaveShaperFeedback as WaveShaperFeedback, type index_WaveformShaper as WaveformShaper, type index_Waveforms as Waveforms, index_arcShape as arcShape, index_jitter as jitter, index_jitterAbsolute as jitterAbsolute, index_pingPong as pingPong, index_pingPongPercent as pingPongPercent, index_sineBipolarShape as sineBipolarShape, index_sineShape as sineShape, index_spring as spring, index_springValue as springValue, index_squareShaper as squareShaper, index_triangleShaper as triangleShaper, index_wave as wave, index_waveFromSource as waveFromSource };
}

export { Forces as F, type Jitterer as J, Oscillator as O, type WaveformShaper as W, index$2 as a, index$1 as b, type JitterOpts as c, jitterAbsolute as d, pingPong as e, type Waveforms as f, type WaveOptions as g, sineShape as h, index as i, jitter as j, arcShape as k, sineBipolarShape as l, type WaveShaperFeedback as m, waveFromSource as n, spring as o, pingPongPercent as p, springValue as q, squareShaper as s, triangleShaper as t, wave as w };
