...
declare class TrackedValue<V> {
    ...
    constructor(id: string, start: V, storeIntermediate: boolean);
    /**
     * Tracks a value
     */
    seen(...p: V[] | Timestamped<V>[]): void;
    get last(): Timestamped<V> | undefined;
    /**
...
declare class TrackedValueMap<V> {
     ...
     */
    protected seenImpl(id: string, ...values: V[]): Promise<void>;
    protected seenValue(id: string, ...values: V[]): Promise<TrackedValue<V>>;
    /**
     ...
     * ```
     */
    lastPoints(): Generator<Timestamped<V> | undefined, void, unknown>;
    /**
...
declare class TrackedPointMap extends TrackedValueMap<Point> {
    ...
    seen(id: string, ...values: Point[]): Promise<PointSeenInfo>;
}
