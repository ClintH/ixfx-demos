...
declare namespace guards {
  export { type guards_StringGuardRange as StringGuardRange, guards_arrayTest as arrayTest, guards_defined as defined, guards_ifNaN as ifNaN, guards_integerParse as integerParse, guards_integerTest as integerTest, guards_isFunction as isFunction, guards_isPlainObject as isPlainObject, guards_isPlainObjectOrPrimitive as isPlainObjectOrPrimitive, guards_isPowerOfTwo as isPowerOfTwo, guards_isStringArray as isStringArray, guards_nullUndef as nullUndef, guards_numberTest as numberTest, guards_percentTest as percentTest, guards_stringTest as stringTest, guards_throwArrayTest as throwArrayTest, guards_throwFromResult as throwFromResult, guards_throwIntegerTest as throwIntegerTest, guards_throwNullUndef as throwNullUndef, guards_throwNumberTest as throwNumberTest, guards_throwPercentTest as throwPercentTest, guards_throwStringTest as throwStringTest };
}

export { type GuardResult as G, type NumberGuardRange as N, type StringGuardRange as S, type GuardResultFail as a, type GuardResultOk as b, arrayTest as c, throwNullUndef as d, defined as e, isFunction as f, guards as g, isPowerOfTwo as h, isStringArray as i, ifNaN as j, integerParse as k, numberTest as l, throwNumberTest as m, nullUndef as n, throwPercentTest as o, percentTest as p, integerTest as q, throwIntegerTest as r, isPlainObject as s, throwArrayTest as t, isPlainObjectOrPrimitive as u, throwFromResult as v, stringTest as w, throwStringTest as x };
