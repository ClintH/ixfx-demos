 ...
 * @returns
 */
declare const scalesPercentOutput: (v: number, outMin: number, outMax?: number) => number;
/**
...
export { IsEqual as I, ToString as T, scalesPercentOutput as a, clampZeroBounds as b, clamp as c, isEqualValueDefault as d, isEqualDefault as i, lerp as l, scale as s, toStringDefault as t };
