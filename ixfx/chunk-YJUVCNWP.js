...
var Adsr = class extends AdsrBase {
  ...
  compute() {
    const [stage, amt2] = super.computeRaw();
    if (stage === void 0)
      return [void 0, NaN, NaN];
    let v;
    switch (stage) {
      case `attack`:
        v = this.attackPath.compute(amt2);
        break;
      case `decay`:
        v = this.decayPath.compute(amt2);
        break;
      case `sustain`:
        v = { x: 1, y: this.sustainLevel };
        break;
      case `release`:
        v = this.releasePath.compute(amt2);
        break;
      case `complete`:
...
//# sourceMappingURL=chunk-YJUVCNWP.js.map