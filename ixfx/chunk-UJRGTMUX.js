    ...
    switch (stage) {
      case `attack`:
        ...
        if (this.initialLevelOverride !== void 0) {
          let v2 = map(v, 0, this.initialLevel, this.initialLevelOverride, this.initialLevel);
          console.log(`Initial level override - ${this.initialLevelOverride}`);
          v = v2;
        }
        break;
      case `decay`:
      ...
      case `release`:
        ...
        if (this.releasedAt !== 1)
          v = map(v, 0, this.sustainLevel, 0, this.releasedAt);
        break;
      case `complete`:
        v = this.releaseLevel;
        break;
...
//# sourceMappingURL=chunk-UJRGTMUX.js.map