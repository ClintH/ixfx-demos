import { a as Point, f as Line, P as Path, R as RectPositioned, e as Rect } from './Rect-11f6b423';
...
/**
 * Cubic bezier where start and end (A/D) are 0 and 1, respectively.
 * Eg: https://cubic-bezier.com/#.17,.67,.83,.67
 * @param b
 * @param c
 * @param t
 * @returns Value
 */
declare const normalisedCubic: (b: number, c: number, t: number) => number;
/**
...
declare const Bezier_normalisedCubic: typeof normalisedCubic;
...
declare namespace Bezier {
  export {
    ...
    Bezier_normalisedCubic as normalisedCubic,
