...
import { I as ISetMutable } from './index-_uHddzoO.js';
 ...
 * @returns
 */
declare const isEqual$5: (a: CirclePositioned | Circle, b: CirclePositioned | Circle) => boolean;
...
type index$6_Circle = Circle;
type index$6_CirclePositioned = CirclePositioned;
type index$6_CircularPath = CircularPath;
declare const index$6_circumference: typeof circumference;
declare const index$6_distanceCenter: typeof distanceCenter;
...
declare const index$6_isPositioned: typeof isPositioned;
declare const index$6_point: typeof point;
declare const index$6_toPositioned: typeof toPositioned;
declare const index$6_toSvg: typeof toSvg;
declare namespace index$6 {
  export { type index$6_Circle as Circle, type index$6_CirclePositioned as CirclePositioned, type index$6_CircularPath as CircularPath, type RandomPointOpts$2 as RandomPointOpts, area$5 as area, bbox$3 as bbox, center$2 as center, index$6_circumference as circumference, index$6_distanceCenter as distanceCenter, distanceFromExterior$1 as distanceFromExterior, index$6_exteriorIntegerPoints as exteriorIntegerPoints, guard$3 as guard, index$6_guardPositioned as guardPositioned, index$6_interiorIntegerPoints as interiorIntegerPoints, interpolate$2 as interpolate, index$6_intersectionLine as intersectionLine, index$6_isCircle as isCircle, index$6_isCirclePositioned as isCirclePositioned, isEqual$5 as isEqual, isNaN$1 as isNaN, index$6_isPositioned as isPositioned, length$1 as length, multiplyScalar$2 as multiplyScalar, nearest$1 as nearest, index$6_point as point, randomPoint$2 as randomPoint, toPath$1 as toPath, index$6_toPositioned as toPositioned, index$6_toSvg as toSvg };
}
...
declare const index$5_toPath: typeof toPath;
declare const index$5_toSvgString: typeof toSvgString;
declare namespace index$5 {
  export { Empty$2 as Empty, type index$5_Line as Line, type index$5_LinePath as LinePath, Placeholder$2 as Placeholder, type index$5_PolyLine as PolyLine, index$5_angleRadian as angleRadian, apply$2 as apply, index$5_asPoints as asPoints, bbox$2 as bbox, distance$1 as distance, divide$1 as divide, index$5_extendFromA as extendFromA, fromFlatArray$1 as fromFlatArray, fromNumbers$2 as fromNumbers, fromPoints$1 as fromPoints, index$5_fromPointsToPath as fromPointsToPath, getPointParameter$1 as getPointParameter, guard$2 as guard, interpolate$1 as interpolate, isEmpty$2 as isEmpty, isEqual$4 as isEqual, index$5_isLine as isLine, isPlaceholder$2 as isPlaceholder, index$5_isPolyLine as isPolyLine, index$5_joinPointsToLines as joinPointsToLines, index$5_length as length, index$5_midpoint as midpoint, multiply$2 as multiply, index$5_nearest as nearest, normaliseByRect$2 as normaliseByRect, index$5_parallel as parallel, index$5_perpendicularPoint as perpendicularPoint, index$5_pointAtX as pointAtX, index$5_pointsOf as pointsOf, index$5_relativePosition as relativePosition, rotate$2 as rotate, index$5_scaleFromMidpoint as scaleFromMidpoint, index$5_slope as slope, subtract$2 as subtract, sum$2 as sum, toFlatArray$1 as toFlatArray, index$5_toPath as toPath, toString$1 as toString, index$5_toSvgString as toSvgString, withinRange$1 as withinRange };
}
 ...
 * @return
 */
declare const isEqual$3: (a: Grid | GridVisual, b: Grid | GridVisual) => boolean;
/**
 ...
 * @returns
 */
declare const isEqual$2: (a: Rect | RectPositioned, b: Rect | RectPositioned) => boolean;
/**
...
declare const index$4_distanceFromExterior: typeof distanceFromExterior;
...
declare namespace index$4 {
  export { type RandomPointOpts$1 as RandomPointOpts, type index$4_Rect as Rect, type index$4_RectArray as RectArray, type index$4_RectPositioned as RectPositioned, type index$4_RectPositionedArray as RectPositionedArray, area$4 as area, index$4_cardinal as cardinal, center$1 as center, clamp$1 as clamp, corners$1 as corners, index$4_distanceFromCenter as distanceFromCenter, index$4_distanceFromExterior as distanceFromExterior, edges$1 as edges, index$4_empty as empty, index$4_emptyPositioned as emptyPositioned, fromCenter$2 as fromCenter, index$4_fromElement as fromElement, fromNumbers$1 as fromNumbers, index$4_fromTopLeft as fromTopLeft, index$4_getEdgeX as getEdgeX, index$4_getEdgeY as getEdgeY, intersectsPoint$1 as intersectsPoint, isEqual$2 as isEqual, index$4_isEqualSize as isEqualSize, isIntersecting$1 as isIntersecting, lengths$1 as lengths, index$4_maxFromCorners as maxFromCorners, multiply$1 as multiply, multiplyScalar$1 as multiplyScalar, normaliseByRect$1 as normaliseByRect, perimeter$4 as perimeter, index$4_placeholder as placeholder, index$4_placeholderPositioned as placeholderPositioned, random$1 as random, randomPoint$1 as randomPoint, subtract$1 as subtract, sum$1 as sum, toArray$1 as toArray };
}
...
type index$3_CompoundPath = CompoundPath;
type index$3_Dimensions = Dimensions;
type index$3_Path = Path;
type index$3_WithBeziers = WithBeziers;
declare const index$3_getEnd: typeof getEnd;
declare const index$3_getStart: typeof getStart;
declare namespace index$3 {
  export { type index$3_CompoundPath as CompoundPath, type index$3_Dimensions as Dimensions, type index$3_Path as Path, type index$3_WithBeziers as WithBeziers, index$3_getEnd as getEnd, index$3_getStart as getStart };
}
...
type index$2_ArrowOpts = ArrowOpts;
type index$2_ContainsResult = ContainsResult;
type index$2_PointCalculableShape = PointCalculableShape;
type index$2_RandomPointOpts = RandomPointOpts;
type index$2_ShapePositioned = ShapePositioned;
declare const index$2_arrow: typeof arrow;
declare const index$2_center: typeof center;
declare const index$2_isIntersecting: typeof isIntersecting;
declare const index$2_randomPoint: typeof randomPoint;
declare const index$2_starburst: typeof starburst;
declare namespace index$2 {
  export { type index$2_ArrowOpts as ArrowOpts, type index$2_ContainsResult as ContainsResult, type index$2_PointCalculableShape as PointCalculableShape, type index$2_RandomPointOpts as RandomPointOpts, type index$2_ShapePositioned as ShapePositioned, index$2_arrow as arrow, index$2_center as center, index$2_isIntersecting as isIntersecting, index$2_randomPoint as randomPoint, index$2_starburst as starburst };
}
...
type index$1_Triangle = Triangle;
...
declare namespace index$1 {
  export { type index$1_BarycentricCoord as BarycentricCoord, Empty$1 as Empty, index$1_Equilateral as Equilateral, Isosceles$1 as Isosceles, Placeholder$1 as Placeholder, Right$1 as Right, type index$1_Triangle as Triangle, index$1_angles as angles, index$1_anglesDegrees as anglesDegrees, apply$1 as apply, area$3 as area, index$1_barycentricCoord as barycentricCoord, index$1_barycentricToCartestian as barycentricToCartestian, bbox$1 as bbox, centroid$1 as centroid, index$1_corners as corners, index$1_edges as edges, index$1_equilateralFromVertex as equilateralFromVertex, index$1_fromFlatArray as fromFlatArray, index$1_fromPoints as fromPoints, index$1_fromRadius as fromRadius, guard$1 as guard, index$1_innerCircle as innerCircle, index$1_intersectsPoint as intersectsPoint, index$1_isAcute as isAcute, isEmpty$1 as isEmpty, isEqual$1 as isEqual, index$1_isEquilateral as isEquilateral, index$1_isIsosceles as isIsosceles, index$1_isOblique as isOblique, index$1_isObtuse as isObtuse, isPlaceholder$1 as isPlaceholder, index$1_isRightAngle as isRightAngle, index$1_isTriangle as isTriangle, index$1_lengths as lengths, index$1_outerCircle as outerCircle, perimeter$3 as perimeter, rotate$1 as rotate, index$1_rotateByVertex as rotateByVertex, index$1_toFlatArray as toFlatArray };
}
...
export { isIntersecting$1 as $, corners$1 as A, distanceFromCenter as B, type CirclePositioned as C, type Dimensions as D, distanceFromExterior as E, edges$1 as F, type Grid as G, empty as H, emptyPositioned as I, fromCenter$2 as J, fromElement as K, type Line as L, fromNumbers$1 as M, fromTopLeft as N, getEdgeX as O, type Point3d as P, getEdgeY as Q, type Rect as R, type ShapePositioned as S, type Triangle as T, getEnd as U, type VisitGenerator as V, type WithBeziers as W, getStart as X, intersectsPoint$1 as Y, isEqual$2 as Z, isEqualSize as _, type Point as a, lengths$1 as a0, maxFromCorners as a1, multiply$1 as a2, multiplyScalar$1 as a3, normaliseByRect$1 as a4, perimeter$4 as a5, placeholder as a6, placeholderPositioned as a7, random$1 as a8, randomPoint$1 as a9, subtract$1 as aa, sum$1 as ab, toArray$1 as ac, type PointRelationResult as ad, type PointRelation as ae, type Path as b, type RectPositioned as c, type CellAccessor as d, type CardinalDirection as e, type Circle as f, type CompoundPath as g, type Cell as h, index$6 as i, type CircularPath as j, Grid$1 as k, index$5 as l, index$3 as m, type PointCalculableShape as n, index as o, type PolyLine as p, type RandomPointOpts$1 as q, type RectArray as r, type RectPositionedArray as s, index$4 as t, index$2 as u, index$1 as v, area$4 as w, cardinal as x, center$1 as y, clamp$1 as z };
