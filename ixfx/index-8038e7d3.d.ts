 ...
 * Backoff options
 */
type RetryWithBackOffOpts = Readonly<{
    /**
...
type index_IntervalAsync<V> = IntervalAsync<V>;
...
export { continuously as A, debounce as B, Continuously as C, DebouncedFunction as D, throttle as E, sleep as F, waitFor as G, HasCompletion as H, IntervalAsync as I, delay as J, everyNth as K, runOnce as L, ModTimer as M, RetryWithBackOffResult as N, OnStartCalled as O, RetryWithBackOffOpts as P, retryWithBackOff as Q, RepeatPredicate as R, Timer as T, UpdateFailPolicy as U, interval as a, forEachAsync as b, repeatReduce as c, delayLoop as d, TaskQueue as e, forEach as f, TimerSource as g, hasElapsedMs as h, index as i, completionMs as j, frequencyTimerSource as k, relativeTimer as l, relativeTimerMs as m, relativeTimerTicks as n, frequencyTimer as o, msElapsedTimer as p, TimeoutSyncCallback as q, repeat as r, TimeoutAsyncCallback as s, ticksElapsedTimer as t, Timeout as u, timeout as v, updateOutdated as w, ContinuouslySyncCallback as x, ContinuouslyAsyncCallback as y, ContinuouslyOpts as z };
