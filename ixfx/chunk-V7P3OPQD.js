...
var edges = (rect2, origin) => Line_exports.joinPointsToLines(...corners(rect2, origin), origin ?? Point_exports.Empty);
var perimeter = (rect2) => {
  guard5(rect2);
...
var PointTracker = class extends ObjectTracker {
  ...
  seen(...p) {
    ...
    const initialRel = {
      ...
      speed: this.values.length < 2 ? 0 : length(this.initial, newLast) / (newLast.at - this.initial.at)
    };
    const lastRel = {
...
//# sourceMappingURL=chunk-V7P3OPQD.js.map