...
var updateOutdated = async (fn, intervalMs) => {
  let lastRun = 0;
  let lastValue;
  return new Promise(async (resolve, reject) => {
    const elapsed = performance.now() - lastRun;
    if (lastValue === void 0 || elapsed > intervalMs) {
      console.log(`Value undefined or outdated`);
      try {
...
//# sourceMappingURL=chunk-RG65KLSC.js.map