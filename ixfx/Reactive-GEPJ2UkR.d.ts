...
type ReactiveDom_ElementsOptions = ElementsOptions;
...
declare namespace ReactiveDom {
  export { type ReactiveDom_BindUpdateOpts as BindUpdateOpts, type ReactiveDom_DomBindOptions as DomBindOptions, type ReactiveDom_DomBindOptionsWithElement as DomBindOptionsWithElement, type ReactiveDom_DomCreateOptions as DomCreateOptions, type ReactiveDom_ElementsOptions as ElementsOptions, type ReactiveDom_PipeDomBinding as PipeDomBinding, ReactiveDom_bind as bind, ReactiveDom_bindElement as bindElement, ReactiveDom_bindHtmlContent as bindHtmlContent, ReactiveDom_bindTextContent as bindTextContent, ReactiveDom_bindUpdate as bindUpdate, ReactiveDom_elements as elements, ReactiveDom_win as win };
}
...
declare function fromGenerator<V>(gen: AsyncGenerator<V>): ReactiveStream<V>;
...
declare const Reactive$1_fromGenerator: typeof fromGenerator;
...
declare const Reactive$1_fromQuery: typeof fromQuery;
