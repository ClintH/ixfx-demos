import { I as IQueueMutable, Q as QueueOpts, a as QueueDiscardPolicy, b as QueueMutable, m as mutable } from './QueueMutable-y9N20W8a.js';
 ...
 * @returns A new queue
 */
declare const immutable: <V>(opts?: QueueOpts<V>, ...startingItems: ReadonlyArray<V>) => IQueueImmutable<V>;
...
declare namespace index {
  export { type index_IPriorityQueueMutable as IPriorityQueueMutable, type index_IQueueImmutable as IQueueImmutable, index_IQueueMutable as IQueueMutable, index_QueueDiscardPolicy as QueueDiscardPolicy, index_QueueMutable as QueueMutable, index_QueueOpts as QueueOpts, index_immutable as immutable, index_mutable as mutable, index_priority as priority };
}

export { type IQueueImmutable as I, QueueImmutable as Q, type IPriorityQueueMutable as a, immutable as b, index as i, priority as p };
