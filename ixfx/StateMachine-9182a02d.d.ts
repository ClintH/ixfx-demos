...
declare type DriverResult = {
    readonly score?: number;
    readonly state?: string;
    readonly next?: boolean;
    readonly reset?: boolean;
};
declare type DriverExpression<V> = (args?: V) => DriverResult | undefined;
declare type DriverDescription<V> = {
