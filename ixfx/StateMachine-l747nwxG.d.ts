 ...
 * @returns
 */
declare const init: <V extends Transitions>(stateMachine: Transitions | Machine<V> | Readonly<Record<string, readonly StateTargetStrict<Transitions>[]>>, initialState?: StateNames<V> | undefined) => MachineState<V>;
declare const reset: <V extends Transitions>(sm: MachineState<V>) => MachineState<V>;
declare const validateMachine: <V extends Transitions>(smOrTransitions: Transitions | Readonly<Record<string, readonly StateTargetStrict<Transitions>[]>> | Machine<V>) => [machine: Machine<V> | undefined, msg: string];
/**
