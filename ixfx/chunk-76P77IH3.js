...
var compareData = (a, b, options = {}) => {
  ...
  if (b === void 0) return [{ path: options.pathPrefix ?? ``, previous: a, value: void 0, state: `removed` }];
  ...
  for (const [key, valueA] of entriesA) {
    ...
    if (typeof valueA === `object`) {
      ...
      if (key in b) {
        ...
        changes.push({ path: sub, previous: valueA, value: void 0, state: `removed` });
      }
    }
  }
  if (includeMissingFromA) {
    ...
    for (const [key, valueB] of entriesB) {
      ...
      changes.push({ path: pathPrefix + key, previous: void 0, value: valueB, state: `added` });
    }
  }
  return changes;
};
...
var getField = (object, path) => {
  ...
  if (object === void 0) throw new Error(`Parameter 'object' is undefined`);
...
//# sourceMappingURL=chunk-76P77IH3.js.map