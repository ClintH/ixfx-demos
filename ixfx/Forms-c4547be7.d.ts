 ...
 * @returns
 */
declare const numeric: (domIdOrEl: string | HTMLInputElement, onChanged?: ((currentVal: number) => void) | undefined, live?: boolean | undefined) => {
    value: number;
};
/**
 * SELECT options
 ...
 * @return
 */
declare const select: (domQueryOrEl: string | HTMLSelectElement, onChanged?: ((currentVal: string) => void) | undefined, opts?: SelectOpts) => SelectHandler;
...
export { Forms as F, SelectOpts as S, SelectHandler as a, button as b, checkbox as c, numeric as n, select as s };
