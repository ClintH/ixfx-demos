...
import { P as Point, a as PolyLine } from './Point-38b2ac09.js';
...
declare type SeenInfo = {
    readonly distance: number;
    readonly centroid: Point;
    readonly angle: number;
    readonly speed: number;
};
declare type TimestampedPoint = Point & {
    readonly at: number;
};
/**
 * A tracked point
 */
declare class TrackedPoint {
    readonly id: string;
    readonly storePoints: boolean;
    relation: (aa: number | Point, bb?: number | undefined) => {
        angle: number;
        distance: number;
        centroid: Point;
    };
    ...
    constructor(id: string, start: Point, storePoints: boolean);
    get x(): number;
    get y(): number;
    /**
     ...
     * @param p Point
     */
    seen(...p: Point[] | TimestampedPoint[]): SeenInfo;
    /**
...
declare const pointTracker: (opts: Opts) => PointTracker;
/**
 * PointTracker. Mutable.
 */
declare class PointTracker {
    store: Map<string, TrackedPoint>;
    gog: GetOrGenerate<string, TrackedPoint, Point>;
     ...
     */
    seen(id: string, ...points: Point[]): Promise<SeenInfo>;
    /**
