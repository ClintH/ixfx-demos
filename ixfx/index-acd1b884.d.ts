import { A as Arc, B as Bezier } from './Bezier-7fe54675';
import { C as Circle } from './Circle-c8def07e';
import { P as Path, a as Point, R as RectPositioned, L as Line, b as Rect, c as Point$1, d as Path$1 } from './Rect-0db90c49';
import { S as SetMutable } from './Interfaces-0ce46cc4';
 ...
 * @param grid
 */
declare const guard: (cell: Cell, paramName?: string, grid?: Readonly<{
    readonly rows: number;
    readonly cols: number;
}> | undefined) => void;
/**
