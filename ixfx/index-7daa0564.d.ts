...
import { a as Point } from './Point-c1796f83.js';
 ...
 * ```
 */
declare const dataTable: (parentOrQuery: HTMLElement | string, data?: object | undefined, opts?: DataTableOpts | undefined) => (data: object) => void;
/**
