...
import { Q as QueueMutable } from './Interfaces-177f270c.js';
...
declare class BleDevice extends SimpleEventEmitter<Events$1> {
    private device;
    private config;
    states: StateMachine;
    codec: Codec;
    ...
    constructor(device: BluetoothDevice, config: Opts$4);
...
declare class NordicBleDevice extends BleDevice {
    constructor(device: BluetoothDevice, opts?: Opts$3);
}
 ...
 */
declare const basic: (onData: (freq: Float32Array, wave: Float32Array, analyser: AudioAnalyser) => void, opts?: Opts$2) => AudioAnalyser;
/**
 ...
 * @returns
 */
declare const freq: (onData: (freq: Float32Array, analyser: AudioAnalyser) => void, opts?: Opts$2) => AudioAnalyser;
/**
 ...
 * @returns
 */
declare const peakLevel: (onData: (level: number, analyser: AudioAnalyser) => void, opts?: Opts$2) => AudioAnalyser;
/**
...
declare abstract class JsonDevice extends SimpleEventEmitter<Events> {
    states: StateMachine;
    codec: Codec;
    verboseLogging: boolean;
    name: string;
...
export { AudioAnalyser$1 as A, Camera as C, EspruinoDevice$1 as E, NordicBleDevice$1 as N, Serial as S, AudioVisualiser$1 as a, index as i };
