...
declare function pull<T extends Record<string, PrimitiveOrObject | (() => any)>>(value: T): {
...
declare namespace index {
  export { index_Bipolar as Bipolar, index_Correlate as Correlate, type index_FrequencyEventMap as FrequencyEventMap, index_FrequencyMutable as FrequencyMutable, index$1 as Graphs, type index_InterpolateOptions as InterpolateOptions, index_IntervalTracker as IntervalTracker, type index_MovingAverageTimedOptions as MovingAverageTimedOptions, index_Normalise as Normalise, type index_NumberFunction as NumberFunction, index_NumberTracker as NumberTracker, index_NumberTrackerResults as NumberTrackerResults, type index_PointTrack as PointTrack, index_PointTracker as PointTracker, type index_PointTrackerResults as PointTrackerResults, Pool$1 as Pool, index_PrimitiveTracker as PrimitiveTracker, type index_PullRecord as PullRecord, type index_ResolveValue as ResolveValue, type index_ResolvedObject as ResolvedObject, index_Table as Table, index_Timestamped as Timestamped, index_TimestampedObject as TimestampedObject, index_TimestampedPrimitive as TimestampedPrimitive, type index_TrackUnique as TrackUnique, index_TrackedPointMap as TrackedPointMap, index_TrackedValueMap as TrackedValueMap, index_TrackedValueOpts as TrackedValueOpts, index_TrackerBase as TrackerBase, clamp$1 as clamp, index_clampIndex as clampIndex, index_fieldResolve as fieldResolve, index_fieldResolver as fieldResolver, index_flip as flip, index_frequencyMutable as frequencyMutable, index_interpolate as interpolate, index_interpolateAngle as interpolateAngle, index_interpolatorInterval as interpolatorInterval, index_interpolatorStepped as interpolatorStepped, index_intervalTracker as intervalTracker, index_movingAverage as movingAverage, index_movingAverageLight as movingAverageLight, index_movingAverageTimed as movingAverageTimed, index_noiseFilter as noiseFilter, index_numberTracker as numberTracker, index_piPi as piPi, index_pointTracker as pointTracker, index_pointsTracker as pointsTracker, index_pull as pull, scale$1 as scale, scaleClamped$1 as scaleClamped, index_scalePercent as scalePercent, index_scalePercentages as scalePercentages, index_scaler as scaler, index_scalerPercent as scalerPercent, index_trackUnique as trackUnique, index_trackUniqueInstances as trackUniqueInstances, index_wrap as wrap, index_wrapInteger as wrapInteger, index_wrapRange as wrapRange };
}

export { trackUniqueInstances as A, Bipolar as B, Correlate as C, Table as D, type PullRecord as E, type FrequencyEventMap as F, type ResolvedObject as G, fieldResolve as H, IntervalTracker as I, fieldResolver as J, pull as K, type InterpolateOptions as L, type MovingAverageTimedOptions as M, Normalise as N, interpolate as O, Pool$1 as P, interpolatorStepped as Q, type ResolveValue as R, interpolatorInterval as S, TrackedPointMap as T, interpolateAngle as U, wrapInteger as V, wrap as W, wrapRange as X, type NumberFunction as Y, index$1 as a, FrequencyMutable as b, movingAverageTimed as c, movingAverage as d, intervalTracker as e, frequencyMutable as f, type PointTrack as g, type PointTrackerResults as h, index as i, PointTracker as j, pointsTracker as k, pointTracker as l, movingAverageLight as m, noiseFilter as n, clamp$1 as o, piPi as p, clampIndex as q, scaler as r, scale$1 as s, scaleClamped$1 as t, scalePercentages as u, scalePercent as v, scalerPercent as w, flip as x, type TrackUnique as y, trackUnique as z };
