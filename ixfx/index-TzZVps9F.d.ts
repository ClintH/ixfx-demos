import { R as Reactive, f as ReactiveWritable, U as Unsubscriber, S as SplitOptions, g as ReactiveOrSource, h as ReactiveStream, F as FilterPredicate, i as SwitcherOptions, j as ReactiveDisposable, M as MergeOptions, k as RxValueTypeObject, l as RxValueTypes, m as SyncOptions, n as ResolveOptions, o as FieldOptions, p as ReactiveOp, I as InitStreamOptions, T as TransformOpts, q as CacheOpts, r as ReactiveInitial, A as AnnotationElapsed, s as SingleFromArrayOptions, B as BatchOptions, D as DebounceOptions, t as ThrottleOptions, u as ToArrayOptions, v as ReactiveArray, w as ReactiveNonInitial, x as FromGeneratorOptions, E as EventOptions, O as Optional, P as Passed, y as PassedSignal, z as PassedValue, G as ReactiveDiff, W as Wrapped, H as ReadFromArrayOptions, J as ReactiveFinite, K as PingedFunctionOptions, L as FromFunctionOptions, N as symbol, Q as ObjectOptions, V as CountOptions, X as DomBindSourceValue, Y as PipeDomBinding, Z as DomBindValueTarget, _ as DomBindUnresolvedSource, $ as BindUpdateOpts, a0 as ElementsOptions, a1 as DomBindResolvedSource, a2 as DomBindTargetNode, a3 as DomBindTargetNodeResolved, a4 as DomCreateOptions, a5 as ElementBind, a6 as InitLazyStreamOptions, a7 as Lazy, a8 as PipeSet, a9 as PrimitiveValueTypeObject, aa as ReactiveOpInit, ab as ReactiveOpLinks, ac as RxPrimitiveValueTypeObject, ad as SignalKinds, ae as UpstreamOptions } from './Types-_Zmx2Zlc.js';
 ...
 * @returns
 */
declare const splitLabelled: <T, K extends PropertyKey>(...labels: Array<K>) => (r: ReactiveOrSource<T>) => Record<K, Reactive<T>>;
/**
 ...
 * @returns
 */
declare function mergeToObject<const T extends Record<string, ReactiveOrSource<any>>>(reactiveSources: T, options?: Partial<MergeOptions>): ReactiveDisposable & Reactive<RxValueTypeObject<T>>;
/**
 ...
 * @returns
 */
declare function mergeToArray<const T extends ReadonlyArray<ReactiveOrSource<any>>>(reactiveSources: T, options?: Partial<MergeOptions>): Reactive<RxValueTypes<T>>;
 ...
 */
declare function sync<const T extends ReadonlyArray<ReactiveOrSource<any>>>(reactiveSources: T, options?: Partial<SyncOptions>): Reactive<RxValueTypes<T>>;
/**
 ...
 * @returns
 */
declare function cache<In>(input: ReactiveOrSource<In>, options?: Partial<CacheOpts<In>>): ReactiveInitial<In>;
/**
...
declare function fromArray<V>(initialValue?: ReadonlyArray<V>, options?: Partial<ArrayOptions<V>>): ReactiveDisposable & ReactiveArray<V> & (ReactiveInitial<ReadonlyArray<V>> | ReactiveNonInitial<ReadonlyArray<V>>);
 ...
 * @param generator
 */
declare function fromGenerator<V>(generator: IterableIterator<V> | AsyncIterableIterator<V> | Generator<V> | AsyncGenerator<V>, options?: Partial<FromGeneratorOptions>): ReactiveDisposable & Reactive<V>;
...
declare function fromEvent<V extends Record<string, any>>(target: EventTarget | null, name: string, options?: Optional<EventOptions<V>, `transform`>): ReactiveNonInitial<V> & ReactiveDisposable;
 ...
 * @param gen
 */
declare const lit: <T>(elOrQuery: string | HTMLElement, source: Reactive<T>, gen: (s: T | undefined) => TemplateResult<any>) => void;
 ...
 * @returns
 */
declare const readFromArray: <V>(sourceArray: Array<V>, options?: Partial<ReadFromArrayOptions>) => Reactive<V> & ReactiveFinite & ReactiveInitial<V>;
 ...
 */
type FromFunctionFunction<T> = ((abort: (reason: string) => void) => T) | ((abort: (reason: string) => void) => Promise<T>);
/**
 * Function which returns a result. Or promised result.
 ...
 * @returns
 */
declare function fromFunction<V>(callback: FromFunctionFunction<V>, options?: Partial<FromFunctionOptions>): ReactiveStream<V>;
 ...
 * @returns
 */
declare function fromDomQuery(query: string): ReactiveDisposable & ReactiveWritable<HTMLElement[]> & {
...
declare function boolean(initialValue: boolean): ReactiveDisposable & ReactiveWritable<boolean> & ReactiveInitial<boolean>;
declare function boolean(): ReactiveDisposable & ReactiveWritable<boolean> & ReactiveNonInitial<boolean>;
...
declare const Ops: {
    ...
    readonly cache: <V_2>(opts: Partial<CacheOpts<V_2>>) => ReactiveOp<V_2, V_2>;
    readonly batch: <V_3>(options: Partial<BatchOptions>) => ReactiveOp<V_3, V_3[]>;
    readonly debounce: <V_4>(options: Partial<DebounceOptions>) => ReactiveOp<V_4, V_4>;
    readonly filter: <V_5>(predicate: (value: V_5) => boolean) => <In_1>(source: ReactiveOrSource<In_1>) => Reactive<In_1>;
    readonly transform: <In_2, Out>(transformer: (value: In_2) => Out) => ReactiveOp<In_2, Out>;
    readonly throttle: <V_6>(options: Partial<ThrottleOptions>) => (source: ReactiveOrSource<V_6>) => Reactive<V_6>;
};
/**
...
type index_FromFunctionFunction<T> = FromFunctionFunction<T>;
declare const index_FromFunctionOptions: typeof FromFunctionOptions;
declare const index_FromGeneratorOptions: typeof FromGeneratorOptions;
...
declare const index_MergeOptions: typeof MergeOptions;
...
type index_PingedFunctionFunction<T, TSource> = PingedFunctionFunction<T, TSource>;
declare const index_PingedFunctionOptions: typeof PingedFunctionOptions;
...
declare const index_ReadFromArrayOptions: typeof ReadFromArrayOptions;
declare const index_ResolveOptions: typeof ResolveOptions;
type index_ResolveSourceOptions = ResolveSourceOptions;
declare const index_RxPrimitiveValueTypeObject: typeof RxPrimitiveValueTypeObject;
...
declare const index_lit: typeof lit;
declare const index_manual: typeof manual;
declare const index_mergeToArray: typeof mergeToArray;
declare const index_mergeToObject: typeof mergeToObject;
...
declare const index_pinged: typeof pinged;
declare const index_pipe: typeof pipe;
declare const index_prepare: typeof prepare;
declare const index_readFromArray: typeof readFromArray;
...
declare namespace index {
  export { index_AnnotationElapsed as AnnotationElapsed, type index_ArrayOptions as ArrayOptions, index_BatchOptions as BatchOptions, index_BindUpdateOpts as BindUpdateOpts, index_CacheOpts as CacheOpts, index_CountOptions as CountOptions, index_DebounceOptions as DebounceOptions, index_Dom as Dom, index_DomBindResolvedSource as DomBindResolvedSource, index_DomBindSourceValue as DomBindSourceValue, index_DomBindTargetNode as DomBindTargetNode, index_DomBindTargetNodeResolved as DomBindTargetNodeResolved, index_DomBindUnresolvedSource as DomBindUnresolvedSource, index_DomBindValueTarget as DomBindValueTarget, index_DomCreateOptions as DomCreateOptions, index_ElementBind as ElementBind, index_ElementsOptions as ElementsOptions, index_EventOptions as EventOptions, index_FieldOptions as FieldOptions, index_FilterPredicate as FilterPredicate, type index_FromFunctionFunction as FromFunctionFunction, index_FromFunctionOptions as FromFunctionOptions, index_FromGeneratorOptions as FromGeneratorOptions, index_InitLazyStreamOptions as InitLazyStreamOptions, index_InitStreamOptions as InitStreamOptions, index_Lazy as Lazy, html as LitHtml, index_MergeOptions as MergeOptions, index_ObjectOptions as ObjectOptions, index_Ops as Ops, index_Optional as Optional, index_Passed as Passed, index_PassedSignal as PassedSignal, index_PassedValue as PassedValue, type index_PingedFunctionFunction as PingedFunctionFunction, index_PingedFunctionOptions as PingedFunctionOptions, index_PipeDomBinding as PipeDomBinding, index_PipeSet as PipeSet, index_PrimitiveValueTypeObject as PrimitiveValueTypeObject, index_Reactive as Reactive, index_ReactiveArray as ReactiveArray, index_ReactiveDiff as ReactiveDiff, index_ReactiveDisposable as ReactiveDisposable, index_ReactiveFinite as ReactiveFinite, index_ReactiveInitial as ReactiveInitial, index_ReactiveNonInitial as ReactiveNonInitial, index_ReactiveOp as ReactiveOp, index_ReactiveOpInit as ReactiveOpInit, index_ReactiveOpLinks as ReactiveOpLinks, index_ReactiveOrSource as ReactiveOrSource, type index_ReactiveProxied as ReactiveProxied, index_ReactiveStream as ReactiveStream, index_ReactiveWritable as ReactiveWritable, index_ReadFromArrayOptions as ReadFromArrayOptions, index_ResolveOptions as ResolveOptions, type index_ResolveSourceOptions as ResolveSourceOptions, index_RxPrimitiveValueTypeObject as RxPrimitiveValueTypeObject, index_RxValueTypeObject as RxValueTypeObject, index_RxValueTypes as RxValueTypes, index_SignalKinds as SignalKinds, index_SingleFromArrayOptions as SingleFromArrayOptions, index_SplitOptions as SplitOptions, index_SwitcherOptions as SwitcherOptions, index_SyncOptions as SyncOptions, index_ThrottleOptions as ThrottleOptions, index_ToArrayOptions as ToArrayOptions, index_TransformOpts as TransformOpts, index_Unsubscriber as Unsubscriber, index_UpstreamOptions as UpstreamOptions, index_Wrapped as Wrapped, index_annotate as annotate, index_annotateElapsed as annotateElapsed, index_batch as batch, index_boolean as boolean, index_cache as cache, index_cloneFromFields as cloneFromFields, index_count as count, index_debounce as debounce, index_field as field, index_filter as filter, index_fromArray as fromArray, index_fromEvent as fromEvent, index_fromFunction as fromFunction, index_fromGenerator as fromGenerator, index_fromObject as fromObject, index_fromProxy as fromProxy, index_fromProxySymbol as fromProxySymbol, index_hasLast as hasLast, index_isDisposable as isDisposable, index_isReactive as isReactive, index_lit as lit, index_manual as manual, index_mergeToArray as mergeToArray, index_mergeToObject as mergeToObject, index_messageHasValue as messageHasValue, index_messageIsDoneSignal as messageIsDoneSignal, index_messageIsSignal as messageIsSignal, index_number as number, index_observable as observable, index_observableWritable as observableWritable, index_opify as opify, index_pinged as pinged, index_pipe as pipe, index_prepare as prepare, index_readFromArray as readFromArray, index_resolve as resolve, index_resolveSource as resolveSource, index_run as run, index_singleFromArray as singleFromArray, index_split as split, index_splitLabelled as splitLabelled, index_switcher as switcher, index_symbol as symbol, index_sync as sync, index_syncToObject as syncToObject, index_takeNextValue as takeNextValue, index_throttle as throttle, index_to as to, index_toArray as toArray, index_toArrayOrThrow as toArrayOrThrow, index_toGenerator as toGenerator, index_transform as transform, index_wrap as wrap };
}

export { type ReactiveProxied as $, batch as A, debounce as B, throttle as C, Dom as D, prepare as E, toArray as F, toArrayOrThrow as G, toGenerator as H, type ArrayOptions as I, fromArray as J, fromGenerator as K, fromEvent as L, messageIsSignal as M, messageIsDoneSignal as N, Ops as O, messageHasValue as P, hasLast as Q, isReactive as R, isDisposable as S, opify as T, wrap as U, lit as V, readFromArray as W, type FromFunctionFunction as X, type PingedFunctionFunction as Y, pinged as Z, fromFunction as _, observableWritable as a, fromProxy as a0, fromProxySymbol as a1, fromObject as a2, type ResolveSourceOptions as a3, resolveSource as a4, count as a5, boolean as b, to as c, splitLabelled as d, switcher as e, mergeToObject as f, mergeToArray as g, syncToObject as h, index as i, sync as j, resolve as k, field as l, manual as m, number as n, observable as o, pipe as p, filter as q, run as r, split as s, takeNextValue as t, transform as u, cache as v, annotate as w, annotateElapsed as x, cloneFromFields as y, singleFromArray as z };
