...
declare type Spaces = `hsl` | `rgb` | `lab` | `hcl`;
...
declare const interpolate: (amount: number, from: Colourish, to: Colourish, space?: Spaces) => string;
declare const scale: (steps: number, space: Spaces, ...colours: Colourish[]) => string[];
