import { D as Drawing } from './Drawing-d6270946';
import { b as CirclePositioned } from './Circle-4b23ec3d';
...
declare const toHsl: (colour: Colourish) => {
    h: number;
    s: number;
    l: number;
    opacity?: number;
};
declare const toRgb: (colour: Colourish) => {
    r: number;
    g: number;
    b: number;
    opacity?: number;
...
declare const Colour$1_rgbToHsl: typeof rgbToHsl;
