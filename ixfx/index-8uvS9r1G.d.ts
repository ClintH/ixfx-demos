 ...
 * @returns
 */
declare const switcher: <TValue, TRec extends Record<string, FilterPredicate<TValue>>, TLabel extends keyof TRec>(cases: TRec, r: ReactiveOrSource<TValue>, options?: Partial<SwitcherOptions>) => Record<TLabel, Reactive<TValue>>;
/**
 ...
 * @returns
 */
declare const bindDiffUpdate: <V>(source: ReactiveDiff<V>, elOrQuery: string | HTMLElement, updater: (diffs: Array<Change<any>>, el: HTMLElement) => void, opts?: Partial<BindUpdateOpts<V>>) => PipeDomBinding & {
    refresh: () => void;
};
/**
...
declare namespace Dom {
  export { Dom_bind as bind, Dom_bindDiffUpdate as bindDiffUpdate, Dom_bindElement as bindElement, Dom_bindHtmlContent as bindHtmlContent, Dom_bindTextContent as bindTextContent, Dom_bindUpdate as bindUpdate, Dom_elements as elements, Dom_win as win };
}
