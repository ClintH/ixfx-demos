 ...
 * @param bindOpts
 */
declare const bindText: <V>(source: Reactive<V>, elOrQuery: string | HTMLElement, bindOpts?: Partial<DomBindSourceValue<V>>) => PipeDomBinding;
/**
 ...
 * @returns
 */
declare const bindHtml: <V>(source: Reactive<V>, elOrQuery: string | HTMLElement, bindOpts?: DomBindSourceValue<V>) => PipeDomBinding;
/**
 ...
 * @param bindOpts
 */
declare const bindElement: <V>(source: Reactive<V>, elOrQuery: string | HTMLElement, ...binds: (DomBindSourceValue<V> & DomBindValueTarget)[]) => PipeDomBinding;
/**
