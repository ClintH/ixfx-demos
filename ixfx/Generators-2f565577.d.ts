 ...
 * @param fn
 */
declare const forEach: <V>(iterator: IterableIterator<V>, fn: (v?: V | undefined) => boolean | void) => void;
/**
...
declare const gaussian: (mean: number, std: number, stepLength?: number) => Generator<number, void, unknown>;
...
declare const Generators_gaussian: typeof gaussian;
...
declare namespace Generators {
  export {
    ...
    Generators_gaussian as gaussian,
    Generators_pingPong as pingPong,
    Generators_pingPongPercent as pingPongPercent,
  };
}

export { Generators as G, numericRange as a, pingPongPercent as b, count as c, forEach as f, gaussian as g, numericRangeRaw as n, pingPong as p, rangePercent as r };
