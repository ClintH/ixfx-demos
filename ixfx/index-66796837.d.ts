 ...
 * @returns Observable
 */
declare const fullSizeCanvas: (domQueryOrEl: string | HTMLCanvasElement, onResized?: ((ctx: CanvasRenderingContext2D, el: HTMLCanvasElement, bounds: {
    readonly width: number;
    readonly height: number;
}) => void) | undefined, skipCss?: boolean) => Observable<Event>;
/**
