import { M as MinMaxAvgTotal } from './NumericArrays-1f113dbc.js';
import { T as ToString } from './Util-a03b2534.js';
import { S as SimpleEventEmitter } from './Events-5892cf2f.js';
import { a as KeyValue } from './KeyValue-e1eba3d8.js';
import { N as NumberTracker, T as TrackedValueOpts, a as TrackerBase, b as Timestamped, c as TrackedValueMap, n as numberTracker } from './NumberTracker-fec1a20e.js';
import { P as PointRelationResult, a as Point, b as PointRelation, c as PolyLine } from './Point-f57faba9.js';
 ...
 */
declare const intervalTracker: (id?: string | undefined, opts?: TrackedValueOpts | undefined) => IntervalTracker;
 ...
 * @returns
 */
declare const scaleClamped: (v: number, inMin: number, inMax: number, outMin?: number | undefined, outMax?: number | undefined, easing?: ((v: number) => number) | undefined) => number;
/**
