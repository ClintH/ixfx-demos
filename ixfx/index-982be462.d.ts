...
declare class AdsrBase extends SimpleEventEmitter<Events> {
     ...
     * @returns
     */
    computeRaw(allowStateChange?: boolean): [stage: string | undefined, amount: number];
    protected compute(allowStateChange?: boolean): [stage: string | undefined, scaled: number, raw: number];
    get isDone(): boolean;
