import {
  SvgElements_exports
} from "./chunk-R33SJ7IM.js";
import {
  ObjectTracker,
  TrackedValueMap
} from "./chunk-D2PHFSAZ.js";
import {
  angleBetween,
  joinPointsToLines,
  length,
  relation
} from "./chunk-3N3URYQ2.js";
import {
  Forms_exports
...
var PointTracker = class extends ObjectTracker {
  ...
  angleFromStart() {
    if (this.values.length > 2) {
      return angleBetween(this.initial, this.last);
    } else {
      throw new Error(`Needs at least two points`);
    }
  }
  get length() {
    if (this.values.length === 1)
...
//# sourceMappingURL=chunk-J6KQUW35.js.map