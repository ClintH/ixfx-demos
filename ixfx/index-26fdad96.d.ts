import { D as Drawing } from './Drawing-0ddd6b93';
import { b as CirclePositioned } from './Circle-35681c71';
import { f as Line, a as Point } from './Rect-b9fc8eba';
...
declare const circleEl: (circle: CirclePositioned, parent: SVGElement, opts?: DrawingOpts$1 | undefined, idOrExisting?: string | SVGCircleElement | undefined) => SVGCircleElement;
declare const lineEl: (line: Line, parent: SVGElement, opts?: LineDrawingOpts | undefined, idOrExisting?: string | SVGLineElement | undefined) => SVGLineElement;
declare const textPathUpdate: (el: SVGTextPathElement, text?: string | undefined, opts?: TextPathDrawingOpts | undefined) => void;
declare const textPathEl: (pathRef: string, text: string, parent: SVGElement, opts?: TextPathDrawingOpts | undefined, idOrExisting?: string | undefined) => SVGTextPathElement;
...
declare const textEl: (pos: Point, text: string, parent: SVGElement, opts?: TextDrawingOpts | undefined, idOrExisting?: string | SVGTextElement | undefined) => SVGTextElement;
/**
...
declare const svg: (parent: SVGElement, opts?: DrawingOpts$1 | undefined) => {
    ...
    line: (line: Line, opts?: DrawingOpts$1 | undefined, idOrExisting?: string | SVGLineElement | undefined) => SVGLineElement;
    circle: (circle: CirclePositioned, opts?: DrawingOpts$1 | undefined, idOrExisting?: string | SVGCircleElement | undefined) => SVGCircleElement;
