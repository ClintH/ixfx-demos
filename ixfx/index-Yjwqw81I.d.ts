import { I as Interval, i as intervalToMs, a as isInterval } from './IntervalType-zqeNLRm6.js';
import { D as Dispatch, a as DispatchList } from './DispatchList-ZRX5ZwtM.js';
import { H as HasCompletion, A as AsyncPromiseOrGenerator } from './Types-v5TpUZ0T.js';
import { S as StateMachine } from './StateMachine-u3Al6fsf.js';
import { M as ModulationTimer, R as RelativeTimerOpts, T as Timer, a as TimerOpts, b as TimerSource, f as frequencyTimer, c as frequencyTimerSource, h as hasElapsedMs, m as msElapsedTimer, r as relativeTimer, t as ticksElapsedTimer } from './Timer-ZNdquXWG.js';
import { D as DelayOpts, I as IntervalOpts, a as delay, d as delayLoop, i as interval } from './Delay-fEaIv5Lz.js';
import { C as Continuously, a as ContinuouslyAsyncCallback, b as ContinuouslyOpts, c as ContinuouslySyncCallback, O as OnStartCalled, d as continuously } from './Continuously-sRxroRit.js';
...
declare namespace Elapsed {
  export { type Elapsed_Since as Since, Elapsed_infinity as infinity, Elapsed_once as once, Elapsed_progress as progress, Elapsed_since as since, Elapsed_toString as toString };
}
...
declare const index_Dispatch: typeof Dispatch;
...
declare namespace index {
  export { index_AsyncPromiseOrGenerator as AsyncPromiseOrGenerator, index_Continuously as Continuously, index_ContinuouslyAsyncCallback as ContinuouslyAsyncCallback, index_ContinuouslyOpts as ContinuouslyOpts, index_ContinuouslySyncCallback as ContinuouslySyncCallback, type index_DebouncedFunction as DebouncedFunction, index_DelayOpts as DelayOpts, index_Dispatch as Dispatch, index_DispatchList as DispatchList, index_Elapsed as Elapsed, index_HasCompletion as HasCompletion, index_Interval as Interval, index_IntervalOpts as IntervalOpts, index_ModulationTimer as ModulationTimer, index_OnStartCalled as OnStartCalled, index_RelativeTimerOpts as RelativeTimerOpts, type index_RepeatPredicate as RepeatPredicate, type index_RetryOpts as RetryOpts, type index_RetryResult as RetryResult, type index_SleepOpts as SleepOpts, index_StateMachine as StateMachine, index_TaskQueue as TaskQueue, type index_Timeout as Timeout, type index_TimeoutAsyncCallback as TimeoutAsyncCallback, type index_TimeoutSyncCallback as TimeoutSyncCallback, index_Timer as Timer, index_TimerOpts as TimerOpts, index_TimerSource as TimerSource, type index_UpdateFailPolicy as UpdateFailPolicy, index_continuously as continuously, index_debounce as debounce, index_delay as delay, index_delayLoop as delayLoop, index_everyNth as everyNth, index_forEach as forEach, index_forEachAsync as forEachAsync, index_frequencyTimer as frequencyTimer, index_frequencyTimerSource as frequencyTimerSource, index_hasElapsedMs as hasElapsedMs, index_interval as interval, index_intervalToMs as intervalToMs, index_isInterval as isInterval, index_msElapsedTimer as msElapsedTimer, index_relativeTimer as relativeTimer, index_repeat as repeat, index_repeatReduce as repeatReduce, index_retry as retry, index_runOnce as runOnce, index_sleep as sleep, index_throttle as throttle, index_ticksElapsedTimer as ticksElapsedTimer, index_timeout as timeout, index_updateOutdated as updateOutdated, index_waitFor as waitFor };
}

export { type DebouncedFunction as D, Elapsed as E, type RepeatPredicate as R, type SleepOpts as S, TaskQueue as T, type UpdateFailPolicy as U, forEachAsync as a, repeatReduce as b, type TimeoutSyncCallback as c, type TimeoutAsyncCallback as d, type Timeout as e, forEach as f, debounce as g, throttle as h, index as i, everyNth as j, runOnce as k, type RetryResult as l, type RetryOpts as m, retry as n, repeat as r, sleep as s, timeout as t, updateOutdated as u, waitFor as w };
