...
import { a as Easing } from './Easing-6Rck5sJB.js';
import { P as Point, R as Rect } from './index-jU6_fzOJ.js';
import { T as Timer } from './Timer-UhFryL5Q.js';
 ...
 * @returns
 */
declare const jitterAbsolute: (opts: JitterOpts) => Jitterer;
/**
 ...
 */
declare const jitter: (opts?: JitterOpts) => Jitterer;
...
declare namespace index {
  export { type index_Adsr as Adsr, type index_AdsrIterableOpts as AdsrIterableOpts, type index_AdsrOpts as AdsrOpts, type index_AdsrTimingOpts as AdsrTimingOpts, type index_CompleteEvent as CompleteEvent, Easing as Easings, type index_EnvelopeOpts as EnvelopeOpts, Envelope as Envelopes, type index_Events as Events, index_Forces as Forces, type index_JitterOpts as JitterOpts, type index_Jitterer as Jitterer, Oscillator as Oscillators, type index_StateChangeEvent as StateChangeEvent, index_adsr as adsr, index_adsrIterable as adsrIterable, index_defaultAdsrOpts as defaultAdsrOpts, index_jitter as jitter, index_jitterAbsolute as jitterAbsolute, index_perSecond as perSecond, index_pingPong as pingPong, index_pingPongPercent as pingPongPercent };
}

export { type AdsrOpts as A, type CompleteEvent as C, Envelope as E, Forces as F, type Jitterer as J, Oscillator as O, type StateChangeEvent as S, type JitterOpts as a, jitterAbsolute as b, type EnvelopeOpts as c, defaultAdsrOpts as d, type AdsrTimingOpts as e, type Events as f, type Adsr as g, adsr as h, index as i, jitter as j, adsrIterable as k, type AdsrIterableOpts as l, perSecond as p };
