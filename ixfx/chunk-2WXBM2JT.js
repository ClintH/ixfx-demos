...
var minMaxAvg2 = (entries, conversionFunction) => {
  if (conversionFunction === void 0)
    conversionFunction = (v) => v[1];
  const values = entries.map(conversionFunction);
...
var comparerInverse = (function_) => {
  return (x, y) => {
    const v = function_(x, y);
    return v * -1;
  };
};
var defaultKeyer = (a) => {
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-2WXBM2JT.js.map