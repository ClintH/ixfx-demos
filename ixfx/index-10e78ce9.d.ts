import { a as LogKind, b as LogMessage, L as LogSet, M as MessageLogger } from './Types-bce495ac.js';
import { L as LogOption, l as logColours, a as logSet, b as logger, r as resolveLogOption } from './Logger-ff6de766.js';
...
declare namespace index {
  export {
    index_LogKind as LogKind,
    index_LogMessage as LogMessage,
    index_LogOption as LogOption,
    index_LogSet as LogSet,
    index_MessageLogger as MessageLogger,
    index_getErrorMessage as getErrorMessage,
    index_logColours as logColours,
    index_logSet as logSet,
    index_logger as logger,
    index_resolveLogOption as resolveLogOption,
  };
}

export { getErrorMessage as g, index as i };
