...
import { b as Easing } from './Easing-9f04548a.js';
import { a as Point, e as Rect } from './Point-f57faba9.js';
import { T as Timer } from './index-a456b68b.js';
import { a as pingPongPercent, p as pingPong } from './PingPong-e2971af9.js';
 ...
 * @returns
 */
declare const computeVelocity: (acceleration: Point, velocity: Point, velocityMax?: number | undefined) => Point;
/**
 ...
 * @returns
 */
declare const computeAccelerationToTarget: (targetPos: Point, currentPos: Point, opts?: TargetOpts) => Readonly<{
    x: number;
    y: number;
}>;
/**
