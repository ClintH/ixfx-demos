...
declare const bind: <V>(source: Reactive<V>, ...binds: DomBindOptionsWithElement<V>[]) => PipeDomBinding;
/**
...
declare namespace ReactiveDom {
  export { type ReactiveDom_BindUpdateOpts as BindUpdateOpts, type ReactiveDom_DomBindOptions as DomBindOptions, type ReactiveDom_DomBindOptionsWithElement as DomBindOptionsWithElement, type ReactiveDom_DomCreateOptions as DomCreateOptions, type ReactiveDom_PipeDomBinding as PipeDomBinding, ReactiveDom_bind as bind, ReactiveDom_bindDiffUpdate as bindDiffUpdate, ReactiveDom_bindElement as bindElement, ReactiveDom_bindHtmlContent as bindHtmlContent, ReactiveDom_bindTextContent as bindTextContent, ReactiveDom_bindUpdate as bindUpdate, ReactiveDom_createUpdate as createUpdate, ReactiveDom_win as win };
}
