...
declare type TimeoutSyncCallback = (elapsedMs?: number, ...args: readonly unknown[]) => boolean | void;
declare type TimeoutAsyncCallback = (elapsedMs?: number, ...args: readonly unknown[]) => Promise<boolean | void>;
/**
