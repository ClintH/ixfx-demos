import { s as string } from './index-5uEgUiqd.js';
import { s as stringSegmentsFromEnd } from './index-Ix0lTRBH.js';
...
type UntilMatchOptions = MatchOptions & {
 ...
 */
declare const untilMatch: (source: string, match: string, options?: Partial<UntilMatchOptions>) => string;
type MatchOptions = {
...
type Text_UntilMatchOptions = UntilMatchOptions;
...
declare namespace Text {
  export { type Text_LineSpan as LineSpan, type Text_MatchOptions as MatchOptions, type Text_Range as Range, type Text_UntilMatchOptions as UntilMatchOptions, Text_abbreviate as abbreviate, Text_afterMatch as afterMatch, Text_between as between, Text_betweenChomp as betweenChomp, Text_countCharsFromStart as countCharsFromStart, Text_htmlEntities as htmlEntities, Text_indexOfCharCode as indexOfCharCode, Text_lineSpan as lineSpan, Text_omitChars as omitChars, string as random, stringSegmentsFromEnd as segmentsFromEnd, Text_splitByLength as splitByLength, Text_splitRanges as splitRanges, Text_startsEnds as startsEnds, Text_toStringAbbreviate as toStringAbbreviate, Text_untilMatch as untilMatch, Text_unwrap as unwrap };
}

export { type LineSpan as L, type MatchOptions as M, type Range as R, Text as T, type UntilMatchOptions as U, abbreviate as a, between as b, betweenChomp as c, afterMatch as d, unwrap as e, splitRanges as f, countCharsFromStart as g, startsEnds as h, indexOfCharCode as i, htmlEntities as j, lineSpan as l, omitChars as o, splitByLength as s, toStringAbbreviate as t, untilMatch as u };
