...
/**
 * Yields a simple integer series from `start` to `end`, counting by 1.
 * If `start` is omitted, starts at 0
 * @param end
 * @param start
 */
declare const count: (end: number, start?: number | undefined) => Generator<number, void, unknown>;
/**
...
export { Generators as G, numericRange as a, pingPongPercent as b, count as c, numericRangeRaw as n, pingPong as p, rangePercent as r };
