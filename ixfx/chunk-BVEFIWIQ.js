...
var raf = typeof window === `undefined` ? (callback) => window.setTimeout(callback, 1) : (callback) => window.requestAnimationFrame(callback);
var continuously = (callback, interval2, opts = {}) => {
  ...
  let currentTimer = 0;
  const schedule = intervalMs === 0 ? raf : (callback_) => globalThis.setTimeout(callback_, intervalMs);
...
//# sourceMappingURL=chunk-BVEFIWIQ.js.map