...
var circleEl = (circle, parent, opts, id) => {
  const p = createOrResolve(parent, `circle`, id);
...
var lineEl = (line, parent, opts, id) => {
  const lineEl2 = createOrResolve(parent, `line`, id);
...
var textEl = (pos, text, parent, opts, id) => {
...
var svg = (parent, opts) => {
  ...
  const o = {
    text: (pos, text, opts2, id) => textEl(pos, text, parent, opts2, id),
    line: (line, opts2, id) => lineEl(line, parent, opts2, id),
    circle: (circle, opts2, id) => circleEl(circle, parent, opts2, id),
...
//# sourceMappingURL=chunk-JRS6WQQP.js.map