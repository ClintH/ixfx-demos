 ...
 * @example
 * ```js
 * each(count(5), () => console.log(`Hi`)); // Prints `Hi` 5x
 * each(count(5), (i) => console.log(i));   // Prints 0 1 2 3 4
 * ```
 * @param iterator
 * @param fn
 */
declare const each: <V>(iterator: IterableIterator<V>, fn: (v: V) => boolean) => void;
/**
...
declare const Generators_each: typeof each;
...
export { Generators as G, numericRange as a, pingPongPercent as b, count as c, each as e, numericRangeRaw as n, pingPong as p, rangePercent as r };
