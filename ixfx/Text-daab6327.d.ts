import { s as string } from './Arrays-83c49f17.js';
 ...
 */
declare const untilMatch: (source: string, match: string, opts?: MatchOpts) => string;
type MatchOpts = {
 ...
 * @returns
 */
declare const afterMatch: (source: string, match: string, opts?: MatchOpts) => string;
/**
...
export { LineSpan as L, MatchOpts as M, Range as R, Text as T, betweenChomp as a, between as b, afterMatch as c, unwrap as d, splitRanges as e, countCharsFromStart as f, startsEnds as g, htmlEntities as h, indexOfCharCode as i, lineSpan as l, omitChars as o, splitByLength as s, untilMatch as u };
