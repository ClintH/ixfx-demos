import { C as Circle, A as Arc, B as Bezier } from './Circle-965512ab';
import { P as Path, a as Point, R as RectPositioned, L as Line, b as Rect, c as Point$1, d as Path$1 } from './Rect-a483e621';
 ...
 */
declare function spiral(smoothness: number, zoom: number): Generator<{
    distance: number;
    angleRadian: number;
    step: number;
}, void, unknown>;
