...
import {
  mapCircular,
  stack
} from "./chunk-TD4SHBHU.js";
import {
  minMaxAvg,
  randomElement
} from "./chunk-EUUTLPTZ.js";
import {
  __export,
  __privateAdd,
  __privateGet,
...
var PaletteImpl = class {
  ...
  get(key, fallback) {
    ...
    if (c2 !== void 0)
      return c2;
    const varName = `--` + key;
    let fromCss = window.getComputedStyle(__privateGet(this, _elementBase)).getPropertyValue(varName).trim();
...
var getCssVariable = (name, fallbackColour = `black`, root) => {
  if (root === void 0)
    root = document.body;
  const fromCss = window.getComputedStyle(root).getPropertyValue(`--${name}`).trim();
  if (fromCss === void 0 || fromCss.length === 0)
...
//# sourceMappingURL=chunk-WPBIHJUF.js.map