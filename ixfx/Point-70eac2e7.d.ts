 ...
 * @returns
 */
declare const getPointsParam: (aOrLine: Point | Line, b?: Point | undefined) => readonly [Point, Point];
/**
 ...
 */
declare function interpolate$2(amount: number, a: Point, pointB: Point): Point;
/**
 ...
 * @param line Line
 */
declare function interpolate$2(amount: number, line: Line): Point;
/**
 ...
 * ```
 *
 * Use {@link toNumbers} for the opposite conversion.
 *
 * @param width
 * @param height
 */
 ...
 *
 * ```js
 * const r1 = Rects.toNumbers({ x: 10, y:20, width: 100, height: 200 });
 * // [10, 20, 100, 200]
 * const r2 = Rects.toNumbers({ width: 100, height: 200 });
 * // [100, 200]
 * ```
 * @param rect
 * @see fromNumbers
 */
declare const toNumbers: (rect: Rect | RectPositioned) => readonly number[];
 ...
 * @returns
 */
declare const normaliseByRect$1: (rect: Rect | RectPositioned, normaliseByOrWidth: Rect | number, height?: number | undefined) => Rect | RectPositioned;
/**
 ...
 */
declare const multiply$1: (a: RectPositioned | Rect, b: Rect | number, c?: number | undefined) => RectPositioned | Rect;
/**
 ...
 * @returns
 */
declare const center$1: (rect: RectPositioned | Rect, origin?: Point | undefined) => Point;
/**
...
declare const Rect$1_toNumbers: typeof toNumbers;
...
declare const center: (shape?: Rect | undefined) => Point;
/**
 ...
 * @returns
 */
declare const angle: (a: Point, b?: Point | undefined, c?: Point | undefined) => number;
/**
 ...
 * @returns
 */
declare const apply: (pt: Point, fn: (v: number, field?: string | undefined) => number) => Point;
/**
 ...
 * @returns
 */
declare const random: (rando?: RandomSource | undefined) => Point;
/**
...
declare type PointRelation = (a: Point | number, b?: number) => {
    /**
     * Angle from start
     */
 ...
 * @returns
 */
declare const relation: (a: Point | number, b?: number | undefined) => PointRelation;
...
declare const Point$1_center: typeof center;
...
export { Circle$1 as C, Line$1 as L, Point as P, RectPositioned as R, PointRelation as a, PolyLine as b, Path as c, Rect$1 as d, Point$1 as e, Path$1 as f, Rect as g, Line as h, CirclePositioned as i, Circle as j };
