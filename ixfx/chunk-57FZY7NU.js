...
var pingPong = function* (interval2, lower, upper, start, rounding) {
  ...
  if (Number.isNaN(interval2)) throw new Error(`interval parameter is NaN`);
  ...
  if (interval2 === 0) throw new Error(`Interval cannot be zero`);
...
//# sourceMappingURL=chunk-57FZY7NU.js.map