import { C as CirclePositioned, L as Line, P as Point, R as Rect } from './index-s45AP2Rl.js';
 ...
 * @returns
 */
declare const createOrResolve: <V extends SVGElement>(parent: SVGElement, type: string, queryOrExisting?: string | V | undefined, suffix?: string) => V;
