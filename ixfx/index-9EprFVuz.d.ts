...
import { b as StateMachine } from './StateMachineWithEvents-QuPTxQpw.js';
...
declare function repeatAsync<V>(countOrPredicate: number | RepeatPredicate, fn: (repeats: number, valuesProduced: number) => Promise<V | undefined>): AsyncGenerator<V>;
/**
...
declare const index_repeatAsync: typeof repeatAsync;
