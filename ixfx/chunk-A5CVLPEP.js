...
// src/dom/Util.ts
var fullSizeCanvas = (domQueryOrEl, onResized) => {
...
var windowResize = (timeoutMs = 100) => fromEvent(window, `resize`).pipe(throttleTime(timeoutMs));
...
var select = (domIdOrEl, onChanged, opts = {}) => {
  const el = resolveEl(domIdOrEl);
...
***************************************************************************** */
//# sourceMappingURL=chunk-A5CVLPEP.js.map