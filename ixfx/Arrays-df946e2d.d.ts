import { I as IsEqual, T as ToString } from './Util-45757d25.js';
 ...
 * @returns
 */
declare const flatten: <V>(array: readonly (V | readonly V[])[]) => readonly V[];
/**
 ...
 */
declare const mergeByKey: <V>(keyFn: ToString<V>, reconcile: MergeReconcile<V>, ...arrays: readonly (readonly V[])[]) => readonly V[];
/**
...
export { Arrays as A, sortByNumericProperty as B, Colour$1 as C, without as D, until as E, remove as F, groupBy as G, sample as H, chunks as I, mergeByKey as J, reducePairwise as K, pushUnique as L, MergeReconcile as M, Random as R, RandomSource as a, Rgb as b, randomElement as c, defaultRandom as d, weightedSkewed as e, weightedInteger as f, gaussian as g, gaussianSkewed as h, integer as i, float as j, shortGuid as k, randomHue as l, guardArray as m, guardIndex as n, areValuesIdentical as o, intersection as p, flatten as q, randomIndex as r, string as s, interleave as t, ensureLength as u, filterBetween as v, weighted as w, randomPluck as x, shuffle as y, zip as z };
