...
declare const multiply$1: (l: Line, p: Point) => Line;
 ...
 * @returns
 */
declare const rotate: (line: Line, angleRad?: number | undefined, origin?: number | Point | undefined) => Line;
 ...
 * const p2 = apply(p, (v) => Math.round(v));
 * // Yields: {x:1, y:5}
 * ```
 * @param pt
 * @param fn
