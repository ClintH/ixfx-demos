import { R as Reactive, D as DomBindOptions, P as PipeDomBinding, a as ReactiveDiff, b as ReactiveDisposable, c as ReactiveWritable, d as Passed, E as ElementsOptions, S as SplitOptions, e as ReactiveOrSource, f as ReactiveStream, F as FilterPredicate, g as SwitcherOptions, h as ResolveOptions, i as FieldOptions, j as ReactiveOp, I as InitStreamOptions, T as TransformOpts, A as AnnotationElapsed, k as SingleFromArrayOptions, B as BatchOptions, l as DebounceOptions, m as ThrottleOptions, n as ToArrayOptions, o as FromArrayOptions, p as ReactiveFinite, G as GeneratorOptions, q as PassedSignal, r as PassedValue, s as ReactiveInitial, t as ReactiveNonInitial, u as EventOptions, O as Optional, v as ObjectOptions, w as symbol, x as BindUpdateOpts, y as DomBindOptionsWithElement, z as DomCreateOptions, C as PipeSet, H as ReactiveOpInit, J as ReactiveOpLinks, K as SignalKinds, U as UpstreamOptions, W as Wrapped } from './Types-MKisNkEW.js';
...
declare const Dom_bindHtmlContent: typeof bindHtmlContent;
declare const Dom_bindTextContent: typeof bindTextContent;
...
declare namespace Dom {
  export { Dom_bind as bind, Dom_bindElement as bindElement, Dom_bindHtmlContent as bindHtmlContent, Dom_bindTextContent as bindTextContent, Dom_bindUpdate as bindUpdate, Dom_elements as elements, Dom_win as win };
}
...
declare const index_DomBindOptions: typeof DomBindOptions;
declare const index_DomBindOptionsWithElement: typeof DomBindOptionsWithElement;
