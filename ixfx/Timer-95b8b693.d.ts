...
declare const frequencyCycleSource: (cyclesPerSecond: number) => TimerSource;
declare const cycleTimer: (cycleLen: number, timer: Timer) => Timer;
...
declare const Timer$1_frequencyCycleSource: typeof frequencyCycleSource;
declare const Timer$1_cycleTimer: typeof cycleTimer;
...
declare namespace Timer$1 {
  export {
    ...
    Timer$1_frequencyCycleSource as frequencyCycleSource,
    Timer$1_cycleTimer as cycleTimer,
...
export { Continuously as C, HasCompletion as H, Timer$1 as T, TimerSource as a, Timer as b, Timeout as c, debounce as d, continuously as e, delay as f, frequencyCycleSource as g, cycleTimer as h, frequencyTimer as i, ticksElapsedTimer as j, msElapsedTimer as m, relativeTimer as r, sleep as s, timeout as t };
