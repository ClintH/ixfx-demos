 ...
 * @returns
 */
declare const minutesMs: (maxMinutes: number, minMinutes?: number) => number;
/**
 ...
 * @returns
 */
declare const secondsMs: (maxSeconds: number, minSeconds?: number) => number;
...
export { Arrays as A, randomPluck as B, Colour$1 as C, shuffle as D, sortByNumericProperty as E, without as F, until as G, remove as H, groupBy as I, sample as J, chunks as K, mergeByKey as L, MergeReconcile as M, reducePairwise as N, pushUnique as O, filterAB as P, unique as Q, Random as R, RandomSource as a, Rgb as b, randomElement as c, defaultRandom as d, weightedSkewed as e, weightedInteger as f, gaussian as g, gaussianSkewed as h, integer as i, float as j, shortGuid as k, secondsMs as l, minutesMs as m, randomHue as n, guardArray as o, guardIndex as p, areValuesIdentical as q, randomIndex as r, string as s, intersection as t, flatten as u, interleave as v, weighted as w, ensureLength as x, filterBetween as y, zip as z };
