 ...
 */
type LinksWithSource<TFinal, T1, T2> = LinksWithSource0<TFinal> | LinksWithSource1<TFinal, T1> | LinksWithSource2<TFinal, T1, T2>;
/**
 * Delay options
 */
type DelayOptions = {
 ...
 * @returns
 */
declare function run<TFinal, T2, T3>(...functions: LinksWithSource<TFinal, T2, T3>): AsyncGenerator<TFinal>;
