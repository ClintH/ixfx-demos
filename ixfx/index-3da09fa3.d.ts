...
import { a as StateChangeEvent, b as StateMachine } from './StateMachine-c77e7f4d.js';
import { Q as QueueMutable } from './Interfaces-72d49634.js';
import { C as Continuously } from './index-e37bbe84.js';
import { N as NumberTracker } from './NumberTracker-df72d7f9.js';
import { P as Point, g as Rect } from './Point-0f1bc73b.js';
import { M as ManualCapturer } from './Video-c7e8503b.js';
...
declare class BleDevice extends SimpleEventEmitter<Events> {
    ...
    rxBuffer: StringReceiveBuffer;
    txBuffer: StringWriteBuffer;
    constructor(device: BluetoothDevice, config: Opts$3);
    get isConnected(): boolean;
    get isClosed(): boolean;
    write(txt: string): void;
 ...
 */
declare const basic: (onData: (freq: Float32Array, wave: Float32Array, analyser: AudioAnalyser) => void, opts?: Opts$1) => AudioAnalyser;
/**
 ...
 * @returns
 */
declare const freq: (onData: (freq: Float32Array, analyser: AudioAnalyser) => void, opts?: Opts$1) => AudioAnalyser;
/**
 ...
 * @returns
 */
declare const peakLevel: (onData: (level: number, analyser: AudioAnalyser) => void, opts?: Opts$1) => AudioAnalyser;
/**
...
export { AudioAnalyser$1 as A, Codec as C, Espruino as E, FrameProcessor as F, NordicBleDevice$1 as N, StringReceiveBuffer as S, AudioVisualiser$1 as a, StringWriteBuffer as b, Camera as c, Serial as d, index as i };
