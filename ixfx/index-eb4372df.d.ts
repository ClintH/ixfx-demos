import { D as Drawing } from './Drawing-73fb6d6f';
import { b as CirclePositioned } from './Circle-f30fc0a6';
import { f as Line, a as Point } from './Rect-320e55dc';
import { M as MapOfMutable, C as CircularArray } from './Interfaces-482c491d';
 ...
 * @returns
 */
declare const pathEl: (svgOrArray: string | readonly string[], parent: SVGElement, opts?: DrawingOpts$1 | undefined, queryOrExisting?: string | SVGPathElement | undefined) => SVGPathElement;
...
declare const Svg_grid: typeof grid;
 ...
 * @return {*}
 */
declare const plot2: (parentElOrQuery: string | HTMLElement, opts: PlotOpts) => Plotter;
...
type Plot2_Plotter = Plotter;
declare namespace Plot2 {
  export {
    Plot2_PlotOpts as PlotOpts,
