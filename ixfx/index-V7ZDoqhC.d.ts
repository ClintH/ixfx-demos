import { C as Continuously, a as ContinuouslyAsyncCallback, b as ContinuouslyOpts, c as ContinuouslySyncCallback, O as OnStartCalled, d as continuously } from './Continuously-Pko7RQLS.js';
...
import { a as Comparer, R as Result } from './Results-D_-kaaAv.js';
...
import { b as StateMachine } from './StateMachine-GRU7DmZl.js';
...
type SeqNode = NodeBase & {
    readonly seq: ReadonlyArray<Node>;
};
type SelNode = NodeBase & {
    readonly sel: ReadonlyArray<Node>;
};
type Node = SeqNode | SelNode | string;
type Traversal = readonly [
    node: Node,
    path: string
];
declare function iterateBreadth(t: Node, pathPrefix?: string): Generator<Traversal>;
declare function iterateDepth(t: Node, pathPrefix?: string): Generator<Traversal>;
...
type index_Node = Node;
type index_NodeBase = NodeBase;
...
type index_SelNode = SelNode;
type index_SeqNode = SeqNode;
...
type index_TaskState = TaskState;
...
declare const index_iterateBreadth: typeof iterateBreadth;
declare const index_iterateDepth: typeof iterateDepth;
...
declare namespace index {
  export { index_AsyncPromiseOrGenerator as AsyncPromiseOrGenerator, type index_AsyncTask as AsyncTask, type index_BackoffOptions as BackoffOptions, index_CompletionTimer as CompletionTimer, index_Continuously as Continuously, index_ContinuouslyAsyncCallback as ContinuouslyAsyncCallback, index_ContinuouslyOpts as ContinuouslyOpts, index_ContinuouslySyncCallback as ContinuouslySyncCallback, type index_DebouncedFunction as DebouncedFunction, type index_DelayOpts as DelayOpts, type index_Dispatch as Dispatch, index_DispatchList as DispatchList, index_Elapsed as Elapsed, type index_ExpressionOrResult as ExpressionOrResult, index_HasCompletion as HasCompletion, index_HasCompletionRunStates as HasCompletionRunStates, index_Interval as Interval, type index_IntervalOpts as IntervalOpts, index_ModulationTimer as ModulationTimer, type index_Node as Node, type index_NodeBase as NodeBase, index_OnStartCalled as OnStartCalled, type index_RateMinimumOptions as RateMinimumOptions, index_RelativeTimerOpts as RelativeTimerOpts, type index_RepeatPredicate as RepeatPredicate, index_RequestResponseMatch as RequestResponseMatch, type index_RequestResponseMatchEvents as RequestResponseMatchEvents, type index_RequestResponseOptions as RequestResponseOptions, type index_RetryOpts as RetryOpts, type index_RetryResult as RetryResult, type index_RetryTask as RetryTask, type index_RunOpts as RunOpts, type index_RunSingleOpts as RunSingleOpts, type index_SelNode as SelNode, type index_SeqNode as SeqNode, index_SleepOpts as SleepOpts, index_StateMachine as StateMachine, index_SyncWait as SyncWait, type index_Task as Task, type index_TaskQueueEvents as TaskQueueEvents, index_TaskQueueMutable as TaskQueueMutable, type index_TaskState as TaskState, type index_Timeout as Timeout, type index_TimeoutAsyncCallback as TimeoutAsyncCallback, type index_TimeoutSyncCallback as TimeoutSyncCallback, index_Timer as Timer, index_TimerOpts as TimerOpts, index_TimerSource as TimerSource, type index_UpdateFailPolicy as UpdateFailPolicy, index_backoffGenerator as backoffGenerator, index_continuously as continuously, index_debounce as debounce, index_delay as delay, index_delayLoop as delayLoop, index_everyNth as everyNth, index_forEach as forEach, index_forEachAsync as forEachAsync, index_frequencyTimer as frequencyTimer, index_frequencyTimerSource as frequencyTimerSource, index_hasElapsed as hasElapsed, index_interval as interval, index_intervalToMs as intervalToMs, index_isInterval as isInterval, index_iterateBreadth as iterateBreadth, index_iterateDepth as iterateDepth, index_msElapsedTimer as msElapsedTimer, index_promiseFromEvent as promiseFromEvent, index_rateMinimum as rateMinimum, index_relativeTimer as relativeTimer, index_repeat as repeat, index_repeatAwait as repeatAwait, index_retryFunction as retryFunction, index_retryTask as retryTask, index_run as run, index_runOnce as runOnce, index_runSingle as runSingle, index_sleep as sleep, index_sleepWhile as sleepWhile, index_throttle as throttle, index_ticksElapsedTimer as ticksElapsedTimer, index_timeout as timeout, index_updateOutdated as updateOutdated, index_waitFor as waitFor };
}

export { type UpdateFailPolicy as $, type RequestResponseOptions as A, type RequestResponseMatchEvents as B, RequestResponseMatch as C, type DebouncedFunction as D, Elapsed as E, type RetryResult as F, type BackoffOptions as G, backoffGenerator as H, type IntervalOpts as I, type RetryOpts as J, type RetryTask as K, retryFunction as L, retryTask as M, type NodeBase as N, runOnce as O, SyncWait as P, type AsyncTask as Q, type RunOpts as R, type SeqNode as S, type TaskState as T, type TaskQueueEvents as U, TaskQueueMutable as V, throttle as W, type TimeoutSyncCallback as X, type TimeoutAsyncCallback as Y, type Timeout as Z, timeout as _, type Task as a, updateOutdated as a0, waitFor as a1, type SelNode as b, type Node as c, iterateBreadth as d, iterateDepth as e, debounce as f, type DelayOpts as g, delay as h, index as i, delayLoop as j, type Dispatch as k, DispatchList as l, everyNth as m, type ExpressionOrResult as n, type RunSingleOpts as o, runSingle as p, forEach as q, run as r, forEachAsync as s, interval as t, promiseFromEvent as u, type RateMinimumOptions as v, rateMinimum as w, type RepeatPredicate as x, repeatAwait as y, repeat as z };
