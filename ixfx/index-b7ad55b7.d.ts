...
declare const scale: (count: number, a: string, b: string, space?: Spaces) => unknown[];
...
declare const Colour_parseToHsl: typeof parseToHsl;
declare const Colour_parseNeutral: typeof parseNeutral;
...
declare namespace Colour {
  export {
    ...
    Colour_scale as scale,
    Colour_opacity as opacity,
    Colour_parseToHsl as parseToHsl,
    Colour_parseNeutral as parseNeutral,
