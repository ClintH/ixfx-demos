...
declare namespace StateMachine {
  export { type ExpressionOrResult as DriverExpression, type StatesHandler as DriverHandler, type StateMachine_DriverOpts as DriverOpts, type Result as DriverResult, type StateMachine_Machine as Machine, type StateMachine_MachineState as MachineState, type StateMachine_Runner as Runner, type StateMachine_StateMachineEventMap as StateMachineEventMap, type Opts as StateMachineWithEventsOpts, type StateMachine_StateNames as StateNames, type StateMachine_StateTarget as StateTarget, type StateMachine_StateTargetStrict as StateTargetStrict, type StateMachine_StopEvent as StopEvent, type StateMachine_TransitionCondition as TransitionCondition, type StateMachine_TransitionResult as TransitionResult, type StateMachine_Transitions as Transitions, type StateMachine_TransitionsStrict as TransitionsStrict, StateMachineWithEvents as WithEvents, StateMachine_bidirectionalFromList as bidirectionalFromList, StateMachine_cloneState as cloneState, StateMachine_done as done, init$1 as driver, StateMachine_fromList as fromList, StateMachine_init as init, StateMachine_isValidTransition as isValidTransition, StateMachine_next as next, StateMachine_normaliseTargets as normaliseTargets, StateMachine_possible as possible, StateMachine_possibleTargets as possibleTargets, StateMachine_reset as reset, StateMachine_to as to, StateMachine_validateMachine as validateMachine, StateMachine_validateTransition as validateTransition };
}

export { type StatesHandler as A, type Result as B, type DriverOpts as D, type ExpressionOrResult as E, type Machine as M, type Opts as O, type Runner as R, StateMachine as S, type Transitions as T, StateMachineWithEvents as a, type StateChangeEvent as b, type StateMachineEventMap as c, type StopEvent as d, type TransitionResult as e, type TransitionCondition as f, type StateTargetStrict as g, type StateTarget as h, type TransitionsStrict as i, type StateNames as j, type MachineState as k, cloneState as l, init as m, done as n, possible as o, possibleTargets as p, normaliseTargets as q, reset as r, next as s, to as t, isValidTransition as u, validateMachine as v, validateTransition as w, fromList as x, bidirectionalFromList as y, init$1 as z };
