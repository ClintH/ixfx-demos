import { i as ReactiveOrSource, T as TransformOpts, R as Reactive, j as ReactiveOp, B as BatchOptions, C as CombineLatestOptions, k as RxValueTypes, l as RxValueTypeObject, m as ReactiveInitial, D as DebounceOptions, F as FieldOptions, n as FilterPredicate, I as InitStreamOptions, S as SingleFromArrayOptions, o as SplitOptions, q as ReactiveStream, r as SwitcherOptions, s as SyncOptions, c as Processors, t as ReactiveWritable, u as ThrottleOptions, v as TimeoutTriggerOptions, W as WithValueOptions, w as ToArrayOptions, P as Passed, x as PassedSignal, y as PassedValue, z as ReactiveDiff, A as Wrapped, E as Trigger, G as TriggerValue, H as TriggerFunction, J as TriggerGenerator, K as GeneratorOptions, L as FunctionOptions, M as CountOptions, N as DomBindSourceValue, O as PipeDomBinding, Q as DomBindValueTarget, V as DomBindUnresolvedSource, X as BindUpdateOpts, Y as ElementsOptions, Z as ArrayOptions, _ as ReactiveFinite, $ as ArrayObjectOptions, a0 as ReactiveArray, a1 as ReactiveNonInitial, a2 as EventOptions, a3 as EventTriggerOptions, a4 as DomValueOptions, a5 as FunctionFunction, a6 as PingedFunctionFunction, a7 as PingedFunctionOptions, a8 as ObjectOptions, a9 as symbol, aa as EventPluckedFieldOptions, ab as EventPluckedFieldOptions2, ac as SetHtmlOptions, ad as OpMathOptions, ae as TallyOptions, U as Unsubscriber, af as DomBindInputOptions, ag as DomBindResolvedSource, ah as DomBindTargetNode, ai as DomBindTargetNodeResolved, aj as DomCreateOptions, ak as ElementBind, al as InitLazyStreamInitedOptions, am as InitLazyStreamOptions, an as Lazy, ao as OpAsAnnotation, ap as Optional, aq as PipeSet, ar as PrimitiveValueTypeObject, as as ReactiveOpInit, at as ReactiveOpLinks, au as ResolveOptions, av as SetHtmlOptionsElement, aw as SetHtmlOptionsQuery, ax as SignalKinds, ay as UpstreamOptions, az as average, aA as max, aB as min, aC as rank, aD as setHtmlText, aE as sum, aF as tally } from './Types-8cDVJ8Ha.js';
import { I as Interval } from './IntervalType-CQa4mlKV.js';
import { R as RankFunction, a as RankOptions } from './Types-0RfFkd3L.js';
import { C as Change } from './Immutable-ZCanoHO-.js';
 ...
 * @returns
 */
declare function combineLatestToObject<const T extends Record<string, ReactiveOrSource<any>>>(reactiveSources: T, options?: Partial<CombineLatestOptions>): Reactive<RxValueTypeObject<T>> & ReactiveInitial<RxValueTypeObject<T>>;
...
type OpChain2<T1, T2, T3> = [
    ReactiveOp<T1, T2>,
    ReactiveOp<T2, T3>
];
type OpChain3<T1, T2, T3, T4> = [
    ReactiveOp<T1, T2>,
    ReactiveOp<T2, T3>,
    ReactiveOp<T3, T4>
];
type OpChain4<T1, T2, T3, T4, T5> = [
    ReactiveOp<T1, T2>,
    ReactiveOp<T2, T3>,
    ReactiveOp<T3, T4>,
    ReactiveOp<T4, T5>
];
type OpChain5<T1, T2, T3, T4, T5, T6> = [
    ReactiveOp<T1, T2>,
    ReactiveOp<T2, T3>,
    ReactiveOp<T3, T4>,
    ReactiveOp<T4, T5>,
...
type OpChain<T1, T2, T3, T4, T5, T6> = OpChain1<T1, T2> | OpChain2<T1, T2, T3> | OpChain3<T1, T2, T3, T4> | OpChain4<T1, T2, T3, T4, T5> | OpChain5<T1, T2, T3, T4, T5, T6>;
declare function chainer<T1, T2>(...ops: [ReactiveOp<T1, T2>]): (source: ReactiveOrSource<T1>) => Reactive<T2>;
declare function chainer<T1, T2, T3>(...ops: OpChain2<T1, T2, T3>): (source: ReactiveOrSource<T1>) => Reactive<T3>;
declare function chainer<T1, T2, T3, T4>(...ops: OpChain3<T1, T2, T3, T4>): (source: ReactiveOrSource<T1>) => Reactive<T4>;
declare function chainer<T1, T2, T3, T4, T5>(...ops: OpChain4<T1, T2, T3, T4, T5>): (source: ReactiveOrSource<T1>) => Reactive<T5>;
declare function chainer<T1, T2, T3, T4, T5, T6>(...ops: OpChain5<T1, T2, T3, T4, T5, T6>): (source: ReactiveOrSource<T1>) => Reactive<T6>;
declare function run<T1, T2>(source: ReactiveOrSource<T1>, ...ops: OpChain1<T1, T2>): Reactive<T2>;
declare function run<T1, T2, T3>(source: ReactiveOrSource<T1>, ...ops: OpChain2<T1, T2, T3>): Reactive<T3>;
declare function run<T1, T2, T3, T4>(source: ReactiveOrSource<T1>, ...ops: OpChain3<T1, T2, T3, T4>): Reactive<T4>;
declare function run<T1, T2, T3, T4, T5>(source: ReactiveOrSource<T1>, ...ops: OpChain4<T1, T2, T3, T4, T5>): Reactive<T5>;
declare function run<T1, T2, T3, T4, T5, T6>(source: ReactiveOrSource<T1>, ...ops: OpChain5<T1, T2, T3, T4, T5, T6>): Reactive<T6>;
...
declare const opify: <TIn, TOut = TIn>(fn: (source: ReactiveOrSource<TIn>, ...args: Array<any>) => Reactive<TOut>, ...args: Array<any>) => (source: ReactiveOrSource<TIn>) => Reactive<TOut>;
...
declare function fromDomQuery(query: string): Reactive<HTMLElement[]> & {
    ...
    update(changedPart: Record<string, any>): HTMLElement[];
 ...
 * @returns
 */
declare function domInputValue(targetOrQuery: HTMLInputElement | string, options?: Partial<DomValueOptions>): ReactiveInitial<string> & Reactive<string> & ReactiveWritable<string>;
...
declare namespace index$1 {
  export { index$1_ArrayObjectOptions as ArrayObjectOptions, index$1_ArrayOptions as ArrayOptions, index$1_DomValueOptions as DomValueOptions, index$1_EventOptions as EventOptions, index$1_EventPluckedFieldOptions as EventPluckedFieldOptions, index$1_EventPluckedFieldOptions2 as EventPluckedFieldOptions2, index$1_EventTriggerOptions as EventTriggerOptions, index$1_FunctionFunction as FunctionFunction, index$1_FunctionOptions as FunctionOptions, index$1_GeneratorOptions as GeneratorOptions, index$1_ObjectOptions as ObjectOptions, index$1_PingedFunctionFunction as PingedFunctionFunction, index$1_PingedFunctionOptions as PingedFunctionOptions, type index$1_ReactiveProxied as ReactiveProxied, index$1_TimeoutTriggerOptions as TimeoutTriggerOptions, index$1_Trigger as Trigger, type index$1_TriggerData as TriggerData, index$1_TriggerFunction as TriggerFunction, index$1_TriggerGenerator as TriggerGenerator, index$1_TriggerValue as TriggerValue, index$1_array as array, index$1_arrayObject as arrayObject, index$1_boolean as boolean, index$1_domInputValue as domInputValue, index$1_event as event, index$1_eventField as eventField, index$1_eventTrigger as eventTrigger, index$1_func as func, index$1_iterator as iterator, index$1_number as number, index$1_object as object, index$1_objectProxy as objectProxy, index$1_objectProxySymbol as objectProxySymbol, index$1_observable as observable, index$1_observableWritable as observableWritable, index$1_of as of, index$1_pinged as pinged, index$1_string as string };
}
...
declare const Ops: {
   ...
   */
     ...
     * @returns
     */
    readonly annotateWithOp: <TIn, TAnnotation_2>(annotatorOp: ReactiveOp<TIn, TAnnotation_2>) => <In_1, TAnnotation_3>(source: ReactiveOrSource<In_1>) => Reactive<{
        value: In_1;
        annotation: TAnnotation_3;
    }>;
    /**
     ...
     * @returns
     */
    readonly batch: <V_1>(options: Partial<BatchOptions>) => ReactiveOp<V_1, V_1[]>;
    readonly cloneFromFields: <V_2>() => ReactiveOp<V_2, V_2>;
    /**
   ...
   * @returns
   */
    readonly debounce: <V_3>(options: Partial<DebounceOptions>) => ReactiveOp<V_3, V_3>;
    readonly elapsed: <V_4>() => ReactiveOp<V_4, number>;
    /**
     ...
     * @returns
     */
    readonly filter: <V_5>(predicate: (value: V_5) => boolean) => <In_2>(source: ReactiveOrSource<In_2>) => Reactive<In_2>;
    /**
   * Outputs the minimum numerical value of the stream.
   * A value is only emitted when minimum decreases.
   * @returns
   */
    readonly min: <TIn_1 = number>(options?: OpMathOptions) => (source: ReactiveOrSource<TIn_1>) => Reactive<number>;
    /**
     * Outputs the maxium numerical value of the stream.
     * A value is only emitted when maximum increases.
     * @returns
     */
    readonly max: <TIn_2 = number>(options?: OpMathOptions) => (source: ReactiveOrSource<TIn_2>) => Reactive<number>;
    readonly sum: <TIn_3 = number>(options?: OpMathOptions) => (source: ReactiveOrSource<TIn_3>) => Reactive<number>;
    readonly average: <TIn_4 = number>(options?: OpMathOptions) => (source: ReactiveOrSource<TIn_4>) => Reactive<number>;
    readonly tally: <TIn_5>(options?: TallyOptions) => (source: ReactiveOrSource<TIn_5>) => Reactive<number>;
    readonly rank: <TIn_6>(rank: RankFunction<TIn_6>, options?: RankOptions & OpMathOptions) => (source: ReactiveOrSource<TIn_6>) => Reactive<TIn_6>;
    ...
    readonly singleFromArray: <V_6>(options?: Partial<SingleFromArrayOptions<V_6>>) => (source: ReactiveOrSource<V_6[]>) => Reactive<V_6>;
    ...
    readonly tapStream: <In_1>(divergedStream: ReactiveWritable<In_1>) => ReactiveOp<In_1, In_1>;
    readonly tapOps: <In_2, Out>(...ops: ReactiveOp<In_2, Out>[]) => (source: ReactiveOrSource<In_2>) => Reactive<Out>;
    /**
   ...
   */
    ...
    readonly transform: <In_3, Out_1>(transformer: (value: In_3) => Out_1, options?: Partial<TransformOpts>) => ReactiveOp<In_3, Out_1>;
    /**
...
type index_OpChain<T1, T2, T3, T4, T5, T6> = OpChain<T1, T2, T3, T4, T5, T6>;
type index_OpChain1<T1, T2> = OpChain1<T1, T2>;
type index_OpChain2<T1, T2, T3> = OpChain2<T1, T2, T3>;
type index_OpChain3<T1, T2, T3, T4> = OpChain3<T1, T2, T3, T4>;
type index_OpChain4<T1, T2, T3, T4, T5> = OpChain4<T1, T2, T3, T4, T5>;
type index_OpChain5<T1, T2, T3, T4, T5, T6> = OpChain5<T1, T2, T3, T4, T5, T6>;
...
declare const index_chainer: typeof chainer;
