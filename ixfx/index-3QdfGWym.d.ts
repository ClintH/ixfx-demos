import { P as Point, an as CardinalDirection, R as Rect } from './index-ezZcXkXG.js';
import { F as Forms } from './Forms-L7Bq41nz.js';
import { S as SimpleEventEmitter } from './Events-nue2G3Li.js';
import { a as ScaleBy, b as Scaler } from './Scaler-vYaQEKd_.js';
import { R as Reactive, U as Unsubscriber, P as Passed } from './Types-_Zmx2Zlc.js';
...
declare const themeChange: () => {
    on: (handler: (value: Passed<MutationRecord[]>) => void) => Unsubscriber;
    value: (callback: (value: MutationRecord[]) => void) => Unsubscriber;
};
/**
...
export { query as $, elRequery as A, el as B, CssVariables as C, DataTable$1 as D, type ElPositionOpts as E, type DataDisplayOptions as F, DataDisplay as G, pointerVisualise as H, defaultErrorHandler as I, type InlineConsoleOptions as J, inlineConsole as K, type LogOpts as L, type CanvasOpts as M, type CanvasEvents as N, type Opts as O, type PointSpaces as P, CanvasHelper as Q, type CanvasResizeArgs as R, parentSizeCanvas as S, fullSizeCanvas as T, type ElementResizeArgs as U, fullSizeElement as V, parentSize as W, resolveEl as X, type QueryOrElements as Y, resolveEls as Z, type ElementQueryOptions as _, DragDrop as a, DomRx as b, type Log as c, positionFn as d, cardinalPosition as e, positionRelative as f, positionFromMiddle as g, cycleCssClass as h, index as i, getTranslation as j, createAfter as k, log as l, createIn as m, clear as n, copyToClipboard as o, pointScaler as p, insertSorted as q, type CreateUpdateElement as r, reconcileChildren as s, setCssClass as t, setCssToggle as u, viewportToSpace as v, setCssDisplay as w, byId as x, setHtml as y, setText as z };
