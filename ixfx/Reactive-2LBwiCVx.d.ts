...
/**
 * Returns a Generator wrapper around Reactive.
 *
 *
 * ```js
 ...
 * @param source
 */
declare function toGenerat<V>(source: ReactiveOrSource<V>): AsyncGenerator<V>;
