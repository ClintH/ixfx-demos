...
import { P as Point } from './Point-38b2ac09.js';
 ...
 * @returns
 */
declare const parentSize: <V extends HTMLElement>(domQueryOrEl: string | V, onResized?: ((args: ElementResizeArgs<V>) => void) | undefined, timeoutMs?: number) => rxjs.Subscription;
/**
 ...
 * ```
 */
declare const dataTable: (parentOrQuery: HTMLElement | string, data?: object | undefined) => (data: object) => void;
/**
...
export { CreateUpdateElement as C, DomRxOpts as D, LogOpts as L, PluckOpts as P, Rx as R, TransformOpts as T, Log as a, parentSizeCanvas as b, resolveEl as c, createAfter as d, createIn as e, fullSizeCanvas as f, getTranslation as g, dataTableList as h, index as i, dataTable as j, clear as k, log as l, resizeObservable as m, copyToClipboard as n, reconcileChildren as o, parentSize as p, rx as r, themeChangeObservable as t, windowResize as w };
