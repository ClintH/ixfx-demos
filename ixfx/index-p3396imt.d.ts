...
type ChainDom_ElementQueryOptions = ElementQueryOptions;
type ChainDom_WrappedElement = WrappedElement;
declare const ChainDom_query: typeof query;
declare namespace ChainDom {
  export { type ChainDom_ElementQueryOptions as ElementQueryOptions, type ChainDom_WrappedElement as WrappedElement, ChainDom_query as query };
}
