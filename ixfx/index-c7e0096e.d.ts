...
type Waveform_Oscillator = Oscillator;
declare const Waveform_sine: typeof sine;
declare namespace Waveform {
  export {
    Waveform_Oscillator as Oscillator,
    Waveform_sine as sine,
  };
}

declare const index_Waveform: typeof Waveform;
...
export { AdsrOpts as A, CompleteEvent as C, Easing as E, StateChangeEvent as S, Waveform as W, easeOverTicks as a, EasingName as b, EnvelopeOpts as c, defaultAdsrOpts as d, easeOverTime as e, AdsrTimingOpts as f, getEasings as g, Adsr as h, index as i, adsr as j };
