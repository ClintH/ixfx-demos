 ...
 * ```
 */
declare const getOrGenerate: <K, V, Z>(map: Map<K, V>, fn: (key: K, args?: Z | undefined) => V | Promise<V>) => (key: K, args?: Z | undefined) => Promise<V>;
/**
...
export { Map$1 as M, getOrGenerateSync as a, addUniqueByHash as b, hasAnyValue as c, find as d, transformMap as e, filter as f, getOrGenerate as g, hasKeyValue as h, mapToObj as i, mapToArray as j, mapToObjTransform as m, toArray as t, zipKeyValue as z };
