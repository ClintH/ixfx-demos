import { P as Point, h as Line, c as Path, R as RectPositioned, g as Rect, j as Circle, b as PolyLine, i as CirclePositioned } from './Point-61f87cdf.js';
...
declare type TriangleEquilateral = {
 ...
 * @returns
 */
declare const fromCenter$1: (t: TriangleEquilateral, origin?: Point, rotationRad?: number | undefined) => Triangle;
/**
 ...
 * @returns
 */
declare const apply: (t: Triangle, fn: (p: Point, label?: string | undefined) => Point) => Readonly<Triangle>;
/**
 ...
 * @returns
 */
declare const isIsoceles: (t: Triangle) => boolean;
/**
 ...
 * @returns
 */
declare const barycentricCoord: (t: Triangle, a: Point | number, b?: number | undefined) => BarycentricCoord;
/**
 ...
 * @param b
 */
declare const intersectsPoint: (t: Triangle, a: Point | number, b?: number | undefined) => boolean;
/**
 ...
 * @returns
 */
declare const rotate: (t: Triangle, amountRadian?: number | undefined, origin?: Point | undefined) => Triangle;
...
declare const Triangle$1_isIsoceles: typeof isIsoceles;
...
declare namespace Triangle$1 {
  export {
    ...
    Triangle$1_isIsoceles as isIsoceles,
...
export { Arc$1 as A, Bezier as B, CubicBezier as C, Ellipse$1 as E, QuadraticBezier as Q, Triangle$1 as T, ArcPositioned as a, EllipsePositioned as b, Triangle as c };
