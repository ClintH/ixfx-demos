  ...
  compute(allowStateChange = true) {
    ...
    switch (stage) {
      case `attack`:
        ...
        console.log(`attack v: ${v}`);
        if (this.initialLevelOverride !== void 0) {
          v = scale(v, 0, 1, this.initialLevelOverride, 1);
          console.log(` initialOverride. ${v} level: ${this.initialLevel} override: ${this.initialLevelOverride}`);
        }
        this.releasedAt = v;
        break;
      case `decay`:
...
//# sourceMappingURL=chunk-X6SKI46A.js.map