import { C as CellAccessor } from './Grid-DwvA8aOV.js';
import { R as Rgb, C as Colour } from './Colour-fqMGpqKU.js';
import { P as Point } from './PointType-0vgoM_lJ.js';
import { L as Line } from './LineType-Lekba5_H.js';
import { P as Path, Q as QuadraticBezier, C as CubicBezier, A as ArcPositioned, E as EllipsePositioned, T as Triangle } from './ArcType-VEUNL6ta.js';
import { R as Rect, a as RectPositioned } from './RectTypes-kjDrC-8b.js';
import { C as CirclePositioned } from './CircleType-hb8awD7g.js';
import { I as IStackImmutable, a as IMapOfMutableExtended } from './IMapOfMutableExtended-GUT4venp.js';
import { S as Svg } from './Svg-_6ogwEgE.js';
...
declare const makeHelper: (ctxOrCanvasEl: CanvasContextQuery, canvasBounds?: Rect) => {
    ...
    paths(pathsToDraw: Array<Path>, opts?: DrawingOpts$1): void;
    line(lineToDraw: Line | Array<Line>, opts?: DrawingOpts$1): void;
    rect(rectsToDraw: RectPositioned | Array<RectPositioned>, opts?: DrawingOpts$1 & {
        filled?: boolean;
    }): void;
    bezier(bezierToDraw: QuadraticBezier | CubicBezier, opts?: DrawingOpts$1): void;
    connectedPoints(pointsToDraw: Array<Point>, opts?: DrawingOpts$1 & {
        loop?: boolean;
    }): void;
    pointLabels(pointsToDraw: Array<Point>, opts?: DrawingOpts$1): void;
    dot(dotPosition: Point | Array<Point>, opts?: DotOpts): void;
    circle(circlesToDraw: CirclePositioned | Array<CirclePositioned>, opts: DrawingOpts$1): void;
    arc(arcsToDraw: ArcPositioned | Array<ArcPositioned>, opts: DrawingOpts$1): void;
    textBlock(lines: Array<string>, opts: DrawingOpts$1 & {
        anchor: Point;
 ...
 * @param opts
 */
declare const lineThroughPoints: (ctx: CanvasRenderingContext2D, points: ReadonlyArray<Point>, opts?: DrawingOpts$1) => void;
/**
 ...
 */
declare const circle: (ctx: CanvasRenderingContext2D, circlesToDraw: CirclePositioned | ReadonlyArray<CirclePositioned>, opts?: DrawingOpts$1) => void;
/**
 ...
 * @param opts
 */
declare const ellipse: (ctx: CanvasRenderingContext2D, ellipsesToDraw: EllipsePositioned | ReadonlyArray<EllipsePositioned>, opts?: DrawingOpts$1) => void;
/**
 ...
 * @param pts
 */
declare const connectedPoints: (ctx: CanvasRenderingContext2D, pts: ReadonlyArray<Point>, opts?: {
    readonly lineWidth?: number;
 ...
 * @param opts
 */
declare const dot: (ctx: CanvasRenderingContext2D, pos: Point | ReadonlyArray<Point>, opts?: DotOpts) => void;
/**
 ...
 * @param opts
 */
declare const line: (ctx: CanvasRenderingContext2D, toDraw: Line | ReadonlyArray<Line>, opts?: LineOpts & DrawingOpts$1) => void;
/**
 ...
 * @param opts
 */
declare const triangle: (ctx: CanvasRenderingContext2D, toDraw: Triangle | ReadonlyArray<Triangle>, opts?: DrawingOpts$1 & {
    readonly filled?: boolean;
}) => void;
/**
 ...
 * @param opts
 */
declare const rect: (ctx: CanvasRenderingContext2D, toDraw: Rect | RectPositioned | ReadonlyArray<RectPositioned>, opts?: DrawingOpts$1 & {
    readonly filled?: boolean;
 ...
 * @param opts
 */
declare const textBlock: (ctx: CanvasRenderingContext2D, lines: ReadonlyArray<string>, opts: DrawingOpts$1 & {
 ...
 */
declare const textBlockAligned: (ctx: CanvasRenderingContext2D, text: ReadonlyArray<string> | string, opts: DrawingOpts$1 & {
    readonly bounds: RectPositioned;
