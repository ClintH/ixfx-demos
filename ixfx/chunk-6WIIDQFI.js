...
var textPathUpdate = (el, text, opts) => {
  ...
  if (opts?.startOffset) {
    el.setAttributeNS(null, `startOffset`, numOfPerctange(opts.startOffset));
  }
  if (opts?.textLength)
    el.setAttributeNS(null, `textLength`, opts.textLength.toString());
  if (text) {
    el.textContent = text;
  }
};
...
//# sourceMappingURL=chunk-6WIIDQFI.js.map