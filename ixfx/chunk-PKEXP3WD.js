...
var interpolate2 = (arc, t2, origin) => {
  guard2(arc);
...
var toPath = (arc) => {
  ...
  return Object.freeze({
    ...arc,
    interpolate: (t2) => interpolate2(arc, t2),
    bbox: () => bbox2(arc),
    length: () => length(arc),
...
var bbox2 = (arc) => {
  if (isPositioned(arc)) {
    const middle = interpolate2(arc, 0.5);
...
var interpolate3 = (circle, t2) => point2(circle, t2 * piPi2);
...
var toPath4 = (line) => {
  ...
  return Object.freeze({
    ...line,
    length: () => length3(a, b),
    interpolate: (amount) => interpolate5(amount, a, b),
    bbox: () => bbox5(line),
