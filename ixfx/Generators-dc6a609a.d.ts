 ...
 */
declare const forEach: <V>(iterator: IterableIterator<V> | V[], fn: (v?: V | undefined) => boolean | void) => void;
/**
 ...
 * @param fn
 */
declare const forEachAsync: <V>(iterator: AsyncIterableIterator<V> | V[], fn: (v?: V | undefined) => Promise<boolean> | void, intervalMs?: number | undefined) => AsyncGenerator<never, void, unknown>;
/**
