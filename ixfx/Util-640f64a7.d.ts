import { I as Interval } from './index-05c1585a.js';
 ...
 * @returns
 */
declare const resolveLogOption: (l?: LogOption) => LogFn;
/**
 ...
 * @returns
 */
declare const elapsedMs: (interval: Interval) => string;
...
declare const Util_elapsedMs: typeof elapsedMs;
