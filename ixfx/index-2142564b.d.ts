import { H as HasCompletion, a as TimerSource } from './Timer-23f99cf8';
 ...
 *
 */
declare type Oscillator = {
    get value(): number;
};
declare const sine: (timerSrc: TimerSource) => Oscillator;
declare const sineBipolar: (timerSrc: TimerSource) => Oscillator;
declare const triangle: (timerSrc: TimerSource) => Oscillator;
declare const saw: (timerSrc: TimerSource) => Oscillator;
declare const square: (timerSrc: TimerSource) => Oscillator;

type Oscillator$1_Oscillator = Oscillator;
declare const Oscillator$1_sine: typeof sine;
declare const Oscillator$1_sineBipolar: typeof sineBipolar;
declare const Oscillator$1_triangle: typeof triangle;
declare const Oscillator$1_saw: typeof saw;
declare const Oscillator$1_square: typeof square;
declare namespace Oscillator$1 {
  export {
    Oscillator$1_Oscillator as Oscillator,
    Oscillator$1_sine as sine,
    Oscillator$1_sineBipolar as sineBipolar,
    Oscillator$1_triangle as triangle,
    Oscillator$1_saw as saw,
    Oscillator$1_square as square,
  };
}
...
export { AdsrOpts as A, CompleteEvent as C, Easing as E, Oscillator$1 as O, StateChangeEvent as S, easeOverTicks as a, EasingName as b, EnvelopeOpts as c, defaultAdsrOpts as d, easeOverTime as e, AdsrTimingOpts as f, getEasings as g, Adsr as h, index as i, adsr as j };
