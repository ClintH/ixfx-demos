...
declare const textPathEl: (pathRef: string, text: string, parent: SVGElement, opts?: DrawingOpts$1 | undefined, idOrExisting?: string | SVGTextPathElement | undefined) => SVGTextPathElement;
