...
import { R as Reactive, a as Passed, U as Unsubscriber, b as PathDataChange, C as ChangeKind, c as ChangeRecord, d as CompareChangeSet, I as IsEqualContext, P as Pathed, e as Process, f as changedDataFields, g as compareArrays, h as compareData, i as compareKeys, j as isEmptyEntries, k as isEqualContextString } from './Types-ZXIECzsQ.js';
...
import { i as index$3 } from './index-V71oBm66.js';
...
declare function reactiveUpdate<S extends Record<string, PrimitiveOrObject>>(schema: S, updaters?: Updated<S>): {
    pull: () => Promise<S>;
    replaceSource: (field: Extract<keyof S, string>, source: Resolvable<any>, disposeOld: boolean) => void;
    on(handler: (value: Passed<S>) => void): Unsubscriber;
    onValue(handler: (value: S) => void): Unsubscriber;
    dispose(reason: string): void;
    isDisposed(): boolean;
    set: ((value: S) => void) & ((value: S) => void);
 ...
 * ```
 *
 * A {@link Resolvable} is a function, generator/iterable, promise or Reactive.
 *
...
declare function pull<T extends Record<string, PrimitiveOrObject | Resolvable<any>>>(value: T): {
    replaceSource: (field: Extract<keyof T, string>, source: Resolvable<any>, disposeOld: boolean) => Reactive<any> | PrimitiveOrObject | Function;
...
type index_ReactiveUpdate<T> = ReactiveUpdate<T>;
...
declare namespace index {
  export { index$3 as Arrays, index_Bipolar as Bipolar, index_ChangeKind as ChangeKind, index_ChangeRecord as ChangeRecord, index_CompareChangeSet as CompareChangeSet, index_Correlate as Correlate, type index_FrequencyEventMap as FrequencyEventMap, index_FrequencyMutable as FrequencyMutable, index$2 as Graphs, type index_InterpolateOptions as InterpolateOptions, index_IntervalTracker as IntervalTracker, index_IsEqualContext as IsEqualContext, type index_MapObjectArgs as MapObjectArgs, index$1 as Maps, type index_MovingAverageTimedOptions as MovingAverageTimedOptions, index_Normalise as Normalise, index_NumberFunction as NumberFunction, index_NumberTracker as NumberTracker, index_NumberTrackerResults as NumberTrackerResults, index_Pathed as Pathed, index_PointTrack as PointTrack, index_PointTracker as PointTracker, index_PointTrackerResults as PointTrackerResults, Pool$1 as Pool, index_PrimitiveTracker as PrimitiveTracker, index_Process as Process, type index_PullRecord as PullRecord, type index_PullRecordWithInitial as PullRecordWithInitial, index_RankArrayOptions as RankArrayOptions, index_RankFunction as RankFunction, index_RankOptions as RankOptions, type index_ReactiveUpdate as ReactiveUpdate, type index_RecordOptions as RecordOptions, type index_Resolvable as Resolvable, type index_ResolveValue as ResolveValue, type index_ResolvedObject as ResolvedObject, index_Table as Table, index_Timestamped as Timestamped, index_TimestampedObject as TimestampedObject, index_TimestampedPrimitive as TimestampedPrimitive, type index_TrackUnique as TrackUnique, index_TrackedPointMap as TrackedPointMap, index_TrackedValueMap as TrackedValueMap, index_TrackedValueOpts as TrackedValueOpts, index_TrackerBase as TrackerBase, index_changedDataFields as changedDataFields, index_clamp as clamp, index_clampIndex as clampIndex, index_compareArrays as compareArrays, index_compareData as compareData, index_compareDataExecute as compareDataExecute, index_compareKeys as compareKeys, index_fieldResolve as fieldResolve, index_fieldResolver as fieldResolver, index_flip as flip, index_frequencyMutable as frequencyMutable, index_interpolate as interpolate, index_interpolateAngle as interpolateAngle, index_interpolatorInterval as interpolatorInterval, index_interpolatorStepped as interpolatorStepped, index_intervalTracker as intervalTracker, index_isEmptyEntries as isEmptyEntries, index_isEqualContextString as isEqualContextString, index_keysToNumbers as keysToNumbers, index_mapObjectShallow as mapObjectShallow, index_movingAverage as movingAverage, index_movingAverageLight as movingAverageLight, index_movingAverageTimed as movingAverageTimed, index_noiseFilter as noiseFilter, index_numberTracker as numberTracker, index_piPi as piPi, index_pointTracker as pointTracker, index_pointsTracker as pointsTracker, index_proportion as proportion, index_pull as pull, index_reactiveUpdate as reactiveUpdate, index_scale as scale, index_scaleClamped as scaleClamped, index_scalePercent as scalePercent, index_scalePercentages as scalePercentages, index_scaler as scaler, index_scalerPercent as scalerPercent, index_softmax as softmax, index_trackUnique as trackUnique, index_trackUniqueInstances as trackUniqueInstances, index_wrap as wrap, index_wrapInteger as wrapInteger, index_wrapRange as wrapRange };
}

export { scalePercent as $, PointTracker as A, Bipolar as B, Correlate as C, pointsTracker as D, pointTracker as E, type FrequencyEventMap as F, proportion as G, type Resolvable as H, type InterpolateOptions as I, type PullRecord as J, type PullRecordWithInitial as K, type ResolveValue as L, type MapObjectArgs as M, Normalise as N, type ResolvedObject as O, Pool$1 as P, fieldResolve as Q, type RecursiveReplace as R, fieldResolver as S, TrackedPointMap as T, reactiveUpdate as U, type ReactiveUpdate as V, pull as W, scale as X, scaler as Y, scaleClamped as Z, scalePercentages as _, type ReadonlyRemapObjectPropertyType as a, scalerPercent as a0, softmax as a1, Table as a2, type TrackUnique as a3, trackUnique as a4, trackUniqueInstances as a5, wrapInteger as a6, wrap as a7, wrapRange as a8, type RemapObjectPropertyType as b, index$2 as c, index$1 as d, clamp as e, clampIndex as f, flip as g, FrequencyMutable as h, index as i, frequencyMutable as j, interpolate as k, interpolatorStepped as l, interpolatorInterval as m, interpolateAngle as n, IntervalTracker as o, piPi as p, intervalTracker as q, keysToNumbers as r, mapObjectShallow as s, movingAverageLight as t, type MovingAverageTimedOptions as u, movingAverageTimed as v, movingAverage as w, noiseFilter as x, type RecordOptions as y, compareDataExecute as z };
