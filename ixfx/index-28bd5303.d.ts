import { P as Point } from './Rect-520c9c0f';
...
declare type BasicAnalyserHandler = (freq: Float32Array, wave: Float32Array, analyser: Analyser) => void;
/**
 ...
 */
declare const basic: (onData: BasicAnalyserHandler, opts?: Opts) => Analyser;
/**
...
type Analyser$1_BasicAnalyserHandler = BasicAnalyserHandler;
...
declare namespace Analyser$1 {
  export {
    ...
    Analyser$1_BasicAnalyserHandler as BasicAnalyserHandler,
