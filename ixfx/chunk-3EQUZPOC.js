...
var markerPrebuilt = (elem, id, opts) => {
  if (elem === null)
    return `(elem null)`;
  ...
  if (id === `triangle`) {
    if (opts === void 0)
      opts = { markerWidth: 6, markerHeight: 6, refX: 5, refY: 5, viewBox: `0 0 10 10` };
    defEl = createMarker(id, opts, () => {
...
//# sourceMappingURL=chunk-3EQUZPOC.js.map