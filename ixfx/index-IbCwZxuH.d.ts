...
import { a as integer } from './index-cpU_5bGE.js';
...
declare namespace index {
  export { index_JitterOpts as JitterOpts, index_Jitterer as Jitterer, index_applyToValues as applyToValues, index_average as average, index_count as count, index_filter as filter, index_isApproximately as isApproximately, index_isValid as isValid, index_jitter as jitter, index_jitterAbsolute as jitterAbsolute, index_linearSpace as linearSpace, index_max as max, index_min as min, index_numericPercent as numericPercent, index_numericRange as numericRange, index_numericRangeRaw as numericRangeRaw, index_pingPong as pingPong, index_pingPongPercent as pingPongPercent, index_quantiseEvery as quantiseEvery, integer as randomUniqueInteger, index_relativeDifference as relativeDifference, index_round as round, index_roundUpToMultiple as roundUpToMultiple, index_total as total, index_tracker as tracker };
}

export { applyToValues as a, numericRange as b, count as c, numericPercent as d, average as e, filter as f, max as g, total as h, index as i, roundUpToMultiple as j, relativeDifference as k, isApproximately as l, min as m, numericRangeRaw as n, linearSpace as o, isValid as p, quantiseEvery as q, round as r, tracker as t };
