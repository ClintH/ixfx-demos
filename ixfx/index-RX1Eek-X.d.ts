import { C as CirclePositioned, a as Circle } from './CircleType-TIlfm7mD.js';
import { P as Point, a as Point3d, b as Placeholder$2 } from './PointType-0vgoM_lJ.js';
import { P as Path, a as CompoundPath$1, D as Dimensions, W as WithBeziers, T as Triangle, Q as QuadraticBezier, C as CubicBezier, b as CubicBezierPath, c as QuadraticBezierPath, d as Arc, A as ArcPositioned, e as Ellipse } from './ArcType-VEUNL6ta.js';
...
import { a as CardinalDirection, b as Cell, G as Grid, C as CellAccessor, V as VisitGenerator, c as Grid$1 } from './Grid-CTEVJbQM.js';
...
import { b as Scaler } from './Scaler-mbL40zQT.js';
import { R as Rgb } from './Colour-2wcTtL22.js';
...
declare const index$9_Dimensions: typeof Dimensions;
declare const index$9_Path: typeof Path;
declare const index$9_WithBeziers: typeof WithBeziers;
declare const index$9_getEnd: typeof getEnd;
declare const index$9_getStart: typeof getStart;
declare namespace index$9 {
  export { CompoundPath$1 as CompoundPath, index$9_Dimensions as Dimensions, index$9_Path as Path, index$9_WithBeziers as WithBeziers, index$9_getEnd as getEnd, index$9_getStart as getStart };
}
 ...
 * @returns
 */
declare const randomPoint$2: (shape: ShapePositioned, opts?: Partial<RandomPointOpts$2>) => Point;
/**
...
type index$8_ArrowOpts = ArrowOpts;
type index$8_ContainsResult = ContainsResult;
type index$8_PointCalculableShape = PointCalculableShape;
type index$8_ShapePositioned = ShapePositioned;
type index$8_Sphere = Sphere;
declare const index$8_arrow: typeof arrow;
declare const index$8_starburst: typeof starburst;
declare namespace index$8 {
  export { type index$8_ArrowOpts as ArrowOpts, type index$8_ContainsResult as ContainsResult, type index$8_PointCalculableShape as PointCalculableShape, type RandomPointOpts$2 as RandomPointOpts, type index$8_ShapePositioned as ShapePositioned, type index$8_Sphere as Sphere, index$8_arrow as arrow, center$2 as center, isIntersecting$2 as isIntersecting, randomPoint$2 as randomPoint, index$8_starburst as starburst };
}
 ...
 * @returns
 */
declare const isPositioned$2: (p: Point | Rect | RectPositioned) => p is Point;
/**
...
declare const index$7_placeholder: typeof placeholder;
declare const index$7_placeholderPositioned: typeof placeholderPositioned;
declare namespace index$7 {
  export { type RandomPointOpts$1 as RandomPointOpts, index$7_Rect as Rect, index$7_RectArray as RectArray, index$7_RectPositioned as RectPositioned, index$7_RectPositionedArray as RectPositionedArray, area$5 as area, index$7_cardinal as cardinal, center$1 as center, clamp$1 as clamp, corners$1 as corners, index$7_distanceFromCenter as distanceFromCenter, distanceFromExterior$1 as distanceFromExterior, edges$1 as edges, index$7_empty as empty, index$7_emptyPositioned as emptyPositioned, fromCenter$2 as fromCenter, index$7_fromElement as fromElement, fromNumbers$2 as fromNumbers, index$7_fromTopLeft as fromTopLeft, index$7_getEdgeX as getEdgeX, index$7_getEdgeY as getEdgeY, index$7_getRectPositioned as getRectPositioned, index$7_getRectPositionedParameter as getRectPositionedParameter, guard$5 as guard, index$7_guardDim as guardDim, guardPositioned$1 as guardPositioned, intersectsPoint$1 as intersectsPoint, isEmpty$3 as isEmpty, isEqual$5 as isEqual, index$7_isEqualSize as isEqualSize, isIntersecting$1 as isIntersecting, isPlaceholder$3 as isPlaceholder, isPositioned$2 as isPositioned, index$7_isRect as isRect, index$7_isRectPositioned as isRectPositioned, index$7_maxFromCorners as maxFromCorners, multiply$4 as multiply, multiplyScalar$2 as multiplyScalar, normaliseByRect$2 as normaliseByRect, perimeter$4 as perimeter, index$7_placeholder as placeholder, index$7_placeholderPositioned as placeholderPositioned, random$1 as random, randomPoint$1 as randomPoint, subtract$3 as subtract, sum$3 as sum, toArray$1 as toArray };
}
 ...
 */
declare const point$1: (circle: Circle | CirclePositioned, angleRadian: number, origin?: Point) => Point;
/**
 ...
 * @returns
 */
declare const randomPoint: (within: Circle | CirclePositioned, opts?: Partial<RandomPointOpts>) => Point;
...
type index$6_RandomPointOpts = RandomPointOpts;
...
declare namespace index$6 {
  export { index$6_Circle as Circle, index$6_CirclePositioned as CirclePositioned, type index$6_CircularPath as CircularPath, type index$6_RandomPointOpts as RandomPointOpts, area$4 as area, bbox$5 as bbox, index$6_center as center, index$6_circumference as circumference, distanceCenter$1 as distanceCenter, index$6_distanceFromExterior as distanceFromExterior, index$6_exteriorIntegerPoints as exteriorIntegerPoints, guard$4 as guard, index$6_guardPositioned as guardPositioned, index$6_interiorIntegerPoints as interiorIntegerPoints, interpolate$4 as interpolate, index$6_intersectionLine as intersectionLine, index$6_intersections as intersections, index$6_isCircle as isCircle, index$6_isCirclePositioned as isCirclePositioned, index$6_isContainedBy as isContainedBy, isEqual$4 as isEqual, index$6_isIntersecting as isIntersecting, isNaN$1 as isNaN, isPositioned$1 as isPositioned, length$2 as length, multiplyScalar$1 as multiplyScalar, nearest$1 as nearest, point$1 as point, index$6_randomPoint as randomPoint, toPath$3 as toPath, index$6_toPositioned as toPositioned, toSvg$1 as toSvg };
}
...
declare namespace index {
  export { index$2 as Arcs, index$3 as Beziers, index_Circle as Circle, index_CirclePositioned as CirclePositioned, index$6 as Circles, type index_CircularPath as CircularPath, CompoundPath as Compound, CompoundPath$1 as CompoundPath, index_Convolve2d as Convolve2d, index_CurveSimplification as CurveSimplification, index_Dimensions as Dimensions, Ellipse as Ellipses, Grid$1 as Grids, Layout as Layouts, index_Line as Line, index$5 as Lines, index_Path as Path, index$9 as Paths, index_Point as Point, index_Point3d as Point3d, type index_PointCalculableShape as PointCalculableShape, index$4 as Points, index_Polar as Polar, index_PolyLine as PolyLine, index_QuadTree as QuadTree, index_Rect as Rect, index_RectArray as RectArray, index_RectPositioned as RectPositioned, index_RectPositionedArray as RectPositionedArray, index$7 as Rects, index_Scaler as Scaler, type index_ShapePositioned as ShapePositioned, index$8 as Shapes, index_SurfacePoints as SurfacePoints, index_Triangle as Triangle, index$1 as Triangles, type Vector$1 as Vector, Vector as Vectors, Waypoint$1 as Waypoints, index_WithBeziers as WithBeziers, index_degreeToRadian as degreeToRadian, index_radianToDegree as radianToDegree, index_radiansFromAxisX as radiansFromAxisX };
}

export { CompoundPath as C, Layout as L, type PointCalculableShape as P, QuadTree as Q, SurfacePoints as S, Vector as V, Waypoint$1 as W, index$6 as a, index$5 as b, index$7 as c, index$4 as d, index$9 as e, index$3 as f, CurveSimplification as g, Convolve2d as h, index as i, index$2 as j, index$8 as k, index$1 as l, type Vector$1 as m, type CircularPath as n, type ShapePositioned as o, degreeToRadian as p, radiansFromAxisX as q, radianToDegree as r };
