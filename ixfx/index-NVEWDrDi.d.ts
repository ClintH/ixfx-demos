import { C as CellAccessor } from './Grid-CTEVJbQM.js';
import { R as Rgb, C as Colour } from './Colour-2wcTtL22.js';
...
import { C as CirclePositioned } from './CircleType-TIlfm7mD.js';
import { I as IStackImmutable, a as IMapOfMutableExtended } from './IMapOfMutableExtended-GY_Epf-Q.js';
import { S as Svg } from './Svg-g8d9PPot.js';
...
declare const makeHelper: (ctxOrCanvasEl: CanvasContextQuery, canvasBounds?: Rect) => {
    ...
    dot(dotPosition: Point | Array<Point>, opts?: DrawingOpts$1 & {
        radius: number;
        outlined?: boolean;
        filled?: boolean;
    }): void;
 ...
 * @param opts
 */
declare const dot: (ctx: CanvasRenderingContext2D, pos: Point | ReadonlyArray<Point>, opts?: DrawingOpts$1 & {
