import { l as ReactiveOrSource, T as TransformOpts, R as Reactive, m as ReactiveOp, B as BatchOptions, n as CombineLatestOptions, o as RxValueTypes, p as RxValueTypeRx, q as RxValueTypeObject, r as ReactiveDiff, s as ReactiveInitial, D as DebounceOptions, F as FieldOptions, t as FilterPredicate, u as InitStreamOptions, S as SingleFromArrayOptions, v as SplitOptions, w as ReactiveStream, x as SwitcherOptions, y as SyncOptions, z as Processors, A as ReactiveWritable, E as ThrottleOptions, G as TimeoutTriggerOptions, W as WithValueOptions, H as ToArrayOptions, a as Passed, J as PassedSignal, K as PassedValue, L as Wrapped, M as Trigger, N as TriggerValue, O as TriggerFunction, Q as TriggerGenerator, V as GeneratorOptions, X as FunctionOptions, Y as CountOptions, b as PathDataChange, Z as DomBindSourceValue, _ as PipeDomBinding, $ as DomBindValueTarget, a0 as DomBindUnresolvedSource, a1 as BindUpdateOpts, a2 as ElementsOptions, a3 as ArrayOptions, a4 as ReactiveFinite, a5 as ArrayObjectOptions, a6 as ReactiveArray, a7 as ReactiveNonInitial, a8 as DerivedOptions, a9 as DomNumberInputValueOptions, aa as DomValueOptions, ab as EventOptions, ac as EventTriggerOptions, ad as FunctionFunction, ae as PingedFunctionFunction, af as PingedFunctionOptions, ag as ObjectOptions, ah as symbol, ai as DerivedFunction, aj as EventPluckedFieldOptions, ak as EventPluckedFieldOptions2, al as SetHtmlOptions, am as OpMathOptions, an as TallyOptions, U as Unsubscriber, ao as DomBindInputOptions, ap as DomBindResolvedSource, aq as DomBindTargetNode, ar as DomBindTargetNodeResolved, as as DomCreateOptions, at as ElementBind, au as InitLazyStreamInitedOptions, av as InitLazyStreamOptions, aw as Lazy, ax as OpAsAnnotation, ay as Optional, az as PipeSet, aA as PrimitiveValueTypeObject, aB as ReactiveInitialStream, aC as ReactiveOpInit, aD as ReactiveOpLinks, aE as ResolveOptions, aF as RxValueTypeObjectOrUndefined, aG as SetHtmlOptionsElement, aH as SetHtmlOptionsQuery, aI as SignalKinds, aJ as UpstreamInitialOptions, aK as UpstreamOptions, aL as average, aM as max, aN as min, aO as rank, aP as setHtmlText, aQ as sum, aR as tally } from './Types-ZXIECzsQ.js';
import { I as Interval } from './IntervalType-CQa4mlKV.js';
import { R as RankFunction, a as RankOptions } from './Types-0RfFkd3L.js';
import Color from 'colorjs.io';
import { H as Hsl } from './Colour-fqMGpqKU.js';
...
declare function runHead<T1, T2>(source: ReactiveOrSource<T1>, ...ops: OpChain1<T1, T2>): Reactive<T2>;
declare function runHead<T1, T2, T3>(source: ReactiveOrSource<T1>, ...ops: OpChain2<T1, T2, T3>): Reactive<T3>;
declare function runHead<T1, T2, T3, T4>(source: ReactiveOrSource<T1>, ...ops: OpChain3<T1, T2, T3, T4>): Reactive<T4>;
declare function runHead<T1, T2, T3, T4, T5>(source: ReactiveOrSource<T1>, ...ops: OpChain4<T1, T2, T3, T4, T5>): Reactive<T5>;
declare function runHead<T1, T2, T3, T4, T5, T6>(source: ReactiveOrSource<T1>, ...ops: OpChain5<T1, T2, T3, T4, T5, T6>): Reactive<T6>;
...
declare const index_runHead: typeof runHead;
