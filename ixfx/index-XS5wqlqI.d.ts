 ...
 */
type LinksWithSource<TFinal, T2> = LinksWithSource0<TFinal> | LinksWithSource1<TFinal, T2>;
/**
 * Delay options
 */
type DelayOptions = {
 ...
 * @returns
 */
declare function run<TFinal, T2>(...functions: LinksWithSource<TFinal, T2>): AsyncGenerator<TFinal>;
