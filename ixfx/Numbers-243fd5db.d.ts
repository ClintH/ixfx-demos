import { T as TrackedValueOpts, N as NumberTracker } from './NumberTracker-dc076271.js';
import { c as EasingFn } from './Arrays-dbb38593.js';
 ...
 * @returns
 */
declare const applyToValues: <T extends Record<string, any>>(obj: T, fn: (v: number) => number) => T;
/**
