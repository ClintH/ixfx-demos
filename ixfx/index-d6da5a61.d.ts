...
import { Q as QueueMutable } from './Interfaces-d1c1f610';
 ...
 */
declare const puck: () => Promise<EspruinoDevice>;
/**
 * @inheritdoc EspruinoDevice
 * @returns Returns a connected instance, or throws exception if user cancelled or could not connect.
 */
...
export { EspruinoDevice$1 as E, NordicBleDevice$1 as N, index as i };
