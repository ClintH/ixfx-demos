import { H as HasCompletion, a as TimerSource } from './Timer-95b8b693';
 ...
 *
 */
declare function sine(timerSrc: TimerSource): Generator<number, void, unknown>;
declare function sineBipolar(timerSrc: TimerSource): Generator<number, void, unknown>;
declare function triangle(timerSrc: TimerSource): Generator<number, void, unknown>;
declare function saw(timerSrc: TimerSource): Generator<number, void, unknown>;
declare function square(timerSrc: TimerSource): Generator<1 | 0, void, unknown>;
