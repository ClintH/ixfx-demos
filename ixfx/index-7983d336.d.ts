 ...
 * @param type Type of jitter calculation: rel/abs
 * @param clamped If true (default) return value is clamped 0..1
 * @returns Jittered value on 0..1 scale
 */
declare const jitter: (value: number, jitter: number, type?: `rel` | `abs`, clamped?: boolean) => number;
...
export { AdsrOpts as A, CompleteEvent as C, EnvelopeOpts as E, Oscillator as O, StateChangeEvent as S, AdsrTimingOpts as a, Adsr as b, adsr as c, defaultAdsrOpts as d, index as i, jitter as j };
