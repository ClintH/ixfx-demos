...
declare type Waveform = {
    get value(): number;
};
declare const sine: (timerSrc: TimerSource) => Waveform;
...
export { AdsrOpts as A, CompleteEvent as C, Easing as E, StateChangeEvent as S, Waveform as W, easeOverTicks as a, EasingName as b, EnvelopeOpts as c, defaultAdsrOpts as d, easeOverTime as e, AdsrTimingOpts as f, getEasings as g, Adsr as h, index as i, adsr as j, sine as s };
