...
import { a as KeyValue, S as SortSyles } from './KeyValue-C8BVtJ3M.js';
...
import { ao as PointRelationResult, P as Point, ap as PointRelation, p as PolyLine, L as Line } from './index-ezZcXkXG.js';
import { C as Coord } from './Polar-M3HREV8-.js';
import { I as IMapImmutable } from './MakeGlobal-ZmibxNwc.js';
import { g as ReactiveOrSource, ac as RxPrimitiveValueTypeObject } from './Types-_Zmx2Zlc.js';
...
type Primitive = boolean | bigint | number | string;
declare function pull<T extends Record<string, Primitive | ReactiveOrSource<any>>>(value: T): {
    compute: () => RxPrimitiveValueTypeObject<T>;
    dispose: () => void;
};
declare function push<T extends Record<string, Primitive | ReactiveOrSource<any>>>(value: T): {
    compute: () => RxPrimitiveValueTypeObject<T>;
    dispose: () => void;
};
