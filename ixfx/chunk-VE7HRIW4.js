...
var updateDataTable = (t, data, formatter) => {
  if (data === void 0) {
    t.innerHTML = ``;
    return;
  }
...
var dataTable = (parentOrQuery, data, formatter) => {
  const parent = resolveEl(parentOrQuery);
  const t = document.createElement(`table`);
  parent.append(t);
  if (data)
    updateDataTable(t, data, formatter);
  return (d) => {
    updateDataTable(t, d, formatter);
  };
};
var clear = (parent) => {
...
***************************************************************************** */
//# sourceMappingURL=chunk-VE7HRIW4.js.map