import { R as Reactive, f as ReactiveWritable, S as SplitOptions, g as ReactiveOrSource, h as ReactiveStream, F as FilterPredicate, i as SwitcherOptions, j as ReactiveDisposable, k as ResolveOptions, l as FieldOptions, m as ReactiveOp, I as InitStreamOptions, T as TransformOpts, A as AnnotationElapsed, n as SingleFromArrayOptions, B as BatchOptions, D as DebounceOptions, o as ThrottleOptions, p as ToArrayOptions, q as ReactiveArray, r as ReactiveInitial, s as ReactiveNonInitial, G as GeneratorOptions, P as Passed, t as PassedSignal, u as PassedValue, v as ReactiveDiff, W as Wrapped, w as FromArrayOptions, x as ReactiveFinite, y as DomBindSourceValue, z as PipeDomBinding, E as DomBindValueTarget, H as DomBindUnresolvedSource, J as BindUpdateOpts, K as ElementsOptions, L as EventOptions, O as Optional, M as ObjectOptions, N as symbol, Q as DomBindResolvedSource, U as DomBindTargetNode, V as DomBindTargetNodeResolved, X as DomCreateOptions, Y as ElementBind, Z as PipeSet, _ as ReactiveOpInit, $ as ReactiveOpLinks, a0 as SignalKinds, a1 as UpstreamOptions } from './Types-hnV-bWAd.js';
import { C as Change } from './Immutable-2OkPBCQB.js';
 ...
 * @returns
 */
declare const readFromArray: <V>(array: V[], options?: Partial<FromArrayOptions>) => Reactive<V> & ReactiveFinite & {
    last(): V;
};
