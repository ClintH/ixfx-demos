import { b as StateMachine } from './StateMachine-9b4ba5c7.js';
 ...
 * @returns
 */
declare const interval: <V>(produce: AsyncPromiseOrGenerator<V> | ArrayLike<V>, optsOrFixedMs?: IntervalOpts | number) => AsyncGenerator<any, void, unknown>;
 ...
 * @returns
 */
declare function progress(duration: Interval): () => number;
...
type AsyncPromiseOrGenerator<V> = (() => Promise<V> | Promise<undefined>) | (() => V | undefined) | Generator<V> | IterableIterator<V> | AsyncIterableIterator<V> | AsyncGenerator<V>;
