 ...
 * ```
 * const t = timer(`quintIn`, 5*1000); // Will take 5 seconds to complete
 * ...
 ...
 * @returns Easing
 */
declare const ticks: (name: EasingName, durationTicks: number) => Easing;
/**
 * 'Ease' from `0` to `1` over a delicious curve. Used commonly for animation
 * and basic modelling of phyical motion.
 *
 * Create via {@link ticks} or {@link time}, call `compute` to calculate the next
...
declare const Easing$1_ticks: typeof ticks;
