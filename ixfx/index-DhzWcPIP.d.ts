import { a as StateMachineWithEvents, b as StateChangeEvent, T as Transitions } from './StateMachine-u3Al6fsf.js';
import { S as SimpleEventEmitter, I as ISimpleEventEmitter } from './Events-Nrj5kd7m.js';
import { I as Interval } from './IntervalType-zqeNLRm6.js';
import { b as QueueMutable } from './QueueMutable-0fPE_WYG.js';
import { C as Continuously } from './Continuously-sRxroRit.js';
import { N as NumberTracker } from './NumberTracker-Xxrdozop.js';
import { a as Point, R as Rect } from './index-i31F4rTB.js';
...
declare namespace index {
  export { AudioAnalyser$1 as AudioAnalysers, AudioVisualiser$1 as AudioVisualisers, NordicBleDevice$1 as Bluetooth, index_Camera as Camera, index_Codec as Codec, index_Espruino as Espruino, index_FrameProcessor as FrameProcessor, type index_FrameProcessorOpts as FrameProcessorOpts, type index_GenericStateTransitions as GenericStateTransitions, type index_IoDataEvent as IoDataEvent, type index_IoEvents as IoEvents, index_Serial as Serial, index_StateChangeEvent as StateChangeEvent, index_StringReceiveBuffer as StringReceiveBuffer, index_StringWriteBuffer as StringWriteBuffer, type Opts$3 as StringWriteBufferOpts, index_VideoFile as VideoFile, index_genericStateTransitionsInstance as genericStateTransitionsInstance };
}

export { AudioAnalyser$1 as A, Codec as C, Espruino as E, FrameProcessor as F, type GenericStateTransitions as G, type IoDataEvent as I, NordicBleDevice$1 as N, type Opts$3 as O, StringReceiveBuffer as S, VideoFile as V, type IoEvents as a, AudioVisualiser$1 as b, StringWriteBuffer as c, Camera as d, type FrameProcessorOpts as e, Serial as f, genericStateTransitionsInstance as g, index as i };
