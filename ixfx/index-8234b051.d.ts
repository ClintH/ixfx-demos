...
declare class SerialDevice extends JsonDevice {
    private config;
...
type Serial_SerialDevice = SerialDevice;
declare const Serial_SerialDevice: typeof SerialDevice;
declare namespace Serial {
  export {
    Serial_Opts as Opts,
    Serial_SerialDevice as SerialDevice,
  };
}
...
export { Camera as C, EspruinoDevice$1 as E, NordicBleDevice$1 as N, Serial as S, index as i };
