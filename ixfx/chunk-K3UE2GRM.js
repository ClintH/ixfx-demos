...
var bindTextContent = (elOrQuery, source, bindOpts2 = {}) => {
  return bind(elOrQuery, source, { ...bindOpts2, elField: `textContent` });
};
var bindHtmlContent = (elOrQuery, source, bindOpts2 = {}) => {
  return bind(elOrQuery, source, { ...bindOpts2, elField: `innerHTML` });
};
var bindAttribute = (elOrQuery, source, attribute, bindOpts2 = {}) => {
  return bind(elOrQuery, source, { ...bindOpts2, attribName: attribute });
};
var bindCssVariable = (elOrQuery, source, cssVariable, bindOpts2 = {}) => {
  return bind(elOrQuery, source, { ...bindOpts2, cssVariable });
};
...
var bind = (elOrQuery, source, ...binds) => {
  const el = resolveEl(elOrQuery);
  const resolveBind = (bind2) => {
