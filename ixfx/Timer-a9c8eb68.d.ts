...
export { Continuously as C, HasCompletion as H, ModTimer as M, TimerSource as T, Timer as a, Timeout as b, timeout as c, debounce as d, continuously as e, delay as f, frequencyTimerSource as g, frequencyTimer as h, interval as i, ticksElapsedTimer as j, msElapsedTimer as m, relativeTimer as r, sleep as s, throttle as t };
