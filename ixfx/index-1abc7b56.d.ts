import { I as Interval, i as intervalToMs, a as isInterval } from './IntervalType-d3ca90bc.js';
import { H as HasCompletion, A as AsyncPromiseOrGenerator } from './Types-6259bb31.js';
import { S as StateMachine } from './StateMachine-0aa5fd05.js';
import { M as ModulationTimer, R as RelativeTimerOpts, T as Timer, a as TimerOpts, b as TimerSource, f as frequencyTimer, c as frequencyTimerSource, h as hasElapsedMs, m as msElapsedTimer, r as relativeTimer, t as ticksElapsedTimer } from './Timer-26d06b1c.js';
import { D as DelayOpts, I as IntervalOpts, d as delay, a as delayLoop, i as interval } from './Delay-f8de3383.js';
import { C as Continuously, a as ContinuouslyAsyncCallback, b as ContinuouslyOpts, c as ContinuouslySyncCallback, O as OnStartCalled, d as continuously } from './Continuously-2545e387.js';
...
export { Dispatch as D, Elapsed as E, RepeatPredicate as R, SleepOpts as S, TaskQueue as T, UpdateFailPolicy as U, forEachAsync as a, repeatReduce as b, DispatchList as c, TimeoutSyncCallback as d, TimeoutAsyncCallback as e, forEach as f, Timeout as g, debounce as h, index as i, DebouncedFunction as j, throttle as k, everyNth as l, runOnce as m, RetryResult as n, RetryOpts as o, retry as p, repeat as r, sleep as s, timeout as t, updateOutdated as u, waitFor as w };
