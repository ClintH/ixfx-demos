...
import { H as HasCompletion } from './index-c0c0f4e9.js';
 ...
 * @returns
 */
declare const unique: <V>(arrays: V[] | V[][] | readonly V[] | readonly (readonly V[])[], comparer?: (a: V, b: V) => boolean) => V[];
/**
...
export { reducePairwise as $, Arrays as A, guardArray as B, Colour$1 as C, guardIndex as D, Easing$1 as E, valuesEqual as F, GenerateRandomOpts as G, intersection as H, flatten as I, zip as J, interleave as K, ensureLength as L, filterBetween as M, randomPluck as N, shuffle as O, sortByNumericProperty as P, without as Q, Random as R, StringOpts as S, until as T, remove as U, groupBy as V, WeightedOpts as W, sample as X, chunks as Y, MergeReconcile as Z, mergeByKey as _, RandomSource as a, filterAB as a0, unique as a1, containsDuplicateValues as a2, compareValues as a3, compareValuesEqual as a4, contains as a5, additionalValues as a6, averageWeighted as a7, weight as a8, validNumbers as a9, dotProduct as aa, average as ab, min as ac, maxIndex as ad, minIndex as ae, max as af, total as ag, maxFast as ah, totalFast as ai, minFast as aj, Rgb as b, EasingFn as c, randomElement as d, RandomOpts as e, defaultRandom as f, weighted as g, WeightedIntOpts as h, integerUniqueGen as i, weightedIntegerFn as j, weightedInteger as k, gaussian as l, gaussianFn as m, integerFn as n, integer as o, floatFn as p, float as q, randomIndex as r, string as s, shortGuid as t, minutesMsFn as u, minutesMs as v, weightedFn as w, secondsMsFn as x, secondsMs as y, randomHue as z };
