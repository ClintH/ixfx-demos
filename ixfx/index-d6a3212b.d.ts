...
import { T as ToString } from './util-2bc3f13f';
...
declare class Palette {
     ...
     * @memberof Palette
     */
    add(key: string, colour: string): void;
...
export { Drawing as D, OverflowPolicy as O, Plot2 as P, Svg as S, stackMutable as a, DictionaryOfColourCombinations as b, Palette as c, index as i, stack as s };
