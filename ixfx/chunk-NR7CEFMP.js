import {
  Drawing_exports
} from "./chunk-RU35SIQT.js";
import {
  mapCircular
} from "./chunk-EB4M56LX.js";
import {
  parentSizeCanvas,
  resolveEl
...
var createPath = (svgOrArray, parent, opts) => {
...
var createCircle = (circle, parent, opts) => {
...
var createLine = (line, parent, opts, id) => {
...
var svg = (parent, opts) => {
  ...
  const o = {
    ...
    line: (line, opts2, id) => createLine(line, parent, opts2, id),
    circle: (circle, opts2) => createCircle(circle, parent, opts2),
...
//# sourceMappingURL=chunk-NR7CEFMP.js.map