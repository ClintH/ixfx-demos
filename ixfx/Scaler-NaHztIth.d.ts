 ...
 * @returns
 */
declare const scaler: (scaleBy?: `both` | `min` | `max` | `width` | `height`, defaultRect?: Rect) => ScalerCombined;
...
declare namespace Scaler$1 {
  export { type Scaler$1_Scaler as Scaler, type Scaler$1_ScalerCombined as ScalerCombined, Scaler$1_scaler as scaler };
}

export { type Scaler as S, Scaler$1 as a };
