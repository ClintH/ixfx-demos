...
import { a as Point } from './Rect-04af8f31';
 ...
 * @returns Observable
 */
declare const fullSizeCanvas: (domQueryOrEl: string | HTMLCanvasElement, onResized?: ((args: ResizeArgs) => void) | undefined, skipCss?: boolean) => Observable<Event>;
/**
 ...
 * @returns Observable
 */
declare const parentSizeCanvas: (domQueryOrEl: string | HTMLCanvasElement, onResized?: ((args: ResizeArgs) => void) | undefined, timeoutMs?: number) => rxjs.Subscription;
/**
...
export { DomRxOpts as D, LogOpts as L, PluckOpts as P, Rx as R, TransformOpts as T, Log as a, resolveEl as b, createAfter as c, createIn as d, resizeObservable as e, fullSizeCanvas as f, copyToClipboard as g, index as i, log as l, parentSizeCanvas as p, rx as r, themeChangeObservable as t, windowResize as w };
