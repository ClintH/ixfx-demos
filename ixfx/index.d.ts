...
declare module "data/Scale" {
     ...
     * @returns
     */
    export const scaleClamped: (v: number, inMin: number, inMax: number, outMin?: number, outMax?: number, easing?: ((v: number) => number) | undefined) => number;
    /**
...
declare module "geometry/Line" {
     ...
     * @param lines
     */
    export function asPoints(lines: Iterable<Line>): Generator<Points.Point, void, unknown>;
    /**
