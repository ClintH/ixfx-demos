import { T as TrackedValueOpts, N as NumberTracker } from './NumberTracker-Xxrdozop.js';
import { E as EasingFn } from './Easing-6U8WQcr8.js';
...
declare namespace Numbers {
  export { Numbers_applyToValues as applyToValues, Numbers_average as average, Numbers_averageWeighted as averageWeighted, Numbers_filter as filter, Numbers_isApproximately as isApproximately, Numbers_isValid as isValid, Numbers_linearSpace as linearSpace, Numbers_max as max, Numbers_min as min, Numbers_quantiseEvery as quantiseEvery, Numbers_round as round, Numbers_total as total, Numbers_tracker as tracker };
}
