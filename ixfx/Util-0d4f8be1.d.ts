 ...
 * ```
 */
declare const mapObject: <SourceType extends Record<string, any>, DestinationFieldType>(object: SourceType, mapFunction: (fieldValue: any, field: string, index: number) => DestinationFieldType) => RemapObjectPropertyType<SourceType, DestinationFieldType>;
 ...
 * @returns
 */
declare const getFieldByPath: (o: any, path?: string) => any;
/**
 ...
 * @returns
 */
declare const getFieldPaths: (o: object | null) => ReadonlyArray<string>;
/**
 ...
 * @returns
 */
declare const comparerInverse: <V>(function_: Comparer<V>) => Comparer<V>;
/**
